...
public class sns_hdns : System.Web.Services.WebService
{
    ...
    #region Tinbai2
    [WebMethod(true)]
    public string Fs_TIN_BAI2_LKE(string b_login, double[] a_tso, string[] a_cot, string b_nnn, string ma_cd, string ten_cd)
    ...
    [WebMethod(true)]
    public string Fs_TIN_BAI2_NH(string b_login, double b_trangKT, object[] a_dt_ct, string[] a_cot_lke)

    {
        try
        {
            ...
            object[] a_gtri = (object[])a_dt_ct[1];
            DataTable b_dt_ct = bang.Fdt_TAO_THEM(a_cot, a_gtri);
            ns_hdns.P_TIN_BAI2_NH(b_dt_ct);
            // ghi log
            hts_dungchung.PHT_LOG_NH(PHANHE.HDNS, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.NHAP, TEN_FORM.NS_HDNS_MA_VTCDANH, TEN_BANG.NS_HDNS_MA_VTCDANH);
            string b_ma = mang.Fs_TEN_GTRI("ma", a_cot, a_gtri);
            return Fs_TIN_BAI2_MA(b_login, b_ma, b_trangKT, a_cot_lke);
        }
        catch (Exception ex)  { return form.Fs_LOC_LOI(ex.Message); }
    }

    [WebMethod(true)]
    public string Fs_TIN_BAI2_MA(string b_login, string b_ma, double b_trangkt, string[] a_cot)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            object[] a_object = ns_hdns.Fdt_TIN_BAI2_MA(b_ma, b_trangkt);
            DataTable b_dt = (DataTable)a_object[2];
            bang.P_COPY_COL(ref b_dt, "ten_tt", "tt");
            bang.P_THAY_GTRI(ref b_dt, "ten_tt", "1", "Áp dụng");
            bang.P_THAY_GTRI(ref b_dt, "ten_tt", "2", "Ngừng áp dụng");
    ...
    [WebMethod(true)]
    public string Fs_TIN_BAI2_CT(string b_login, string b_ma)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            DataSet b_ds = ns_hdns.Fds_TIN_BAI2_CT(b_ma);
            DataTable b_dt = b_ds.Tables[0];
            bang.P_COPY_COL(ref b_dt, "TEN_TT", "TT");
            bang.P_THAY_GTRI(ref b_dt, "TEN_TT", "2", "Ngừng áp dụng");
            bang.P_THAY_GTRI(ref b_dt, "TEN_TT", "1", "Áp dụng");
    ...
    public string Fs_TIN_BAI2_XOA(string b_login, string b_ma, double[] a_tso, string[] a_cot, object[] a_dt_ct)

    {
        try
        {
            ...
            foreach (DataRow dr in b_dt_ct.Rows)
            {
                ...
                ns_hdns.P_TIN_BAI2_XOA(b_ma); return Fs_TIN_BAI2_LKE(b_login, a_tso, a_cot, "", "", ""); }
                else { b_ma_trung += dr["ma"].ToString() + ", "; }
            }
            // ghi log
            hts_dungchung.PHT_LOG_NH(PHANHE.HDNS, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.XOA, TEN_FORM.NS_HDNS_MA_VTCDANH, TEN_BANG.NS_HDNS_MA_VTCDANH);
    ...
    [WebMethod(true)]
    public string Fs_TIN_BT3_LKE(string b_login, double[] a_tso, string[] a_cot)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            double b_tu_n = chuyen.OBJ_N(a_tso[0]), b_den_n = chuyen.OBJ_N(a_tso[1]);
            object[] a_object = ns_hdns.Fdt_TIN_BT3_LKE( b_tu_n, b_den_n); ;
            DataTable b_dt = (DataTable)a_object[1];
            bang.P_SO_CNG(ref b_dt, "ngay_tl");
            bang.P_SO_CNG(ref b_dt, "ngay_gt");
            return chuyen.OBJ_S(a_object[0]) + "#" + bang.Fs_BANG_CH(b_dt, a_cot);
    ...
    [WebMethod(true)]
    public string Fs_TIN_BT3_NH(string b_login, double b_trangKT, object[] a_dt_ct, string[] a_cot_lke)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            ...
            bang.P_CNG_SO(ref b_dt_ct, "ngay_tl");
            bang.P_CNG_SO(ref b_dt_ct, "ngay_gt");
            ns_hdns.P_TIN_BT3_NH(b_dt_ct);
            // ghi log
            hts_dungchung.PHT_LOG_NH(PHANHE.HDNS, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.NHAP, TEN_FORM.NS_HDNS_MA_VTCDANH, TEN_BANG.NS_HDNS_MA_VTCDANH);
            string b_ma = mang.Fs_TEN_GTRI("ma", a_cot, a_gtri);
            return Fs_TIN_BT3_MA(b_login, b_ma, b_trangKT, a_cot_lke);
        }
        catch (Exception ex) { return form.Fs_LOC_LOI(ex.Message); }
    }

    [WebMethod(true)]
    public string Fs_TIN_BT3_MA(string b_login, string b_ma, double b_trangkt, string[] a_cot)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            object[] a_object = ns_hdns.Fdt_TIN_BT3_MA(b_ma, b_trangkt);
            DataTable b_dt = (DataTable)a_object[2];
            int b_hang = bang.Fi_TIM_ROW(b_dt, "ma", b_ma);
            return b_hang.ToString() + "#" + chuyen.OBJ_S(a_object[0]) + "#" + chuyen.OBJ_S(a_object[1]) + "#" + bang.Fs_BANG_CH(b_dt, a_cot);
        }
    ...
    [WebMethod(true)]
    public string Fs_TIN_BT3_XOA(string b_login, string b_ma, double[] a_tso, string[] a_cot, object[] a_dt_ct)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            ...
            foreach (DataRow dr in b_dt_ct.Rows)
            {
                double b_tontai = ht_dungchung.FTL_HOI_MA_TONTAI(ht_dungchung.NS_HDNS_GAN_CDANHDVI_CT, ht_dungchung.MA_CDANH_XOA, dr["ma"].ToString(), ref b_thongbao);
                if (b_tontai <= 0)
                { ns_hdns.P_TIN_BT3_XOA(b_ma); return Fs_TIN_BT3_LKE(b_login, a_tso, a_cot); }
     ...
     [WebMethod(true)]
    public string Fs_TIN_BT3_CT(string b_login, string b_ma)
     {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
           DataSet b_ds = ns_hdns.Fds_TIN_BT3_CT(b_ma);
            DataTable b_dt = b_ds.Tables[0];
            DataTable b_dt_tt = b_ds.Tables[1];
            bang.P_SO_CNG(ref b_dt, "ngay_tl");
            bang.P_SO_CNG(ref b_dt, "ngay_gt");
    ...
    //object[] a_obj = ns_hdns.Fdt_NS_PB_NTDUC_LKE(b_ngay_tu, b_ngay_den, (double)a_tso[0], (double)a_tso[1]);
            ...
            se.P_TG_LUU("ns_hdns_bt3_tin", "DT_TT", b_dt_tt);
            bang.P_TIM_THEM(ref b_dt, "ns_hdns_bt3_tin", "DT_TT", "ma_tt");
    ...
    #region NAMbai2
    [WebMethod(true)]
    public string Fs_NAM_BAI2_LKE(string b_login, double[] a_tso, string[] a_cot, string b_nnn, string ma_cd, string ten_cd)

    {
        try
        {
            ...
            double b_tu_n = chuyen.OBJ_N(a_tso[0]), b_den_n = chuyen.OBJ_N(a_tso[1]);
            object[] a_object;
            a_object = ns_hdns.Fdt_NAM_BAI2_LKE(b_nnn, ma_cd, ten_cd, b_tu_n, b_den_n);
            DataTable b_dt = (DataTable)a_object[1];
            bang.P_COPY_COL(ref b_dt, "ten_tt", "tt");
            bang.P_THAY_GTRI(ref b_dt, "ten_tt", "1", "Áp dụng");
            bang.P_THAY_GTRI(ref b_dt, "ten_tt", "2", "Ngừng áp dụng");
    ...
    [WebMethod(true)]
    public string Fs_NAM_BAI2_NH(string b_login, double b_trangKT, object[] a_dt_ct, string[] a_cot_lke)

    {
        try
        {
            ...
            object[] a_gtri = (object[])a_dt_ct[1];
            DataTable b_dt_ct = bang.Fdt_TAO_THEM(a_cot, a_gtri);
            ns_hdns.P_NAM_BAI2_NH(b_dt_ct);
            // ghi log
            hts_dungchung.PHT_LOG_NH(PHANHE.HDNS, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.NHAP, TEN_FORM.NS_HDNS_MA_VTCDANH, TEN_BANG.NS_HDNS_MA_VTCDANH);
            string b_ma = mang.Fs_TEN_GTRI("ma", a_cot, a_gtri);
            return Fs_NAM_BAI2_MA(b_login, b_ma, b_trangKT, a_cot_lke);
        }
        catch (Exception ex) { return form.Fs_LOC_LOI(ex.Message); }
    }

    [WebMethod(true)]
    public string Fs_NAM_BAI2_MA(string b_login, string b_ma, double b_trangkt, string[] a_cot)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            object[] a_object = ns_hdns.Fdt_NAM_BAI2_MA(b_ma, b_trangkt);
            DataTable b_dt = (DataTable)a_object[2];
            bang.P_COPY_COL(ref b_dt, "ten_tt", "tt");
            bang.P_THAY_GTRI(ref b_dt, "ten_tt", "1", "Áp dụng");
            bang.P_THAY_GTRI(ref b_dt, "ten_tt", "2", "Ngừng áp dụng");
    ...
    [WebMethod(true)]
    public string Fs_NAM_BAI2_CT(string b_login, string b_ma)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            DataSet b_ds = ns_hdns.Fds_NAM_BAI2_CT(b_ma);
            DataTable b_dt = b_ds.Tables[0];
            bang.P_COPY_COL(ref b_dt, "TEN_TT", "TT");
            bang.P_THAY_GTRI(ref b_dt, "TEN_TT", "2", "Ngừng áp dụng");
            bang.P_THAY_GTRI(ref b_dt, "TEN_TT", "1", "Áp dụng");
    ...
    public string Fs_NAM_BAI2_XOA(string b_login, string b_ma, double[] a_tso, string[] a_cot, object[] a_dt_ct)
        ...
        try
        {
            ...
            foreach (DataRow dr in b_dt_ct.Rows)
            {
...

                {
                    ...
                    ns_hdns.P_NAM_BAI2_XOA(b_ma); return Fs_NAM_BAI2_LKE(b_login, a_tso, a_cot, "", "", "");
                }
                else { b_ma_trung += dr["ma"].ToString() + ", "; }
            }
            // ghi log
    ...
    [WebMethod(true)]
    public string Fs_NS_HDNS_NAM_BT3_MA(string b_login, string b_ma, double b_trangkt, string[] a_cot)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            object[] a_object = ns_hdns.Fdt_NS_HDNS_NAM_BT3_MA(b_ma, b_trangkt);
            DataTable b_dt = (DataTable)a_object[2];
            int b_hang = bang.Fi_TIM_ROW(b_dt, "ma", b_ma);
            return b_hang.ToString() + "#" + chuyen.OBJ_S(a_object[0]) + "#" + chuyen.OBJ_S(a_object[1]) + "#" + bang.Fs_BANG_CH(b_dt, a_cot);
        }
    ...
    [WebMethod(true)]
    public string Fs_NS_HDNS_NAM_BT3_CT(string b_login, string b_ma)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            DataSet b_ds = ns_hdns.Fds_NS_HDNS_NAM_BT3_CT(b_ma);
            DataTable b_dt = b_ds.Tables[0];
            DataTable b_dt_tt = b_ds.Tables[1];
            bang.P_SO_CNG(ref b_dt, "ngay_tl");
            bang.P_SO_CNG(ref b_dt, "ngay_gt");

            se.P_TG_LUU("ns_hdns_bt3_NAM", "DT_TT", b_dt_tt);
            bang.P_TIM_THEM(ref b_dt, "ns_hdns_bt3_NAM", "DT_TT", "ma_tt");
    ...
    [WebMethod(true)]
    public string Fs_NS_HDNS_NAM_BT3_LKE(string b_login, double[] a_tso, string[] a_cot)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            ...
            object[] a_object = ns_hdns.Fdt_NS_HDNS_NAM_BT3_LKE(b_tu_n, b_den_n); ;
            DataTable b_dt = (DataTable)a_object[1];
            bang.P_SO_CNG(ref b_dt, "ngay_tl");
            bang.P_SO_CNG(ref b_dt, "ngay_gt");
            return chuyen.OBJ_S(a_object[0]) + "#" + bang.Fs_BANG_CH(b_dt, a_cot);
    ...
    [WebMethod(true)]
    public string Fs_NS_HDNS_NAM_BT3_NH(string b_login, double b_trangKT, object[] a_dt_ct, string[] a_cot_lke)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            ...
            ns_hdns.P_NS_HDNS_NAM_BT3_NH(b_dt_ct);
            // ghi log
            hts_dungchung.PHT_LOG_NH(PHANHE.HDNS, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.NHAP, TEN_FORM.NS_HDNS_MA_VTCDANH, TEN_BANG.NS_HDNS_MA_VTCDANH);
            string b_ma = mang.Fs_TEN_GTRI("ma", a_cot, a_gtri);
            return Fs_NS_HDNS_NAM_BT3_MA(b_login, b_ma, b_trangKT, a_cot_lke);
        }
        catch (Exception ex) { return form.Fs_LOC_LOI(ex.Message); }
    }
    [WebMethod(true)]
    public string Fs_NS_HDNS_NAM_BT3_XOA(string b_login, string b_ma, double[] a_tso, string[] a_cot, object[] a_dt_ct)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            ...
            foreach (DataRow dr in b_dt_ct.Rows)
            {
                ...
                {
                    ns_hdns.P_NS_HDNS_NAM_BT3_XOA(b_ma); return Fs_NS_HDNS_NAM_BT3_LKE(b_login, a_tso, a_cot);
                }
                else { b_ma_trung += dr["ma"].ToString() + ", "; }
            }
            // ghi log
    ...
    #region NAM_bai4
    [WebMethod(true)]
    public string Fs_NAM_BAI4_LKE(string b_login, double[] a_tso, string[] a_cot)

    {
        try
        {
            ...
            object[] a_object = ns_hdns.Fdt_NAM_BAI4_LKE(b_tu_n, b_den_n); ;
    ...
    [WebMethod(true)]
    public string Fs_NAM_BAI4_NH(string b_login, double b_trangKT, object[] a_dt_ct, string[] a_cot_lke)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            ...
            bang.P_CNG_SO(ref b_dt_ct, "ngay_tl");
            bang.P_CNG_SO(ref b_dt_ct, "ngay_ad");
            ns_hdns.P_NAM_BAI4_NH(b_dt_ct);
            string b_ma = mang.Fs_TEN_GTRI("ma", a_cot, a_gtri);
            return Fs_NAM_BAI4_MA(b_login, b_ma, b_trangKT, a_cot_lke);
        }
        catch (Exception ex) { return form.Fs_LOC_LOI(ex.Message); }
    }

    [WebMethod(true)]
    public string Fs_NAM_BAI4_MA(string b_login, string b_ma, double b_trangkt, string[] a_cot)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            object[] a_object = ns_hdns.Fdt_NAM_BAI4_MA(b_ma, b_trangkt);
            DataTable b_dt = (DataTable)a_object[2];
            bang.P_SO_CNG(ref b_dt, "ngay_tl");
            bang.P_SO_CNG(ref b_dt, "ngay_ad");
            int b_hang = bang.Fi_TIM_ROW(b_dt, "ma", b_ma);
    ...
    [WebMethod(true)]
    public string Fs_NAM_BAI4_CT(string b_login, string b_ma)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
    ...
    [WebMethod(true)]
    public string Fs_NAM_BAI4_XOA(string b_login, string b_ma, double[] a_tso, string[] a_cot, object[] a_dt_ct)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            ...
            foreach (DataRow dr in b_dt_ct.Rows)
            {
                ...
                if (b_tontai <= 0)
                {
                    ...
                    ns_hdns.P_NAM_BAI4_XOA(b_ma); return Fs_NAM_BAI4_LKE(b_login, a_tso, a_cot);
                }
                else { b_ma_trung += dr["ma"].ToString() + ", "; }
            }
            // ghi log
    ...
    #region Tinbai4
    [WebMethod(true)]
    public string Fs_TIN_BAI4_LKE(string b_login, double[] a_tso, string[] a_cot)

    {
        try
        {
            ...
            object[] a_object = ns_hdns.Fdt_TIN_BAI4_LKE(b_tu_n, b_den_n); ;
    ...
    [WebMethod(true)]
    public string Fs_TIN_BAI4_NH(string b_login, double b_trangKT, object[] a_dt_ct, string[] a_cot_lke)
     {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            ...
            bang.P_CNG_SO(ref b_dt_ct, "ngay_tl");
            bang.P_CNG_SO(ref b_dt_ct, "ngay_ad");
            ns_hdns.P_TIN_BAI4_NH(b_dt_ct);
            string b_ma = mang.Fs_TEN_GTRI("ma", a_cot, a_gtri);
            return Fs_TIN_BAI4_MA(b_login, b_ma, b_trangKT, a_cot_lke);
         }
        catch (Exception ex) { return form.Fs_LOC_LOI(ex.Message); }
    }

     [WebMethod(true)]
    public string Fs_TIN_BAI4_MA(string b_login, string b_ma, double b_trangkt, string[] a_cot)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            object[] a_object = ns_hdns.Fdt_TIN_BAI4_MA(b_ma, b_trangkt);
            DataTable b_dt = (DataTable)a_object[2];
            bang.P_SO_CNG(ref b_dt, "ngay_tl");
            bang.P_SO_CNG(ref b_dt, "ngay_ad");
            int b_hang = bang.Fi_TIM_ROW(b_dt, "ma", b_ma);
    ...
    [WebMethod(true)]
    public string Fs_TIN_BAI4_CT(string b_login, string b_ma)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            DataSet b_ds = ns_hdns.Fds_TIN_BAI4_CT(b_ma);
            DataTable b_dt = b_ds.Tables[0];
            return (bang.Fb_TRANG(b_dt)) ? "" : bang.Fs_HANG_GOP(b_dt, 0);
        }
        catch (Exception ex) { return form.Fs_LOC_LOI(ex.Message); }
    ...
    [WebMethod(true)]
    public string Fs_TIN_BAI4_XOA(string b_login, string b_ma, double[] a_tso, string[] a_cot, object[] a_dt_ct)
    {
        try
        {
            if (b_login != "") se.P_LOGIN(b_login);
            ...
            foreach (DataRow dr in b_dt_ct.Rows)
            {
                ...
                if (b_tontai <= 0)
                {
                    ...
                    ns_hdns.P_TIN_BAI4_XOA(b_ma); return Fs_TIN_BAI4_LKE(b_login, a_tso, a_cot);
                }
                else { b_ma_trung += dr["ma"].ToString() + ", "; }
            }
            // ghi log
    ...
    //        double b_tu_n = chuyen.OBJ_N(a_tso[0]), b_den_n = chuyen.OBJ_N(a_tso[1]);
    //        object[] a_object;
    //        a_object = ns_hdns.Fdt_TIN_BAI4_LKE( b_tu_n, b_den_n);
    //        DataTable b_dt = (DataTable)a_object[1];
    //        bang.P_SO_CNG(ref b_dt, "ngay_tl");
    //        bang.P_SO_CNG(ref b_dt, "ngay_ad");
    //        return chuyen.OBJ_S(a_object[0]) + "#" + bang.Fs_BANG_CH(b_dt, a_cot);
