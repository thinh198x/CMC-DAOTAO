<%@ Page Title="ns_ktkl_qlkl" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_ktkl_qlkl.aspx.cs" Inherits="f_ns_ktkl_qlkl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="main_content" class="container_content hide_sbar">
        ...
        <div class="r_c_content b_right">
            <div class="title_dmuc width_common">
                <Cthuvien:luu ID="tenForm" runat="server" Text="Quản lý kỷ luật" />
                <img class="b_right" src="../../../images/eDoc/icon_close.png" alt="" onclick="return form_dong();" />
            </div>
            <div class="width_common auto_sc line_46">
                <div class="b_left col_40 inner" id="UPa_tk">
                    <div class="b_left form-group iterm_form">
                        <span class="standard_label lv2 b_left col_30">Đối tượng kỷ luật</span>
                        <div class="input-group">
                            <Cthuvien:DR_list ID="dtkl_tk" runat="server" onchange="checkanhien();" CssClass="form-control css_list" ToolTip="Đối tượng kỷ luật" />
                        </div>
                    </div>
                    ...
                    <div class="b_right form-group iterm_form">
                        ...
                        <div class="input-group">
                            <Cthuvien:ma ID="ten_tk" ten="Tên nhân viên" runat="server" CssClass="form-control css_ma" kt_xoa="X" kieu_chu="false" />
                        </div>
                    </div>
                    <div class="b_right form-group iterm_form">
                    ...
                    <div class="b_left form-group iterm_form">
                        <Cthuvien:nhap ID="timki" runat="server" Text="Tìm kiếm" anh="K" class="bt_action" onclick="return ns_ktkl_qlkl_P_LKE();form_P_LOI();" />
                    </div>
                    <div class="grid_table width_common css_divb">
                        <div style="overflow-x: scroll">
                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                CssClass="table gridX" loai="X" Width="100%" hangKt="10" cotAn="so_id,dtuong,trangthai" hamRow="ns_ktkl_qlkl_GR_lke_RowChange()">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Họ tên" DataField="ten" HeaderStyle-Width="100px" ItemStyle-CssClass="css_Gnd" />
                                    <asp:BoundField HeaderText="Hình thức kỷ luật" HeaderStyle-Width="150px" DataField="hinhthuc" ItemStyle-CssClass="css_Gnd" />
                                    <asp:BoundField HeaderText="Số tiền" DataField="sotien" HeaderStyle-Width="120px" ItemStyle-CssClass="css_nd_r" />
                        ...
                        <ctr_khud_divL:ctr_khud_divL ID="Ctr_khud_divL1" runat="server" loai="X" gridId="GR_lke" ham="ns_ktkl_qlkl_P_LKE()" />
                    </div>
                ...
                <div class="b_right col_60 inner" id="UPa_ct">
                    <div class="width_common pv_bl"><span>Thông tin Quyết định kỷ luật</span></div>
                    <div class="col_2_iterm width_common">
                        <div class="b_left form-group iterm_form">
                            <span class="standard_label lv2 b_left col_40">Ngày hiệu lực<span class="require">*</span></span>
                            <div class="input-group">                                
                                <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="NGAY_HL" runat="server" ten="Ngày hiệu lực" ToolTip="Ngày hiệu lực" CssClass="form-control css_ngay" kt_xoa="X" />
                            </div>
                        </div>
                        <div class="b_right form-group iterm_form">
                            <span class="standard_label lv2 b_left col_40">Ngày hết hiệu lực </span>
                            <div class="input-group">
                                <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="ngay_hhl" runat="server" ten="Ngày hết hiệu lực" ToolTip="Ngày hết hiệu lực" CssClass="form-control css_ngay" kt_xoa="X" />
                            </div>
                        </div>
                    </div>
                    <div class="col_2_iterm width_common">
                    ...
                    <div class="col_2_iterm width_common">
                        ...
                        <div class="b_right form-group iterm_form">
                            <span class="standard_label lv2 b_left col_40">Ngày ban hành<span class="require">*</span></span>
                            <div class="input-group">
                                <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="NGAYKY" runat="server" ten="Ngày ban hành" CssClass="form-control css_ngay" kt_xoa="X" ToolTip="Ngày ban hành" />
                            </div>
                        </div>
                    </div>
                    <div class="col_2_iterm width_common">
                    ...
                    <div class="width_common pv_bl"><span>Thông tin kỷ luật</span></div>
                    <div class="col_2_iterm width_common">
                        <div class="b_left form-group iterm_form">
                            <span class="standard_label lv2 b_left col_40">Đối tượng kỷ luật<span class="require">*</span></span>
                            <div class="input-group">
                    ...
                    <div id="an_canhan">
                        <div class="col_2_iterm width_common">
                            <div class="b_left form-group iterm_form">
                                ...
                                <div class="input-group">
                                    <Cthuvien:ma ID="so_the" runat="server" kt_xoa="X" CssClass="form-control css_ma" f_tkhao="~/App_form/ns/tt/ns_cb_chon.aspx" ktra="ns_cb,so_the,ten" placeholder="Nhấn (F1)" BackColor="#f6f7f7" ToolTip="Mã nhân viên" MaxLength="20" />
                                </div>
                            </div>
                            <div class="b_right form-group iterm_form">
                        ...
                        <div class="grid_table width_common css_divCn">
                            <div>
                                <Cthuvien:GridX ID="GR_ct" runat="server" AutoGenerateColumns="false" PageSize="1"
                                    CssClass="table gridX" loai="N" Width="100%" cot="so_thenv,tennv,ten_cdanhnv,ten_dvinv,cdanhnv,dvinv" cotAn="cdanhnv,dvinv" hangKt="5" gchuId="gchu" ctrT="so_tt" ctrS="nhap">
                                    <Columns>
                                        <asp:BoundField DataField="leGrid" HeaderStyle-Width="10px" />
                                        ...
                                        <asp:TemplateField HeaderText="Vị trí chức danh">
                                            <ItemTemplate>
                                                <Cthuvien:ma ID="ten_cdanhnv" runat="server" kieu_unicode="true" CssClass="css_Gma" kt_xoa="X" ReadOnly="true" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Đơn vị">
                                            <ItemTemplate>
                                                <Cthuvien:ma ID="ten_dvinv" runat="server" Width="100%" kieu_unicode="true" CssClass="css_Gma" kt_xoa="X" ReadOnly="true" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                    ...
                    <div class="col_2_iterm width_common">
                        <div class="b_left form-group iterm_form">
                            <span class="standard_label lv2 b_left col_40">Cấp kỷ luật<span class="require">*</span></span>
                            <div class="input-group">
                                <Cthuvien:DR_list ID="CAP_KTKL" runat="server" onchange="checkanhien();" CssClass="form-control css_list" ToolTip="Cấp kỷ luật" />
                            </div>
                        </div>
                        <div class="b_right form-group iterm_form">
                            <span class="standard_label lv2 b_left col_40">Trừ tiền thưởng tháng</span>
                            <div class="input-group">
                                <Cthuvien:so ID="sotien" co_dau="K" runat="server" kt_xoa="X" CssClass="form-control css_so" MaxLength="20" so_tp="3" ToolTip="Số tiền" />
                                <Cthuvien:ma ID="ma_nte" runat="server" kt_xoa="K" CssClass="css_ma_c" kieu_chu="true" BackColor="#DBE8F1" Width="26px" Height="22px" Text="VND" ten="Mã tiền tệ" />
                            </div>
                        </div>
                    </div>
                    <div class="col_2_iterm width_common">
                        <div class="b_left form-group iterm_form">
                            <span class="standard_label lv2 b_left col_40">Hình thức kỷ luật <span class="require">*</span></span>
                            <div class="input-group">
                                <Cthuvien:DR_lke ID="HINHTHUC" runat="server" ten="Hình thức kỷ luật" ToolTip="Hình thức kỷ luật" kt_xoa="X" ktra="DT_HTKL" CssClass="form-control css_list" onchange="ns_ktkl_qlkl_P_KTRA('HINHTHUC');" />
                            </div>
                        </div>
                        <div class="b_right form-group iterm_form">
                        </div>
                    ...
                    <div class="b_left form-group iterm_form">
                        <span class="standard_label lv2 b_left col_20">Lý do kỷ luật </span>
                        <div class="input-group">
                    ...
                    <div id="an_canhan1">
                        <div class="b_left form-group iterm_form">
                            <span class="standard_label lv2 b_left col_20">Có trừ vào lương</span>
                            <div class="input-group">
                                <Cthuvien:kieu ID="tvluong" runat="server" kt_xoa="X" lke=",X" tra=",X" Width="30px" ToolTip="X - Có trừ vào lương" CssClass="form-control css_ma_c" onchange="checkanhien();" MaxLength="1" />
                            </div>
                        </div>
                        <div class="col_2_iterm width_common" id="an_truluong" style="display: none">
                            <div class="b_left form-group iterm_form">
                    ...
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="moi" runat="server" Text="Làm mới" class="bt_action" anh="K" OnClick="return ns_ktkl_qlkl_P_MOI();form_P_LOI();" Width="100px" />
                        <Cthuvien:nhap ID="ghi" runat="server" Text="Ghi" class="bt_action" anh="K" OnClick="return ns_ktkl_qlkl_P_NH();form_P_LOI();" Width="100px" />
                        <Cthuvien:nhap ID="in" runat="server" Text="In" Width="70px" class="bt_action" anh="K" title="In" OnServerClick="msword_Click" />
                        <Cthuvien:nhap ID="xoa" runat="server" Text="Xóa" class="bt_action" anh="K" OnClick="return ns_ktkl_qlkl_P_XOA();form_P_LOI();" Width="100px" />
    ...
    <div id="UPa_hi">
        ...
        <Cthuvien:an ID="andtkl" runat="server" />
        <Cthuvien:an ID="dtkl_Hi" runat="server" />
        <Cthuvien:an ID="tungay_Hi" runat="server" />
        <Cthuvien:an ID="denngay_Hi" runat="server" />
        <Cthuvien:an ID="tthai_Hi" runat="server" />
        <Cthuvien:an ID="phong_Hi" runat="server" />
        <Cthuvien:an ID="kthuoc" runat="server" Value="1400,820" />
    </div>
</asp:Content>
