<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_dt_kh_ct_tkb.aspx.cs" Inherits="f_ns_dt_kh_ct_tkb"
    Title="ns_dt_kh_ct_tkb" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
                                    ...
                                    <td>
                                        <table id="UPa_tk">
                                            <tr>
                                                ...
                                                <td>                                                    
                                                    <Cthuvien:DR_lke ID="dr_ngay" ktra="DT_KH_TKB" runat="server" Width="175px" onchange="ns_dt_kh_ct_tkb_P_DR_CHANGE()" style="float:left;"></Cthuvien:DR_lke>
                                                </td>
                                                <td>    
                                                ...
                                                <td>
                                                    <Cthuvien:nhap ID="doi" runat="server" Width="80px" Text="Đổi" OnClick="return ns_dt_kh_ct_tkb_P_DOI_NGAY();" />  
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="False" PageSize="1"
                                            CssClass="table gridX" loai="X" hangKt="10" cotAn="so_id" hamRow="ns_dt_kh_ct_tkb_GR_lke_RowChange()">
                                            <Columns>
                                    ...
                                    <td>
                                        <table cellpadding="1" cellspacing="1">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <Cthuvien:so ID="thluong" ten="Thời lượng đào tạo" runat="server" Width="150px" CssClass="css_form_r" kt_xoa="X" onchange="ns_dt_kh_ct_tkb_P_KTRA('thluong');" co_dau="K" MaxLength="5" />
                                                </td>
                                            </tr>                                            
                                            <tr>
                                                <td align="left">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <Cthuvien:kieu ID="loai_gv" runat="server" CssClass="css_ma_c" Width="22px" lke="NB,NG" Text="NB" ToolTip="Loại GV: NB-Nội bộ, NG-Ngoài" onchange="ns_dt_kh_ct_tkb_P_KTRA('LOAI_GV')"/>
                                               </td>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <Cthuvien:ma ID="gvien" runat="server" CssClass="css_form" kt_xoa="X" ten="Giảng viên"
                                                        Width="150px" onchange="ns_dt_kh_ct_tkb_P_KTRA('GVIEN')" f_tkhao="~/App_form/ns/tt/ns_cb_chon.aspx" ktra="NS_CB,ma,ten" ToolTip="Ấn F1 để chọn GV" BackColor="#f6f7f7"></Cthuvien:ma>
                                                    <Cthuvien:ma ID="SO_ID_GV" runat="server" CssClass="css_form" kt_xoa="X" ten="Giảng viên" Width="0px" style="display:none;"></Cthuvien:ma>
                                                </td>
                                            </tr>                                                
                                            <tr>
                                                <td align="left">
                                                    <asp:Label ID="Label6" runat="server" CssClass="css_gchu">Loại hình giảng dạy</asp:Label>
                                                </td>
                                                <td align="left">
                                                    <Cthuvien:DR_lke ID="ma_lhgd" ktra="DT_MA_LHGD" runat="server" Width="160px"></Cthuvien:DR_lke>                                                    
                                                 </td>
                                                <td align="left">                                                    
                                                </td>
                                                <td align="left">                                                    
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <Cthuvien:bbuoc ID="Bbuoc2" runat="server" CssClass="css_gchu" Text="Giờ bắt đầu" />
                                                </td>
                                                <td align="left">
                                                    <Cthuvien:ma ID="GIO_D" runat="server" CssClass="css_form_c" kt_xoa="X" ten="Giờ bắt đầu"
                                                        Width="160px" MaxLength="5" onchange="ns_dt_kh_ct_tkb_P_KTRA('GIO_D');"></Cthuvien:ma>
                                                </td>
                                                <td align="left">
                                                    <Cthuvien:bbuoc ID="Bbuoc4" runat="server" CssClass="css_gchu" Text="Giờ kết thúc" />      
                                                </td>
                                                <td align="left">
                                                    <Cthuvien:ma ID="GIO_C" runat="server" CssClass="css_form_c" kt_xoa="X" ten="Giờ kết thúc"
                                                        Width="150px" MaxLength="5" onchange="ns_dt_kh_ct_tkb_P_KTRA('GIO_C');"></Cthuvien:ma>
                                                </td>
                                            </tr>   
                                            <tr>
                                                <td align="left">
