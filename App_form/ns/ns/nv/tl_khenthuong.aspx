                                ...
                                <tr>
                                    <td>
                                       <%-- <div style="height: 200px; width: 334px;overflow-y: scroll;">--%>
                                            ...
                                            loai="L" hangKt="5" cotAn="ma,ma_ct,nsd" hamRow="ht_maph_GR_lke_RowChange()">
                                            <Columns>
                                                ...
                                                <td align="left">
                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <Cthuvien:ma ID="Ma2" ten="tên nhân viên" runat="server"  CssClass="css_form" kieu_unicode="True"
                                                                    kt_xoa="G" Width="184px" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            <td>
                                                                <Cthuvien:ma ID="Ma3" ten="chức danh" runat="server" CssClass="css_form" kieu_chu="True" 
                                                                    kt_xoa="G" Width="136px" />
                                                            </td>
                                                            <td align="left">
                                                                <Cthuvien:bbuoc ID="Bbuoc15" runat="server" CssClass="css_gchu_c" Width="110px">Chức danh</Cthuvien:bbuoc>
                                                            </td>
                                                            <td>
                                                                <Cthuvien:ma ID="Ma4" ten="phòng ban" runat="server" CssClass="css_form" kieu_chu="True" 
                                                                    kt_xoa="G" Width="184px" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            <td>
                                                                <Cthuvien:ma ID="Ma1" ten="chức danh" runat="server" CssClass="css_form" kieu_chu="True" 
                                                                    kt_xoa="G" Width="136px" />
                                                            ...
                                                            <td>
                                                                <Cthuvien:so ID="So1" ten="tiên lương" runat="server"   CssClass="css_form_r" kieu_chu="True"
                                                                    kt_xoa="G" Width="184px" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Cthuvien:DR_nhap ID="DR_nhap1" ten="kỳ lương" runat="server" DataTextField="ten" DataValueField="so_id"
                                                                    ...
                                                                    <asp:ListItem Selected="True" Text="Cấp 1" Value="1"></asp:ListItem>
                                                            ...
                                                            <td>
                                                                <Cthuvien:so ID="So2" ten="tiên lương" runat="server"   CssClass="css_form_r" kieu_chu="True"
                                                                    kt_xoa="G" Width="184px" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Cthuvien:DR_nhap ID="DR_nhap4" ten="kỳ lương" runat="server" DataTextField="ten" DataValueField="so_id"
                                                                    CssClass="css_form_c" kieu="S" Width="136px" onchange="tl_khenthuong_load_luong()" >
                                                                    <asp:ListItem Selected="True" Text="Hình thức 1" Value="1"></asp:ListItem>
                                                                    <asp:ListItem Text="Hình thức 2" Value="2"></asp:ListItem>
                                                                </Cthuvien:DR_nhap>
                                                            </td>
                                                ...
                                                <td align="left">
                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <Cthuvien:so ID="So3" ten="tiên lương" runat="server"   CssClass="css_form_r" kieu_chu="True"
                                                                    kt_xoa="G" Width="125px" />
                                                            </td>
                                                            <td align="left">
                                                            ...
                                                            <td>
                                                                <Cthuvien:DR_nhap ID="DR_nhap2" ten="kỳ lương" runat="server" DataTextField="ten" DataValueField="so_id"
                                                                    ...
                                                                    <asp:ListItem Selected="True" Text="Kỳ 1" Value="1"></asp:ListItem>
                                                                    <asp:ListItem Text="Kỳ 2" Value="2"></asp:ListItem>
                                                                </Cthuvien:DR_nhap>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <div class="box3 txRight2">
                                                        <a href="#" onclick="return ns_kthuong_P_NH();form_P_LOI();" class="bt bt-grey"><i class="fa fa-save"></i><span class="txUnderline">N</span>hập</a>
                                                        <a href="#" onclick="return ns_kthuong_P_MOI();form_P_LOI();" class="bt bt-grey"><span class="txUnderline">M</span>ới</a>
                                                        <a href="#" class="bt bt-grey" onclick="return ns_kthuong_P_XOA();form_P_LOI();"><i class="fa fa-trash-o"></i><span class="txUnderline">X</span>óa</a>
                                                        <a href="#" onclick="return ns_kthuong_P_IN();form_P_LOI();" class="bt bt-grey"><i class="fa fa-excel"></i><span class="txUnderline">X</span>uất excel</a>
                                                    </div>
                                                </td>
