<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_dt_thuchien_bt_xem.aspx.cs" Inherits="f_ns_dt_thuchien_bt_xem"
    Title="ns_dt_thuchien_bt_xem" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
    ...
    <div id="main_content" class="container_content hide_sbar">
        <div class="r_c_content b_right">
            <div class="title_dmuc width_common">
                <Cthuvien:luu ID="tenForm" runat="server" Text="Kết quả bài thi" />
                ...
                <div class="col_60 inner" id="UPa_ct">
                    ...
                    <div class="col_2_iterm width_common">
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group" id="trHoanThanh2">
                        ...
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group" id="trDapan2">
                                <Cthuvien:gchu ID="diem" runat="server" Font-Bold="true" CssClass="css_gchu" kt_xoa="K" />
                            </div>
                        </div>
                    </div>
                    <div class="grid_table width_common" id="GR_v2" style="display:none;">
                        <div id="trtraloi">
                                ...
                                <div id="bt_grid">
                                    <div style="overflow-x:scroll;">
                                        <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1" Width="100%"
                                            CssClass="gridX" loai="N" hangKt="5" cot="so_id,STT,traloi,dapan" cotAn="so_id,nsd"
                                    ...
                                    <div id="trphantrang">
                                        <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_dt_thuchien_bt_P_LKE()" />
                                    </div>
                                </div>
                    ...
                    <div class="list_bt_action" id="UPa_nhap">
                      ...
                      <%--  <a id="btnquaylai" href="#" class="bt_action" onclick="return ns_dt_thuchien_bt_P_TIEPTHEO_QUAYLAI();form_P_LOI();"><i class="fa fa-start"></i>Quay lại</a>
                        <a id="btntieptheo" class="bt_action" href="#" onclick="return ns_dt_thuchien_bt_P_TIEPTHEO_TIEPTHEO();form_P_LOI();"><i class="fa fa-view"></i>Tiếp theo</a>
                       ...
                       <%-- <a id="btnclose" class="bt_action" href="#" onclick="return ns_dt_thuchien_bt_P_DONG();form_P_LOI();"><i class="fa fa-firefox"></i>Đóng</a>--%>
                    </div>
