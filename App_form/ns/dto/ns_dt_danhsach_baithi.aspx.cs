...
public partial class f_ns_dt_danhsach_baithi : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                string b_s = this.ResolveUrl("~/App_form/ns/dto/ns_dt_danhsach_baithi" + khac.Fs_runMode() + ".js?x=" + DateTime.Now.ToString("yyyyMMddHHmmss"));
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ns_dt_danhsach_baithi_P_KD('" + b_so_the + "');", true);
                P_NHAN_DROP();
            }
        }
