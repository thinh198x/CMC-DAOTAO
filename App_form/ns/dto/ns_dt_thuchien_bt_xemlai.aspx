<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_dt_thuchien_bt_xemlai.aspx.cs" Inherits="f_ns_dt_thuchien_bt_xemlai"
    Title="ns_dt_thuchien_bt_xemlai" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
    ...
    <div id="main_content" class="container_content hide_sbar">
        <div class="r_c_content b_right">
            <div class="title_dmuc width_common">
                <Cthuvien:luu ID="tenForm" runat="server" Text="Xem lại bài thi" />
            ...
            <div class="width_common auto_sc">
                <div class="col_60 inner" id="UPa_ct">
                    ...
                    <div class="col_2_iterm width_common">
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ma ID="SO_THE" ten="Mã nhân viên" runat="server" Enabled="false" ReadOnly="true" CssClass="form-control css_ma" Width="150px" gchu="gchu" />
                            </div>
                        </div>
                        <div class="b_left iterm_form">
                            <span class="standard_label b_left col_40">Họ tên</span>
                            <div class="input-group">
                                <Cthuvien:ma ID="ho_ten" ten="Họ Tên nhân viên" runat="server" Enabled="false" ReadOnly="true" CssClass="form-control css_ma" Width="250px" gchu="gchu" />
                            </div>
                        </div>
                    </div>
                    <div class="col_2_iterm width_common">
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ma ID="ten_kythi" ten="Tên kỳ thi" runat="server" Enabled="false" ReadOnly="true" CssClass="form-control css_ma" Width="514px" gchu="gchu" />
                            </div>
                        </div>
                    </div>
                    <div class="col_2_iterm width_common">
                                ...
                                <div id="bt_grid">
                                    <div style="overflow-x:scroll;">
                                        <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1" Width="100%"
                                            ...
                                            onchange="ns_dt_thuchien_bt_xemlai_GR_lke_RowChange()">
                                            <Columns>
                                    ...
                                    <div id="trphantrang" style="display:none;">
                                        <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_dt_thuchien_bt_xemlai_P_TRALOI()" />
                                    </div>
                                </div>
                    ...
                    <div class="list_bt_action" id="UPa_nhap">
                        <Cthuvien:nhap ID="btnquaylai" runat="server" Width="100px" class="bt_action" anh="K" Text="Quay lại" OnClick="return ns_dt_thuchien_bt_xemlai_P_TIEPTHEO_QUAYLAI();form_P_LOI();" />
