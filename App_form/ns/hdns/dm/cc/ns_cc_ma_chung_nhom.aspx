<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_cc_ma_chung_nhom.aspx.cs" Inherits="f_ns_cc_ma_chung_nhom"
    Title="ns_cc_ma_chung_nhom" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <td class="form_left" valign="top">                            
                            <div>
                                <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                    CssClass="table gridX" loai="X" cotAn="nsd,trangthai,mota" hangKt="10" hamRow="ns_cc_ma_chung_nhom_GR_lke_RowChange()">
                                    <Columns>
                                        <asp:BoundField DataField="leGrid" HeaderStyle-Width="10px" />
                                        <asp:BoundField HeaderText="Mã nhóm danh mục" DataField="ma" HeaderStyle-Width="145px">
                                            <ItemStyle CssClass="css_Gma" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="Tên nhóm danh mục" DataField="ten" HeaderStyle-Width="190px">
                                            <ItemStyle CssClass="css_Gnd" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="Trạng thái" DataField="ten_trangthai" HeaderStyle-Width="90px">
                                            <ItemStyle CssClass="css_Gnd" />
                                        </asp:BoundField>
                            ...
                            <div>
                                <khud:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_cc_ma_chung_nhom_P_LKE()" />
                            </div>                            
                        </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                   <Cthuvien:ma ID="MA" ten="Mã nhóm danh mục" runat="server" CssClass="css_form" kieu_chu="True"
                                                                    kt_xoa="G" onchange="ns_cc_ma_chung_nhom_P_KTRA('MA')" Width="240px" MaxLength="20" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <div class="box3 txCenter">
                                                        <Cthuvien:nhap ID="moi" runat="server" Text="Làm mới" OnClick="return ns_cc_ma_chung_nhom_P_MOI();form_P_LOI();" /> 
                                                        <Cthuvien:nhap ID="nhap" runat="server" Width="80px" Text="Ghi" OnClick="return ns_cc_ma_chung_nhom_P_NH();form_P_LOI();" />
                                                        <Cthuvien:nhap ID="chon" runat="server" Width="80px" Text="Chọn" OnClick="return form_P_TRA_CHON('MA,TEN');form_P_LOI();" />   
                                                        <Cthuvien:nhap ID="xoa" runat="server" Width="80px" Text="Xóa" OnClick="return ns_cc_ma_chung_nhom_P_XOA();form_P_LOI();" />
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
    ...
    <Cthuvien:an ID="kthuoc" runat="server" Value="1000,520" />
</asp:Content>
