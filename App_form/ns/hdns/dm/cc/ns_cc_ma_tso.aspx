<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_cc_ma_tso.aspx.cs" Inherits="f_ns_cc_ma_tso"
    Title="ns_cc_ma_tso" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
        ...
        <tr>
            <td align="center">
                <table cellpadding="1" cellspacing="1">
                    <tr>
                        <td align="left">
                            <Cthuvien:luu ID="Luu1" runat="server" CssClass="css_tieudeM" Text="Danh mục tham số hệ thống" />
                        </td>
                        <td align="right">
                            <table cellpadding="1" cellspacing="1">
                                <tr>
