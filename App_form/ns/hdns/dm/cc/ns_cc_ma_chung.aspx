<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_cc_ma_chung.aspx.cs" Inherits="f_ns_cc_ma_chung"
    Title="ns_cc_ma_chung" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
        ...
        <tr>
            <td align="center">
                <table cellpadding="1" cellspacing="1">
                    <tr>
                        <td align="left">
                            <Cthuvien:luu ID="Luu1" runat="server" CssClass="css_tieudeM" Text="Danh mục dùng chung chấm công" />
                        </td>
                        <td align="right">
                            <table cellpadding="1" cellspacing="1">
                                <tr>
                        ...
                        <td class="form_left" valign="top">
                            <div>
                                <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                    CssClass="table gridX" loai="X" hangKt="10" cotAn="nsd,NHOM_MA,thamso1,thamso2,trangthai,mota" hamRow="ns_cc_ma_chung_GR_lke_RowChange()">
                                    <Columns>
                            ...
                            <div>
                                <khud:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_cc_ma_chung_P_LKE()" />
                            </div>
                        </td>
                                    ...
                                    <td>
                                        <table id="UPa_ct" runat="server" cellpadding="1" cellspacing="1">
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <Cthuvien:DR_lke ID="NHOM_MA" ktra="DT_CC_MA_CHUNG_NHOM" runat="server" ten="Nhóm danh mục" kt_xoa="G" Width="190px"></Cthuvien:DR_lke>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <Cthuvien:ma ID="MA" ten="Mã danh mục" runat="server" CssClass="css_form" kieu_chu="True"
                                                        kt_xoa="G" onchange="ns_cc_ma_chung_P_KTRA('MA')" Width="190px" MaxLength="20" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <Cthuvien:ma ID="TEN" ten="Tên danh mục" runat="server" kieu_unicode="true" CssClass="css_form" kt_xoa="X" Width="190px" MaxLength="255" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left">
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <div class="box3 txCenter">
                                                        <Cthuvien:nhap ID="moi" runat="server" Text="Làm mới" OnClick="return ns_cc_ma_chung_P_MOI();form_P_LOI();" />
                                                        <Cthuvien:nhap ID="nhap" runat="server" Width="80px" Text="Ghi" OnClick="return ns_cc_ma_chung_P_NH();form_P_LOI();" />
                                                        <Cthuvien:nhap ID="chon" runat="server" Width="80px" Text="Chọn" OnClick="return form_P_TRA_CHON('MA,TEN');form_P_LOI();" />
                                                        <Cthuvien:nhap ID="xoa" runat="server" Width="80px" Text="Xóa" OnClick="return ns_cc_ma_chung_P_XOA();form_P_LOI();" />
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
