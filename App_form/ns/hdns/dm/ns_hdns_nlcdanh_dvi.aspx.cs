...
public partial class f_ns_hdns_nlcdanh_dvi : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        { 
            if (!IsPostBack) 
            {
                ...
                string b_s = this.ResolveUrl("~/App_form/ns/hdns/dm/ns_hdns_nlcdanh_dvi" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
                ScriptManager.RegisterClientScriptInclude(this.Page, this.GetType(), Guid.NewGuid().ToString(), b_s);
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ns_hdns_nlcdanh_dvi_P_KD();", true);
   ...
   private void P_TT_DROP()
    ...
    protected void btn_excel_mau_Click(object sender, EventArgs e)
    {
        ...
        Excel_dungchung.ExportTemplate("Templates/importhdns/ns_hdns_nlcdanh_dvi_ktao.xls", b_ds, null, "ns_hdns_nlcdanh_dvi_kt");
    }
