        ...
        <tr>
            <td align="center">
                <table cellpadding="1" cellspacing="1">
                    <tr>
                        <td align="left">
                            <Cthuvien:luu ID="Luu1" runat="server" CssClass="css_tieudeM" Text="Xây dựng mức năng lực" />
                        </td>
                        <td align="right">
                            <table cellpadding="1" cellspacing="1">
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                            CssClass="table gridX" loai="X" hangKt="15" cotAn="nsd,so_id,mota_theomuc,ghichu" hamRow="dgnl_dm_xd_td_nl_GR_lke_RowChange()">
                                            <Columns>
                                    ...
                                    <td>
                                        ...
                                        <table cellpadding="1" cellspacing="1">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Cthuvien:ma ID="NHOM_NL" runat="server" CssClass="css_form" BackColor="#f6f7f7" kieu_chu="true"
                                                                    Width="137px" f_tkhao="~/App_form/ns/hdns/dm/dgnl_dm_n_nl.aspx" gchu="gchu" ten="Nhóm năng lực" kt_xoa="G"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <Cthuvien:ma ID="NANGLUC" runat="server" CssClass="css_form" BackColor="#f6f7f7" kieu_chu="true"
                                                        Width="270px" f_tkhao="~/App_form/ns/hdns/dm/dgnl_dm_nl.aspx" gchu="gchu" ten="năng lực" kt_xoa="X"
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <Cthuvien:ma ID="mota_theomuc" ten="Mô tả năng lực theo mức" runat="server" Height="50px" TextMode="MultiLine" CssClass="css_form" kieu_unicode="True"
                                                        kt_xoa="X" Width="270px" />
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <Cthuvien:ma ID="ghichu" ten="Ghi chú" runat="server" Height="50px" TextMode="MultiLine" CssClass="css_form" kieu_unicode="True"
                                                        kt_xoa="X" Width="270px" />
                                                </td>
                                            </tr>
                                        </table>
                                            ...
                                            <tr>
                                                <td style="padding-top: 5px">
                                                    <div class="box3 txRight">
                                                        ...
                                                        <a href="#" onclick="return dgnl_dm_xd_td_nl_P_MOI();form_P_LOI();" class="bt bt-grey"><span class="txUnderline">M</span>ới</a>
                                                        ...
                                                        <a href="#" onclick="return form_P_TRA_CHON('nhom_nl,nangluc,muc_nl,so_id');form_P_LOI();" class="bt bt-grey"><span class="txUnderline">C</span>họn</a>
