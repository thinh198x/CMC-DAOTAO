<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_hdns_pban_longbai3.aspx.cs" Inherits="App_form_ns_hdns_dm_cdanh_ns_hdns_pban_longbai3"  MasterPageFile="~/trangnen.master" %>
        ...
        <div class="r_c_content b_right">
            ...
            <div class="width_common auto_sc line_64">
                <div class="b_left col_60 inner" id="UPa_tk">
                    ...
                    <div class="b_left form-group iterm_form">
                        <Cthuvien:nhap ID="tim" runat="server" Text="Tìm kiếm" class="bt_action" anh="K" OnClick="ns_hdns_bdlong_bai3_P_LKE('');form_P_LOI('');" Title="Tìm kiếm" />
                    </div>
                    <div class="grid_table width_common">
                        <div style="overflow-x: scroll">
                            <Cthuvien:GridX ID="GR_lke" Width="100%" runat="server" AutoGenerateColumns="false" PageSize="1" CssClass="table gridX" hangKt="15" hamRow="ns_pb_bdlong_bai3_GR_lke_RowChange()"
                            cotAn="ten_ta,ngay_gt,ten_vt,ghi_chu,nsd" loai="X" cthich="chon:Đánh dấu chọn ký">
                                <Columns>
                ...
                <div class="b_right col_40 inner" id="UPa_ct">
                    ...
                    <div class="list_bt_action">
                       	<Cthuvien:nhap ID="moi" runat="server" Text="Làm mới" class="bt_action" anh="K" OnClick="ns_hdns_bdlong_bai3_P_MOI();form_P_LOI('');" Title="Ấn nút để làm mới" />
                        <Cthuvien:nhap ID="nhap" runat="server" Text="Ghi" class="bt_action" anh="K" OnClick="ns_hdns_bdlong_bai3_P_NH();form_P_LOI('');" Title="Ấn nút nhập để nhập mới" />
                        <Cthuvien:nhap ID="Nhapexcel" runat="server" Text="Import" class="bt_action" anh="K" OnClick="ns_hdns_bdlong_bai3_FILE_Import();form_P_LOI('');" Title="Import" />
                        <Cthuvien:nhap ID="xoa" runat="server" Text="Xóa" class="bt_action" anh="K" OnClick="return ns_hdns_bdlong_bai3_P_XOA();form_P_LOI();" Title="Xóa dòng thông tin đang chọn" />
                          <Cthuvien:nhap ID="file" runat="server" Text="File" Width="70px" class="bt_action" anh="K"
                                title="File" OnClick="return ns_hdns_bdlong_bai3_FILE_NHAP();form_P_LOI();" />
                    </div>
