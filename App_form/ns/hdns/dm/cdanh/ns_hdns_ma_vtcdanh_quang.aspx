<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_hdns_ma_vtcdanh_quang.aspx.cs" 
    Inherits="f_ns_hdns_ma_nn_quang" MasterPageFile="~/trangnen.master" %>
                ...
                <div class="b_left col_50 inner" id="UPa_tk">
                    <div class="b_left form-group iterm_form">
                        ...
                        <div class="input-group">
                            <Cthuvien:DR_list ID="list_nnn" kieu="U" DataTextField="ten" DataValueField="ma" runat="server" CssClass="form-control css_list"/>
                        </div>
                    </div>
                    <div class="b_left form-group iterm_form">
                        <span class="standard_label b_left col_20">Mã chức danh</span>
                        <div class="input-group">
                            <Cthuvien:ma ID="macd" ten="mã chức danh" runat="server" CssClass="form-control css_ma" kieu_unicode="True" kt_xoa="X" />
                        </div>
                    </div>
                    <div class="b_left form-group iterm_form">
                        <span class="standard_label b_left col_20">Tên chức danh</span>
                        <div class="input-group">
                            <Cthuvien:ma ID="tencd" ten="tên chức danh" runat="server" CssClass="form-control css_ma" kieu_unicode="True" kt_xoa="X"
                                MaxLength="255" />
                        </div>
                    </div>

                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="Nhap1" runat="server" Text="Tìm kiếm" class="bt_action" anh="K" OnClick="ns_hdns_ma_bt2_quang_P_LKE('');form_P_LOI('');"/>
                    </div>
                    <br />

                    <div class="grid_table width_common">
                        <div>
                            <Cthuvien:GridX ID="GR_lke" Width="100%" runat="server" AutoGenerateColumns="false" PageSize="1" CssClass="table gridX" hangKt="15" hamRow="ns_hdns_ma_bt2_quang_GR_lke_RowChange()"
                                cotAn="ma_nnn,tt,ghichu,nsd" loai="X" >
                                <Columns>
                                    <asp:BoundField DataField="leGrid" HeaderStyle-Width="10px" />
                                    <asp:BoundField DataField="ten_ncd" HeaderText="Nhóm chức danh" HeaderStyle-Width="160px" ItemStyle-CssClass="css_Gma" />
                                    <asp:boundfield datafield="ma" headertext="mã chức danh" itemstyle-cssclass="css_Gma" HeaderStyle-Width="160px"/>
                        ...
                        <ctr_khud_divL:ctr_khud_divL ID="Ctr_khud_divL1" runat="server" loai="X" gridId="GR_lke"
                            ham="ns_hdns_ma_bt2_quang_P_LKE()" />
                    </div>
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="xuatExel" runat="server" Text="Xuất Excel" class="bt_action" anh="K" OnClick="ns_hdns_ma_bt2_quang_P_IN();form_P_LOI('');" Title="Ấn nút để xuất thông tin ra Excel" />
                    </div>
                </div>
                <div class="b_right col_50 inner" id="UPa_ct">
                    <div style="display: none">
                        <Cthuvien:gchu ID="nsd" runat="server" CssClass="css_gchu2" kt_xoa="X" Font-Bold="true" />
                        <Cthuvien:DR_lke ID="ma_cm" runat="server" ktra="DT_CM" kieu_chu="True" ten="Tên chuyên môn" onchange="ns_hdns_ma_bt2_quang_P_KTRA('MA_CM')" Width="270px" kt_xoa="G" />
                        <Cthuvien:DR_lke ID="ma_nn" runat="server" kieu_chu="True" ten="Nhóm chức danh lỗi"
                            MaxLength="30" kt_xoa="K" ktra="DT_NN" Width="270px" onchange="ns_hdns_ma_bt2_quang_P_KTRA('MA_CB')" />
                        <Cthuvien:DR_lke ID="cbnn" runat="server" ktra="DT_CB" kieu_chu="True" ten="Tên cấp bậc nghề nghiệp"
                            onchange="ns_hdns_ma_bt2_quang_P_KTRA('MA_CB')" Width="270px" kt_xoa="M" />
                    ...
                    <div class="b_left form-group iterm_form">
                        ...
                        <div class="input-group">
                            <Cthuvien:DR_list ID="ma_nnn" kieu="U" DataTextField="ten" DataValueField="ma" runat="server" CssClass="form-control css_list"/>
                        </div>
                    </div>
                    <div class="b_left form-group iterm_form">
                        ...
                        <div class="input-group">
                            <Cthuvien:ma ID="MA" ten="mã chức danh" runat="server" CssClass="form-control css_ma" kieu_chu="True" Enabled="false"
                                kt_xoa="G" onchange="ns_hdns_ma_bt2_quang_P_KTRA('MA')" BackColor="#f6f7f7" />
                        </div>
                    </div>
                    <div class="b_left form-group iterm_form">
                    ...
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="moi" runat="server" Text="Làm mới" class="bt_action" anh="K" OnClick="ns_hdns_ma_bt2_quang_P_MOI();form_P_LOI('');" Title="Ấn nút để làm mới" />
                        <Cthuvien:nhap ID="nhap" runat="server" Text="Ghi" class="bt_action" anh="K" OnClick="ns_hdns_ma_bt2_quang_P_NH();form_P_LOI('');" Title="Ấn nút nhập để nhập mới" />
                        ...
                        <Cthuvien:nhap ID="xoa" runat="server" Text="Xóa" class="bt_action" anh="K" OnClick="return ns_hdns_ma_bt2_quang_P_XOA();form_P_LOI();" Title="Xóa dòng thông tin đang chọn" />
                    </div>
                    <div style="display: none;">
