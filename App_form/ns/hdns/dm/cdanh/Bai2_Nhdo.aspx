<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bai2_Nhdo.aspx.cs" Inherits="App_form_ns_hdns_dm_cdanh_Bai2_Nhdo" MasterPageFile="~/trangnen.master" %>
            ...
            <div class="width_common auto_sc line_55">
                <div class="b_left col_50 inner" id="UPa_tk">
                    ...
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="Nhap1" runat="server" Text="Tìm kiếm" class="bt_action" anh="K" OnClick="ns_hdns_ma_bt2_nhdo_P_LKE('');form_P_LOI('');"/>
                    </div>
                    <br />
                    <div class="grid_table width_common">
                        <div>
                            <Cthuvien:GridX ID="GR_lke" Width="100%" runat="server" AutoGenerateColumns="false" PageSize="1" CssClass="table gridX" hangKt="15" hamRow="ns_hdns_ma_bt2_nhdo_GR_lke_RowChange()"
                                 cotAn="tt,ghichu,nsd" loai="X" cthich="chon:Đánh dấu chọn ký">
                                <Columns>
                        ...
                        <ctr_khud_divL:ctr_khud_divL ID="Ctr_khud_divL1" runat="server" loai="X" gridId="GR_lke"
                            ham="ns_hdns_ma_bt2_nhdo_P_LKE()" />
                    </div>
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="xuatExel" runat="server" Text="Xuất Excel" class="bt_action" anh="K" OnClick="ns_hdns_ma_bt2_nhdo_P_IN();form_P_LOI('');" Title="Ấn nút để xuất thông tin ra Excel" />
                    </div>
                </div>
                <div class="b_right col_50 inner" id="UPa_ct">
                    ...
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="moi" runat="server" Text="Làm mới" class="bt_action" anh="K" OnClick="ns_hdns_ma_bt2_nhdo_P_MOI();form_P_LOI('');" Title="Ấn nút để làm mới" />
                        <Cthuvien:nhap ID="nhap" runat="server" Text="Ghi" class="bt_action" anh="K" OnClick="ns_hdns_ma_bt2_nhdo_P_NH();form_P_LOI('');" Title="Ấn nút nhập để nhập mới" />                     
                        <Cthuvien:nhap ID="xoa" runat="server" Text="Xóa" class="bt_action" anh="K" OnClick="return ns_hdns_ma_bt2_nhdo_P_XOA();form_P_LOI();" Title="Xóa dòng thông tin đang chọn" />
                    </div>
                    <div style="display: none;">
