<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_hdns_bai3_nhdo.aspx.cs" Inherits="App_form_ns_hdns_dm_cdanh_ns_hdns_bai3_nhdo" MasterPageFile="~/trangnen.master"  EnableEventValidation="false" %>
            ...
            <div class="width_common auto_sc line_55">
                <div class="b_left col_50 inner" id="UPa_tk">
                    ...
                    <div class="b_left form-group iterm_form">
                        <div class="list_bt_action">
                            <Cthuvien:nhap ID="tim" runat="server" Text="Tìm kiếm" Width="100px" class="bt_action" anh="K" OnClick="return ns_hdns_ma_bt3_nhdo_P_LKE();form_P_LOI();" />
                        </div>
                    </div>
                    <div class="grid_table width_common">
                        <div style="overflow-x: scroll">
                            <Cthuvien:GridX ID="GR_lke" Width="100%" runat="server" AutoGenerateColumns="false" PageSize="1" CssClass="table gridX" hangKt="15" hamRow="ns_hdns_ma_bt3_nhdo_GR_lke_RowChange()"
                                cot="ma,ten,ng_qly,ngay_tl,ngay_gt,ma_tt" cotAn="ten_ta,ten_vt,ghichu,nsd" loai="X" >
                                <Columns>
                                    <asp:BoundField DataField="leGrid" HeaderStyle-Width="10px" />
                                    <asp:BoundField DataField="ma" HeaderText="Mã phòng ban" HeaderStyle-Width="100px" ItemStyle-CssClass="css_Gnd" />
                                    <asp:BoundField DataField="ten" HeaderText="Tên phòng ban" HeaderStyle-Width="140px" ItemStyle-CssClass="css_Gma" />
                                    <asp:BoundField DataField="ng_qly" HeaderText="Người quản lý" HeaderStyle-Width="140px" ItemStyle-CssClass="css_Gma" />                                    
                                    <asp:BoundField DataField="ngay_tl" HeaderText="Ngày thành lập" HeaderStyle-Width="100px" ItemStyle-CssClass="css_Gma" />
                                    <asp:BoundField DataField="ngay_gt" HeaderText="Ngày giải thể" HeaderStyle-Width="100px" ItemStyle-CssClass="css_Gma" />                                    
                                    <asp:BoundField DataField="ma_tt" HeaderText="Tỉnh thành" HeaderStyle-Width="100px" ItemStyle-CssClass="css_Gma" />
                                </Columns>
                            </Cthuvien:GridX>
                        </div>
                        <ctr_khud_divL:ctr_khud_divL ID="Ctr_khud_divL1" runat="server" loai="X" gridId="GR_lke"
                            ham="ns_hdns_ma_bt3_nhdo_P_LKE()" />
                    </div>
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="xuatExel" runat="server" Text="Xuất Excel" class="bt_action" anh="K" OnClick="ns_hdns_ma_bt3_nhdo_P_IN();form_P_LOI('');" Title="Ấn nút để xuất thông tin ra Excel" />
                    </div>
                </div>
                <div class="b_right col_50 inner" id="UPa_ct">      
                    ...
                    <div class="b_right form-group iterm_form">
                        <span class="standard_label b_left col_20">Ngày thành lập<span class="require">*</span></span>
                        <div class="input-group">
                    ...
                    <div class="b_right form-group iterm_form">
                        <span class="standard_label b_left col_20">Ngày giải thể</span>
                        <div class="input-group">
                    ...
                    <div class="b_left form-group iterm_form">
                        ...
                        <div class="input-group">
                            <Cthuvien:ma ID="dia_chi"  runat="server" CssClass="form-control css_ma" kieu_unicode="True" kt_xoa="X" MaxLength="255" />
                        </div>
                    </div>
                    <div class="b_left form-group iterm_form">
                    ...
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="moi" runat="server" Text="Làm mới" class="bt_action" anh="K" OnClick="ns_hdns_ma_bt3_nhdo_P_MOI();form_P_LOI('');" Title="Ấn nút để làm mới" />
                        <Cthuvien:nhap ID="nhap" runat="server" Text="Ghi" class="bt_action" anh="K" OnClick="ns_hdns_ma_bt3_nhdo_P_NH();form_P_LOI('');" Title="Ấn nút nhập để nhập mới" />
                        <Cthuvien:nhap ID="xoa" runat="server" Text="Xóa" class="bt_action" anh="K" OnClick="return ns_hdns_ma_bt3_nhdo_P_XOA();form_P_LOI();" Title="Xóa dòng thông tin đang chọn" />
