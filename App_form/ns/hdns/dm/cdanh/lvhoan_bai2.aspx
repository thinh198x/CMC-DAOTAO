<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/trangnen.master" CodeFile="Lvhoan_bai2.aspx.cs" Inherits="App_form_ns_ma_Lvhoan_bai2" %>
        ...
        <div class="r_c_content b_right">
            ...
            <div class="width_common auto_sc line_55">
                <div class="b_left col_50 inner" id="UPa_tk">
                    <div class="b_left form-group iterm_form">
                        ...
                        <div class="input-group">
                            <Cthuvien:ma ID="macd" ten="Mã chức danh" runat="server" CssClass="form-control css_ma" kt_xoa="K" kieu_chu="true" />
                        </div>
                    </div>
                    <div class="b_left form-group iterm_form">
                        <span class="standard_label b_left col_30">Tên chức danh</span>
                        <div class="input-group">
                            <Cthuvien:ma ID="tencd" ten="Tên chức danh" runat="server" kt_xoa="X" CssClass="form-control css_ma" kieu_unicode="true" />
                        </div>
                    </div>
                    <div class="b_left form-group iterm_form">
                        <div class="list_bt_action">
                            <Cthuvien:nhap ID="tim" runat="server" Text="Tìm kiếm" Width="100px" class="bt_action" anh="K" OnClick="return lvhoan_bai2_P_LKE();form_P_LOI();" />
                        </div>
                    </div>
                    <div class="grid_table width_common">
                        <div>
                            <Cthuvien:GridX ID="GR_lke" Width="100%" runat="server" AutoGenerateColumns="false" PageSize="1" CssClass="table gridX" hangKt="15" hamRow="lvhoan_bai2_GR_lke_RowChange()"
                                cot="ma_nnn,ma,ten,ten_tt,tt,ghichu,nsd" cotAn="tt,ghichu,nsd" loai="X" cthich="chon:Đánh dấu chọn ký">
                                <Columns>
                    ...
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="xuatExel" runat="server" Text="Xuất Excel" class="bt_action" anh="K" OnClick="lvhoan_bai2_P_IN();form_P_LOI('');" Title="Ấn nút để xuất thông tin ra Excel" />
                    </div>
                </div>
                <div class="b_right col_50 inner" id="UPa_ct">
                    ...
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="moi" runat="server" Text="Làm mới" class="bt_action" anh="K" OnClick="lvhoan_bai2_P_MOI();form_P_LOI('');" Title="Ấn nút để làm mới" />
                        <Cthuvien:nhap ID="nhap" runat="server" Text="Ghi" class="bt_action" anh="K" OnClick="lvhoan_bai2_P_NH();form_P_LOI('');" Title="Ấn nút nhập để nhập mới" />
                        <Cthuvien:nhap ID="xoa" runat="server" Text="Xóa" class="bt_action" anh="K" OnClick="return lvhoan_bai2_P_XOA();form_P_LOI();" Title="Xóa dòng thông tin đang chọn" />
                    </div>
                    <div style="display: none;">
