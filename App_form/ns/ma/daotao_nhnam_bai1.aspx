<%@ Page Language="C#" AutoEventWireup="true" CodeFile="daotao_nhnam_bai1.aspx.cs" Inherits="f_daotao_nhnam_bai1" MasterPageFile="~/trangnen.master" %>
        ...
        <div class="r_c_content b_right">
            ...
            <div class="width_common auto_sc line_55">
                    ...
                    <div class="grid_table width_common">
                        <div>
                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                CssClass="table gridX" loai="X" hangKt="15" cotAn="nsd,ghichu,tt" hamRow="ns_nhnam_bai1_GR_lke_RowChange()">
                                <Columns>
                        ...
                        <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" gridId="GR_lke" ham="ns_nhnam_bai1_P_LKE()" /> <%--phân trang--%>
                    </div>
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="excel" runat="server" Text="Xuất excel" class="bt_action" anh="K" OnClick="return ns_nhnam_bai1_P_IN();form_P_LOI();" Width="100px" /> <%--Xuât exel--%>
                    </div>
                </div>
                <div class="b_right col_50 inner" id="UPa_ct">
                    <div class="b_left form-group iterm_form">
                        ...
                        <div class="input-group">
                            <Cthuvien:ma ID="ma" runat="server" CssClass="form-control css_ma"
                                kt_xoa="G" onfocusout="ns_nhnam_bai1_P_KTRA('MA')" MaxLength="20" Enabled="false"></Cthuvien:ma>
                        </div>
                    </div>
                    <div class="b_left form-group iterm_form">
                    ...
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="moi" runat="server" Text="Làm mới" class="bt_action" anh="K" OnClick="return ns_nhnam_bai1_P_MOI();form_P_LOI();" />
                        <Cthuvien:nhap ID="nhap" runat="server" class="bt_action" anh="K" Text="Ghi" OnClick="return ns_nhnam_bai1_P_NH();form_P_LOI();" />
                        ...
                        <Cthuvien:nhap ID="xoa" runat="server" Text="Xóa" class="bt_action" anh="K" OnClick="return ns_nhnam_bai1_P_XOA();form_P_LOI('');" Width="70px" />
                    </div>
