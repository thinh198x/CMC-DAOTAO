<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_ma_xloai.aspx.cs" Inherits="f_ns_ma_xloai"
    Title="ns_ma_xloai" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
      ...
      <tr class="css_tieudeN">
            <td colspan="2">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="left">
                            <Cthuvien:luu ID="Luu1" runat="server" CssClass="css_tieudeM" Text="Xếp loại" />
                        </td>
                        <td align="right">
                                            ...
                                            <tr>
                                                <td>
                                                    <Cthuvien:ma ID="MA" ten="Mã" runat="server" CssClass="css_ma" kieu_chu="True"
                                                        kt_xoa="G" onchange = "ns_ma_xloai_P_KTRA('MA')" Width="120px" />
                                                </td>
                    ...
                    <tr>
                        <td align="left" style="padding-left:39px">
                            <table id = "UPa_nhap" runat ="server" cellpadding="1" cellspacing="1">
                                <tr>
                                    <td align="center">
                                        <Cthuvien:nhap ID="nhap" runat="server" CssClass="css_button" Font-Bold="True" OnClick="return ns_ma_xloai_P_NH();"
                                            Text="Nhập" Width="70px" />
                                    </td>
                                    <td align="center">
                                        <Cthuvien:nhap ID="xoa" runat="server" CssClass="css_button" Font-Bold="True" OnClick="return ns_ma_xloai_P_XOA();"
                                            Text="Xóa" Width="70px" />
                                    </td>
                                     <td align="center">
                                        <Cthuvien:nhap ID="chon" runat="server" CssClass="css_button" Font-Bold="True" OnClick="return form_P_TRA_CHON('MA,TEN');"
                    ...
                    <tr>
                        <td>
                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                CssClass="table gridX" loai="X" hangKt="15" cotAn="nsd" hamRow="ns_ma_xloai_GR_lke_RowChange()">
                                <Columns>
