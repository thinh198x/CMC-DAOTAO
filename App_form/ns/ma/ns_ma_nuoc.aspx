<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_ma_nuoc.aspx.cs" Inherits="f_ns_ma_nuoc"
    Title="ns_ma_nuoc" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
            ...
            <div class="width_common auto_sc line_55">
                <div class="b_left col_50 inner" id="UPa_tk">
                    <div class="grid_table width_common">
                        ...
                        <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" gridId="GR_lke" ham="ns_ma_nuoc_P_LKE()" /> <%--phân trang--%>
                    </div>
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="excel" runat="server" Text="Xuất excel" class="bt_action" anh="K" OnClick="return ns_ma_nuoc_P_IN();form_P_LOI();" Width="100px" /> <%--Xuât exel--%>
                    </div>
                </div>
