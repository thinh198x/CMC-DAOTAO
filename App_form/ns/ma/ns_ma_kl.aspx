<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_ma_kl.aspx.cs" Inherits="f_ns_ma_kl"
    Title="ns_ma_kl" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <Cthuvien:ma ID="MA" runat="server" CssClass="css_ma" kieu_chu="True"
                                                        kt_xoa="G" onchange = "ns_ma_kl_P_KTRA('MA')" Width="120px" />
                                                </td>
                    ...
                    <tr>
                        <td align="center">
                            <table id = "UPa_nhap" runat ="server" cellpadding="1" cellspacing="1">
                                <tr>
                                    <td align="center">
                                        <cthuvien:nhap ID="nhap" runat="server" CssClass="css_button" Font-Bold="True" OnClick="return ns_ma_kl_P_NH();form_P_LOI();"
                                            Text="Nhập" Width="70px" />
                                    </td>
                                    <td align="center">
                                        <cthuvien:nhap ID="xoa" runat="server" CssClass="css_button" Font-Bold="True" OnClick="return ns_ma_kl_P_XOA();form_P_LOI();"
                                            Text="Xóa" Width="70px" />
                                    </td>
                                </tr>
                            </table>
            ...
            <td style="border-right: gray 1px solid; border-top: gray 1px solid; vertical-align: top;
               ...
               <Cthuvien:GridX ID="GR_lke" runat="server" ctr_sott="sott"
                        DisplayLayout-ClientSideEvents-AfterRowActivateHandler="ns_ma_kl_GR_lke_ActiveRowChange">
                  <%--  <Bands>
    ...
    <div id = "UPa_hidden">
    <cthuvien:an ID="kthuoc" runat="server" Value="750,440" />
    </div>
</asp:Content>
