<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_ma_hhdang.aspx.cs" Inherits="f_ns_ma_hhdang"
    Title="ns_ma_hhdang" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
                                ...
                                <tr>
                                    <td>
                                        <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                            CssClass="table gridX" loai="X" hangKt="10" cotAn="nsd" hamRow="ns_ma_hhdang_GR_lke_RowChange()">
                                            <Columns>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Cthuvien:ma ID="MA" ten="Mã" runat="server" CssClass="css_form" kieu_chu="True" kt_xoa="G"
                                                                    onfocusout="ns_ma_hhdang_P_KTRA('MA')" Width="120px" />
                                                            </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <Cthuvien:ma ID="TEN" ten="Tên" runat="server" CssClass="css_form" kieu_unicode="True"
                                                        kt_xoa="X" Width="240px"></Cthuvien:ma>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <div class="box3 txRight">
                                                        <a href="#" onclick="return ns_ma_hhdang_P_NH();form_P_LOI();" class="bt bt-grey"><i class="fa fa-save"></i><span class="txUnderline">N</span>hập</a>
                                                        <a href="#" class="bt bt-grey" onclick="return ns_ma_hhdang_P_XOA();form_P_LOI();"><i class="fa fa-trash-o"></i><span class="txUnderline">X</span>óa</a>
