...
public partial class f_ns_ctt_dxxn_ct : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                string b_s = this.ResolveUrl("~/App_form/ns/ctt/ngv/ns_ctt_dxxn_ct" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ns_ctt_dxxn_ct_P_KD('" + b_so_the + "');", true);
