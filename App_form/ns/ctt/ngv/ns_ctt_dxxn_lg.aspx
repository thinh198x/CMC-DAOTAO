<%@ Page Title="ns_ctt_dxxn_lg" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_ctt_dxxn_lg.aspx.cs" Inherits="f_ns_ctt_dxxn_lg" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <tr>
                        ...
                        <td align="center" colspan="2">
                            <table cellpadding="1" width="100%" cellspacing="1">
                                <tr>
                                    <td align="left">
                                        <Cthuvien:luu ID="Luu5" runat="server" CssClass="css_tieudeM" Text="Đề xuất xác nhận mức lương" />
                                    </td>
                                    <td align="right">
                                        <div class="acc">
                                            <ul>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                    ...
                                    <td align="left" id="Upa_tk" runat="server">
                                        <table cellpadding="1" cellspacing="1" id="UPa_tk" >
                                            <tr>
                                                ...
                                                <td>
                                                    <Cthuvien:nhap ID="tim" runat="server" Width="80px" Text="Tìm" OnClick="return ns_ctt_dxxn_lg_P_LKE();" />                                                    
                                                </td>
                                            </tr>                                            
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td style="padding-top: 15px" align="center">                                        
                                        <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                            CssClass="table gridX" hangKt="15" cot="SO_ID,ngaynh,ngaygui_xn,tt_xn" cotAn="SO_ID" hamRow="ns_ctt_dxxn_lg_GR_lke_RowChange()">
                                            <Columns>
                                ...
                                <tr>
                                    <td id="GR_lke_td" runat="server" align="center">
                                        <khud_slide:khud_slide ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="return ns_ctt_dxxn_lg_P_LKE();" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                                        ...
                                        <table id="UPa_ct" runat="Server" cellpadding="1" cellspacing="1">
                                            ...
                                            <tr>                                                
                                                ...
                                                <td align="left" colspan="3">
                                                    <Cthuvien:ma ID="HKHAU" ten="Địa chỉ" runat="server" CssClass="css_form" kt_xoa="X" Width="100%" MaxLength="256"/>
                                                </td>   
                                            </tr>                                            
                                            <tr>                                                
                                                <td align="left">
                                            ...
                                            <tr>                                                
                                                ...
                                                <td align="left" colspan="3">
                                                    <Cthuvien:ma ID="DCHI_CQ" ten="Địa chỉ công ty" runat="server" CssClass="css_form" kt_xoa="X" Width="100%" MaxLength="200" />
                                                </td>                                                        
                                            </tr>
                                             <tr>                                                
                                                <td align="left">
                                           ...
                                           <tr>     
                                               <td align="left">
                                                ...
                                                <td align="left">
                                                    <Cthuvien:ma ID="PHONG" ten="Bộ phận" runat="server" CssClass="css_form" kt_xoa="X" Width="160px" MaxLength="20" />
                                                </td>   
                                                ...
                                                <td  align="left">
                                                    <Cthuvien:ma ID="CDANH" ten="Chức vụ" runat="server" CssClass="css_form" kt_xoa="X" Width="160px" />
                                                </td>                                                 
                                            </tr>                                            
                                           <tr>
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <Cthuvien:DR_lke ID="lhd" ktra="DT_LOAI_HD" runat="server" Width="155px"></Cthuvien:DR_lke>
                                                </td>
                                                <td align="left">
                                                    <asp:Label ID="Label10" runat="server" Text="Loại HĐ khác" CssClass="css_gchu" />                                                  
                                                </td>
                                               <td align="left">
                                                    <Cthuvien:ma ID="loai_hd" ten="Loại HĐ khác" runat="server" CssClass="css_form" kt_xoa="X" Width="160px" />
                                                </td>
                                            </tr>          
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <div class="ip-group date">
                                                        <span class="ip-group-addon"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                                        <Cthuvien:ngay  placeholder='dd/MM/yyyy' ID="NGAYD_HD" runat="server" Width="132px" CssClass="css_form_c" kt_xoa="X" ten="Hợp đồng hiệu lực từ" />
                                                    </div>
                                                </td>
                                                <td align="left">
                                               ...
                                               <td align="left">
                                                    <div class="ip-group date">
                                                        <span class="ip-group-addon"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                                        <Cthuvien:ngay  placeholder='dd/MM/yyyy' ID="NGAYC_HD" runat="server" Width="132px" CssClass="css_form_c" kt_xoa="X" ten="Hợp đồng hiệu lực đến" />
                                                    </div>
                                                </td>
                                            </tr>     
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td  align="left">
                                                    <Cthuvien:so ID="LUONG_CHINH" ten="Mức lương chính" runat="server" Width="160px" CssClass="css_form_c" kt_xoa="X" co_dau="K"/>
                                                </td>  
                                                <td align="left">
                                                    <Cthuvien:bbuoc ID="Bbuoc13" runat="server" Text="Trước/sau thuế" CssClass="css_gchu"></Cthuvien:bbuoc>
                                                </td>
                                                <td align="left">
                                                    <Cthuvien:kieu ID="THUE" runat="server" CssClass="css_ma_c" Width="80px" lke="TRUOC,SAU" Text="TRUOC" ToolTip="Loại lương: TRUOC-Trước thuế, SAU-Sau thuế"/>
                                                </td>
                                            </tr>
                                             <tr>
                                                <td align="left">
                                                ...
                                                <td  align="left">
                                                    <Cthuvien:so ID="tn_khac" ten="Thu nhập khác" runat="server" Width="160px" CssClass="css_form_c" kt_xoa="X" co_dau="K"/>
                                                </td>  
                                                <td></td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="3" align="left">
                                                    <Cthuvien:nd ID="dgiai_tnk" ten="Diễn giải nguồn thu nhập khác" runat="server" kt_xoa="X" CssClass="css_form" Height="50px"
                                                        Width="100%" TextMode="MultiLine" MaxLength="200" ToolTip="Diễn giải nguồn thu nhập khác" />   
                                                </td>                                                        
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="padding-top: 20px">
                                                    <div class="box3 txCenter" style="width: 100%;">
                                                        <Cthuvien:nhap ID="moi" runat="server" Text="Làm mới" OnClick="return ns_ctt_dxxn_lg_P_MOI();" /> 
                                                        <Cthuvien:nhap ID="nhap" runat="server" Width="80px" Text="Ghi" OnClick="return ns_ctt_dxxn_lg_P_NH();" />
                                                        <Cthuvien:nhap ID="xoa" runat="server" Width="80px" Text="Xóa" OnClick="return ns_ctt_dxxn_lg_P_XOA();" />
                                                        <Cthuvien:nhap ID="guixn" runat="server" Width="100px" Text="Gửi xác nhận" OnClick="return ns_ctt_dxxn_lg_P_PD();" />                                             
                                                    </div>
                                                </td>                                                
                                            </tr>
                                        </table>
    ...
    <div id="UPa_hi">
        <Cthuvien:an ID="kthuoc" runat="server" Value="1090,770" />
