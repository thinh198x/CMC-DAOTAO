<%@ Page Title="ns_ls_dg" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_ls_dg.aspx.cs" Inherits="f_ns_ls_dg" %>
        ...
        <div class="width_common auto_sc">
            <div class="b_left col_100 inner" id="UPa_tk">
                    ...
                    <div class="b_left form-group iterm_form">
                        ...
                        <div class="input-group">
                            <Cthuvien:ma ID="SO_THE" ten="Mã cán bộ" runat="server" CssClass="form-control css_ma" BackColor="#f6f7f7" ktra="ns_cb,so_the,ten" placeholder="Nhấn (F1)"
                                ToolTip="Mã số cán bộ" kieu_chu="true" f_tkhao="~/App_form/ns/tt/ns_cb_chon.aspx" onchange="ns_ls_dg_P_KTRA('SO_THE')" gchu="gchu" kt_xoa="K" />
                        </div>
                    </div>
                    <div class="b_left form-group iterm_form">
                ...
                <div class="grid_table width_common">
                    <div>
                        <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Kỳ đánh giá" DataField="ky_dg" HeaderStyle-Width="200px" ItemStyle-CssClass="css_Gma" />
                    ...
                    <div>
                        <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_ls_dg_P_LKE()" />
                    </div>
                </div>
                <div class="list_bt_action">
                    <Cthuvien:nhap ID="XuatExcel" class="bt_action" anh="K" runat="server" Text="Xuất excel" Width="90px" OnClick="return ns_ls_dg_P_IN();form_P_LOI();" />
