...
public partial class f_ns_ls_tt_qt_dt : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                string b_s = this.ResolveUrl("~/App_form/ns/ls/ns_ls_tt_qt_dt" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
                ScriptManager.RegisterClientScriptInclude(this.Page, this.GetType(), Guid.NewGuid().ToString(), b_s);
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ns_ls_tt_qt_dt_P_KD();", true);
    ...
    protected void excel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Excel_dungchung.ExportTemplate("Templates/ExportMau/ns_ls_tt_qt_dt.xlsx", b_dt, null, "QuaTrinhDaoTao");
        }
        catch (Exception ex) { form.P_LOI(this, "loi:File export không tồn tại:loi"); }
    }
    protected void excel_mau_Click(object sender, EventArgs e)
    {        
        Excel_dungchung.ExportTemplate("Templates/importhsns/ns_ls_tt_qt_dt.xls", "ns_ls_tt_qt_dt");
    }
