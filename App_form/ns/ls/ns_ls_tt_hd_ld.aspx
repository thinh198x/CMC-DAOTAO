<%@ Page Title="ns_ls_tt_hd_ld" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_ls_tt_hd_ld.aspx.cs" Inherits="f_ns_ls_tt_hd_ld" %>
                    ...
                    <div class="grid_table width_common">
                        <div>
                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1" Width="100%"
                                CssClass="table gridX" loai="X" hangKt="12" cotAn="lhd,ma_nguoiky,cdanh_nguoiky">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Loại hợp đồng" DataField="ten_lhd"  ItemStyle-CssClass="css_Gma" />
                                    <asp:BoundField HeaderText="Nội dung phụ lục" DataField="ten_hd_pl"  ItemStyle-CssClass="css_Gma" />
                        ...
                        <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_ls_tt_hd_ld_P_LKE('K')" />

                    </div>
                    <div class="list_bt_action">
                        <button onclick="return ns_ls_tt_hd_ld_P_IN();form_P_LOI();" class="bt_action"><span class="txUnderline">X</span>uất excel</button>
