<%@ Page Title="ns_xn_ct" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_xn_ct.aspx.cs" Inherits="f_ns_xn_ct" %>
                    ...
                    <tr>
                        ...
                        <td align="center" colspan="2">
                            <table cellpadding="1" width="100%" cellspacing="1">
                                <tr>
                                    <td align="left">
                                        <Cthuvien:luu ID="Luu5" runat="server" CssClass="css_tieudeM" Text="Xác nhận công tác" />
                                    </td>
                                    <td align="right">
                                        <div class="acc">
                                            <ul>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                    ...
                                    <td align="left" id="Upa_tk" runat="server">
                                        <table cellpadding="1" cellspacing="1" id="UPa_tk" >
                                            <tr>
                                                ...
                                                <td>
                                                    <Cthuvien:nhap ID="tim" runat="server" Width="80px" Text="Tìm" OnClick="return ns_xn_ct_P_LKE();" />                                                    
                                                </td>
                                            </tr>                                            
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td style="padding-top: 15px" align="center">                                        
                                        <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                            CssClass="table gridX" hangKt="15" cot="SO_ID,so_the,ten,ngaygui_xn,tt_xn" cotAn="SO_ID" hamRow="ns_xn_ct_GR_lke_RowChange()">
                                            <Columns>
                                ...
                                <tr>
                                    <td id="GR_lke_td" runat="server" align="center">
                                        <khud_slide:khud_slide ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="return ns_xn_ct_P_LKE();" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                                        ...
                                        <table id="UPa_ct" runat="Server" cellpadding="1" cellspacing="1">
                                            ...
                                            <tr>                                                
                                                ...
                                                <td align="left" colspan="3">
                                                    <Cthuvien:ma ID="HKHAU" ten="Địa chỉ thường trú" runat="server" CssClass="css_form" kt_xoa="X" Width="100%" MaxLength="256" BackColor="#f6f7f7" Font-Bold="true" disabled ReadOnly="true"/>
                                                </td>   
                                            </tr>
                                            <tr>
                                                 <td align="left">
                                                ...
                                                <td align="left" colspan="3">
                                                    <Cthuvien:ma ID="DCHI" ten="Địa chỉ tạm trú" runat="server" CssClass="css_form" kt_xoa="X" Width="100%" MaxLength="256" BackColor="#f6f7f7" Font-Bold="true" disabled ReadOnly="true"/>
                                                </td>  
                                            </tr>
                                            <tr>                                                
                                                <td align="left">
                                                ...
                                                <td>
                                                    <Cthuvien:ma ID="SOCMT" ten="Số CMND" runat="server" CssClass="css_form" kt_xoa="X" Width="160px" MaxLength="50" BackColor="#f6f7f7" Font-Bold="true" disabled ReadOnly="true"/>
                                                </td>    
                                                ...
                                                <td align="left">                                                    
                                                    <div class="ip-group date">
                                                        ...
                                                        <Cthuvien:ngay  placeholder='dd/MM/yyyy' ID="NGAY_CMT" runat="server" Width="132px" CssClass="css_form_c" kt_xoa="X" ten="Ngày cấp CMND"  BackColor="#f6f7f7" Font-Bold="true" disabled ReadOnly="true"/>
                                                    </div>
                                                </td>                                                                                             
                                            </tr>                                            
                                            <tr>
                                                ...
                                                <td align="left" colspan="3">
                                                      <Cthuvien:ma ID="NC_CMT" ten="Nơi cấp CMND" runat="server" CssClass="css_form" kt_xoa="X" Width="100%" MaxLength="100" BackColor="#f6f7f7" Font-Bold="true" disabled ReadOnly="true"/>
                                                </td> 
                                            </tr>                                            
                                            <tr>                                               
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <Cthuvien:ma ID="DTNR" ten="Số điện thoại nhà" runat="server" CssClass="css_form" kt_xoa="X" Width="160px" MaxLength="50" BackColor="#f6f7f7" Font-Bold="true" disabled ReadOnly="true"/> 
                                                </td>  
                                                <td align="left">
                                                    <asp:Label ID="Bbuoc3" runat="server" Text="Số ĐTDĐ" CssClass="css_gchu"></asp:Label>
                                                </td>
                                                <td align="left">
                                                    <Cthuvien:ma ID="DTDD" ten="Số ĐTDĐ" runat="server" CssClass="css_form" Width="160px" kt_xoa="X" MaxLength="50"  BackColor="#f6f7f7" Font-Bold="true" disabled ReadOnly="true"/>
                                                </td>
                                            </tr>
                                            <tr>                                                
                                                <td align="left">
                                                ...
                                                <td align="left" colspan="3">
                                                    <Cthuvien:ma ID="CQUAN" ten="Hiện đang làm việc tại" runat="server" CssClass="css_form" kt_xoa="X" Width="100%"  BackColor="#f6f7f7" Font-Bold="true" disabled ReadOnly="true"/>
                                                </td>                                                        
                                            </tr>
                                           <tr>                                               
                                                <td align="left">
                                                ...
                                                <td  align="left">
                                                    <Cthuvien:ma ID="CDANH" ten="Chức danh/chức vụ" runat="server" CssClass="css_form" kt_xoa="X" Width="160px"  BackColor="#f6f7f7" Font-Bold="true" disabled ReadOnly="true"/>
                                                </td>                              
                                                <td align="left">
                                                ...
                                                <td  align="left">
                                                    <div class="ip-group date">
                                                        <span class="ip-group-addon"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                                        <Cthuvien:ngay  placeholder='dd/MM/yyyy' ID="NGAY_VAO" runat="server" Width="132px" CssClass="css_form_c" kt_xoa="X" ten="Ngày vào làm việc"  BackColor="#f6f7f7" Font-Bold="true" disabled ReadOnly="true"/>
                                                    </div>
                                                </td>                                                        
                                            </tr>
                                            <tr>                                                
                                                ...
                                                <td align="left" colspan="3">
                                                    <Cthuvien:ma ID="DCHI_CQ" ten="Địa chỉ cơ quan" runat="server" CssClass="css_form" kt_xoa="X" Width="100%" MaxLength="200"  BackColor="#f6f7f7" Font-Bold="true" disabled ReadOnly="true"/>
                                                </td>                                                        
                                            </tr>
                                            <tr>                                                
                                                <td align="left">
                                                ...
                                                <td align="left">
                                                    <Cthuvien:ma ID="DTCQ" ten="Điện thoại liên lạc" runat="server" CssClass="css_form" kt_xoa="X" Width="160px" MaxLength="20"  BackColor="#f6f7f7" Font-Bold="true" disabled ReadOnly="true"/>
                                                </td>      
                                                <td></td><td></td>                                                  
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <Cthuvien:nd ID="LYDO_XN" ten="Lý do xác nhận công tác" runat="server" kt_xoa="X" CssClass="css_form" Height="50px"
                                                        Width="100%" TextMode="MultiLine" MaxLength="200"  BackColor="#f6f7f7" Font-Bold="true" disabled ReadOnly="true"/>   
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">  
                                                     <div class="ip-group date">
                                                        <span class="ip-group-addon"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                                                        <Cthuvien:ngay  placeholder='dd/MM/yyyy' ID="ngay_tra_kq" runat="server" Width="133px" CssClass="css_form_c" kt_xoa="X" ten="Ngày trả kết quả" />
                                                    </div>
                                                </td>                                                                                          
                                            </tr>
                                            <tr>                                               
                                            ...
                                            <tr>
                                                <td style="padding-top: 20px">
                                                    <div class="box3 txCenter" style="width: 100%;">
                                                        <Cthuvien:nhap ID="xacnhan" runat="server" Width="80px" Text="Xác nhận" OnClick="return ns_xn_ct_P_NH(2);" />
                                                        <Cthuvien:nhap ID="tuchoi" runat="server" Width="80px" Text="Từ chối" OnClick="return ns_xn_ct_P_NH(3);" />
                                                        <Cthuvien:nhap ID="tralai" runat="server" Width="100px" Text="Y.cầu sửa lại" OnClick="return ns_xn_ct_P_NH(4);" />
                                                        <Cthuvien:nhap ID="in" runat="server" Width="80px" Text="In" OnClick="return ns_xn_ct_P_IN();" OnServerClick="In_Click" />                                          
                                                    </div>
                                                </td>
