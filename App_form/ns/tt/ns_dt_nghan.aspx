<%@ Page Title="ns_dt_nghan" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_dt_nghan.aspx.cs" Inherits="f_ns_dt_nghan" %>
        ...
        <div class="r_c_content b_right">
            ...
            <div class="width_common auto_sc line_46">
                    ...
                    <div class="grid_table width_common">
                        <div style="overflow-x: scroll;">
                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                CssClass="table gridX" loai="X" hangKt="20" cotAn="so_id" hamRow="ns_dt_nghan_GR_lke_RowChange()">
                                <Columns>
                        ...
                        <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_dt_nghan_P_LKE('K')" />
                    </div>
                ...
                <div class="b_right col_60 inner" id="UPa_ct">
                        ...
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ma ReadOnly="true" ID="so_the" ten="Mã cán bộ" runat="server" CssClass="form-control css_ma" BackColor="#f6f7f7"
                                    ktra="ns_cb,so_the,ten" ToolTip="Mã số cán bộ" f_tkhao="~/App_form/ns/tt/ns_cb_chon.aspx" onchange="ns_ths_P_KTRA('SO_THE')"
                                    gchu="gchu" kt_xoa="K" />
                            </div>
                        </div>
                    ...
                    <div class="col_2_iterm width_common">
                        <div class="b_left form-group iterm_form">
                            <span class="standard_label lv2 b_left col_40">Loại Chứng chỉ</span>
                            <div class="input-group">
                    ...
                    <div id="an_chungchi_khac">
                        <div class="width_common">
                            <div class="b_left form-group iterm_form">
                                <span class="standard_label lv2 b_left col_20">Tên chứng chỉ <span class="require">*</span></span>
                                <div class="input-group">
                                    <Cthuvien:ma ID="ten_cchi" ten="Tên chứng chỉ" runat="server" CssClass="form-control css_ma" kt_xoa="X"
                                        kieu_unicode="true" gchu="gchu" ToolTip="Nội dung" MaxLength="255" />
                                </div>
                            </div>
                        </div>
                        <div class="width_common">
                            <div class="b_left form-group iterm_form">
                                <span class="standard_label lv2 b_left col_20">Nội dung </span>
                                <div class="input-group">
                                    <Cthuvien:nd ID="noidung" ten="Nội dung" runat="server" CssClass="form-control css_ma" kt_xoa="X"
                        ...
                        <div class="col_2_iterm width_common">
                            <div class="b_left form-group iterm_form">
                                <span class="standard_label lv2 b_left col_40">Số hiệu</span>
                                <div class="input-group">
                            ...
                            <div class="b_right form-group iterm_form">
                                ...
                                <div class="input-group">
                                    <Cthuvien:ma ID="cs_dtao" ToolTip="Cơ sở đào tạo" runat="server"
                                        kieu_unicode="true" CssClass="form-control css_ma" kt_xoa="X" MaxLength="255" />
                                </div>
                            </div>
                        </div>
                        <div class="col_2_iterm width_common">
                            ...
                            <div class="b_left form-group iterm_form">
                                ...
                                <div class="input-group">
                                    <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="den_ngay" runat="server" ten="Đến ngày"
                                        CssClass="form-control icon_lich" MaxLength="10" kieu_chu="true" kt_xoa="X" />
                                </div>
                            </div>
                        </div>
                        <div class="col_2_iterm width_common">
                            <div class="b_left form-group iterm_form">
                                <span class="standard_label lv2 b_left col_40">Ngày hiệu lực CC</span>
                                <div class="input-group">
                                    <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="ngay_hl" runat="server" ten="Ngày hiệu lực CC"
                                        CssClass="form-control icon_lich" MaxLength="10" kieu_chu="true" kt_xoa="X" />
                                </div>
                            </div>
                            <div class="b_left form-group iterm_form">
                                ...
                                <div class="input-group">
                                    <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="ngay_hhl" runat="server" ten="Ngày hết hiệu lực CC"
                                        CssClass="form-control icon_lich" MaxLength="10" kieu_chu="true" kt_xoa="X" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="moi" runat="server" Text="Làm mới" class="bt_action" anh="K" OnClick="return ns_dt_nghan_P_MOI();form_P_LOI();" Width="100px" />
                        <Cthuvien:nhap ID="nhap" runat="server" Text="Ghi" class="bt_action" anh="K" OnClick="return ns_dt_nghan_P_NH();form_P_LOI();" Width="100px" />
                        <Cthuvien:nhap ID="xoa" runat="server" Text="Xóa" class="bt_action" anh="K" onclick="return ns_dt_nghan_P_XOA();form_P_LOI();" Width="100px" />
                    </div>
                    <div style="display: none;">
                        <Cthuvien:nhap ID="file" runat="server" Text="File" class="bt_action" anh="K" OnClick="return ns_dt_nghan_FI_NH();" Width="70px" />
                    </div>
                    <div>
                        <div id="UPa_gchu">
