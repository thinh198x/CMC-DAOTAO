...
public partial class f_ns_dthv : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                string b_s = this.ResolveUrl("~/App_form/ns/tt/ns_dthv" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
                ScriptManager.RegisterClientScriptInclude(this.Page, this.GetType(), Guid.NewGuid().ToString(), b_s);
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ns_dthv_P_KD('');", true);
    ...
    private void P_NHAN_DROP()
    {
        ...
        se.P_TG_LUU(this.Title, "NS_DTHV_HTDT", b_dt_htdt);

        DataTable b_dt_cnganh = ns_ma.Fdt_NS_MA_CNGANH_DT_DR_A();
        se.P_TG_LUU(this.Title, "NS_DTHV_CNGANH", b_dt_cnganh);
    ...
    protected void excel_Click(object sender, EventArgs e)
    {
        try
        {
            DataTable b_dt = ns_tt.Fdt_NS_DTHV_LKE_ALL(this.so_the_an.Value);
            ...
            b_dt.TableName = "DATA";
            // ghi log
            hts_dungchung.PHT_LOG_NH(PHANHE.NS, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.EXPORT_EXCEL, TEN_FORM.NS_DTHV, TEN_BANG.NS_DTHV);
    ...
    protected void excel_Click_All(object sender, EventArgs e)
    {
        try
        {
            DataTable b_dt = ns_tt.Fdt_NS_DTHV_LKE_ALL(" ");
            bang.P_THAY_GTRI(ref b_dt, "XEPLOAI", "M", " ");
            bang.P_THAY_GTRI(ref b_dt, "XEPLOAI", "G", "Giỏi");
            bang.P_THAY_GTRI(ref b_dt, "XEPLOAI", "K", "Khá");
            bang.P_THAY_GTRI(ref b_dt, "XEPLOAI", "TB", "Trung bình");
            ...
            // ghi log
            hts_dungchung.PHT_LOG_NH(PHANHE.NS, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.EXPORT_EXCEL, TEN_FORM.NS_DTHV, TEN_BANG.NS_DTHV);
            Excel_dungchung.ExportTemplate("Templates/ExportMau/ns_dthv_all.xlsx", b_dt, null, "Danh muc cap nhan vien");
        }
        catch (Exception ex) { form.P_LOI(this, "loi:File export không tồn tại:loi"); }
    }
}
