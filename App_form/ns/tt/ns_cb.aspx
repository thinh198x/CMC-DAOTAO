<%@ Page Title="ns_cb" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_cb.aspx.cs" Inherits="f_ns_cb" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container_content">
        ...
        <div class="r_c_content b_right">
            <div class="title_dmuc width_common">
                <Cthuvien:luu ID="tenForm" runat="server" Text="Hồ sơ nhân viên" />
            ...
            <div class="width_common auto_sc line_37">
                <div class="b_left col_30 inner tabdoc_left">
                    <div class="tab_doc pdl10">
                        <div id="DPu" runat="server">
                            ...
                            <Cthuvien:tab ID="DPu_ttk" runat="server" CssClass="css_tab_doc_de" Text="Thông tin quá trình" />
                        </div>
                    </div>
                    <asp:Panel ID="Pu_tk" runat="server" Style="display: block;">
                        <div id="UPa_tk">
                            <div class="non_tabdoc inner" style="height: 220px">
                            ...
                            <div class="sublist_gr">
                                <ul class="tabContent-list">
                                    ...
                                    <ul class="tabContent-list2">
                                        <li><a href="#" id="ns_qhe" onclick="ns_cb_P_ACTIVEMENU('ns_qhe')">
                                            <Cthuvien:roi ID="ld_qhe" runat="server" f_tkhao="~/App_form/ns/tt/ns_qhe.aspx"
                                                gui="SO_THE,TEN,PHONG" dong="true" Text="Quan hệ thân nhân" />
                                        </a></li>
                                        <li style="display: none"><a id="ns_gd_hc" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_gd_hc')">
                                            <Cthuvien:roi ID="Lb_hc" runat="server" f_tkhao="~/App_form/ns/tt/ns_gd_hc.aspx"
                                                gui="SO_THE,TEN,PHONG" dong="true" Text="Hoàn cảnh kinh tế" />
                                        </a></li>
                                        <li><a id="ns_dthv" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_dthv')">
                                            <Cthuvien:roi ID="Lb_dthv" runat="server" f_tkhao="~/App_form/ns/tt/ns_dthv.aspx"
                                                gui="SO_THE,TEN,PHONG" dong="true" Text="Bằng cấp chuyên môn" />
                                        </a></li>
                                        <li><a id="ns_dt_nghan" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_dt_nghan')">
                                            <Cthuvien:roi ID="Lb_dtnh" runat="server" f_tkhao="~/App_form/ns/tt/ns_dt_nghan.aspx"
                                                gui="SO_THE,TEN,PHONG" dong="true" Text="Chứng chỉ đào tạo" />
                                        </a></li>
                                        <li style="display: none"><a id="ns_kynang_cn" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_kynang_cn')">
                                            <Cthuvien:roi ID="Lb_kynang" runat="server" f_tkhao="~/App_form/ns/tt/ns_kynang_cn.aspx"
                                                gui="SO_THE,TEN,PHONG" dong="true" Text="Kỹ năng cá nhân" />
                                        </a></li>
                                        <li><a id="ns_ths" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_ths')">
                                            <Cthuvien:roi ID="Lb_ths" runat="server" f_tkhao="~/App_form/ns/tt/ns_ths.aspx"
                                                gui="SO_THE,TEN,PHONG" dong="true" Text="Túi hồ sơ" />
                                        </a></li>
                                        <li style="display: none;"><a id="ns_qt_hoctap" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_qt_hoctap')">
                                            <Cthuvien:roi ID="Qt_hoctap" runat="server" f_tkhao="~/App_form/ns/tt/ns_dt_hoctap.aspx"
                                                gui="SO_THE,TEN,PHONG" dong="true" Text="Quá trình học tập" />
                                        </a></li>
                                        <li><a id="ns_ho_gdinh" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_ho_gdinh')">
                                            <Cthuvien:roi ID="ho_gdinh" runat="server" f_tkhao="~/App_form/ns/tt/ns_ho_gdinh.aspx"
                                                gui="SO_THE,TEN" dong="true" Text="Thông tin hộ gia đình" />
                                        </a></li>
                                        <li><a id="ns_lsct" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_lsct')">
                                            <Cthuvien:roi ID="Ls_lsct" runat="server" f_tkhao="~/App_form/ns/ls/ns_lsct.aspx"
                                                gui="SO_THE,TEN,PHONG" dong="true" Text="Quá trình công tác trước khi vào công ty" />
                                        </a></li>
                                    </ul>
                                    <li class="sub_gr">Nghiệp vụ</li>
                                    <ul class="tabContent-list2">
                                        <li><a id="ns_ls_ct_tct" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_ls_ct_tct')">
                                            <Cthuvien:roi ID="Roi5" runat="server"
                                        ...
                                        <li><a id="ns_ls_luong" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_ls_luong')">
                                            <Cthuvien:roi ID="Ls_tct" runat="server"
                                        ...
                                        <li><a id="ns_lsld" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_lsld')">
                                            <Cthuvien:roi ID="Roi1" runat="server"
                                        ...
                                        <li style="display: none"><a id="ns_hd" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_hd')">
                                            <Cthuvien:roi ID="Lb_hd" runat="server"
                                        ...
                                        <li><a id="ns_lskt" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_lskt')">
                                            <Cthuvien:roi ID="Roi3" runat="server"
                                        ...
                                        <li><a id="ns_lskl" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_lskl')">
                                            <Cthuvien:roi ID="Roi4" runat="server"
                                        ...
                                        <li><a id="ns_lsdt" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_lsdt')">
                                            <Cthuvien:roi ID="Roi2" runat="server"
                                                f_tkhao="~/App_form/ns/ls/ns_ls_qt_dt.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Quá trình đào tạo trong công ty" /></a></li>
                                        <li style="display: none"><a id="ns_cp" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_cp')">
                                            <Cthuvien:roi ID="Lb_cp" runat="server"
                                        ...
                                        <li style="display: none"><a id="ns_hdct" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_hdct')">
                                            <Cthuvien:roi ID="Lb_qtlv" runat="server"
                                        ...
                                        <li style="display: none"><a id="ns_biendong_bh" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_biendong_bh')">
                                            <Cthuvien:roi ID="Lb_bhxh" runat="server"
                                        ...
                                        <li style="display: none"><a id="ns_tv" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_tv')">
                                            <Cthuvien:roi ID="Lb_kthd" runat="server"
                                        ...
                                        <li style="display: none"><a id="ns_ktkl_kt" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_ktkl_kt')">
                                            <Cthuvien:roi ID="Lb_kt" runat="server"
                                        ...
                                        <li style="display: none"><a id="ns_ktkl_kl" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_ktkl_kl')">
                                            <Cthuvien:roi ID="Lb_kl" runat="server"
                                        ...
                                        <li><a id="ns_ls_dg" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_ls_dg')">
                                            <Cthuvien:roi ID="lb_dg" runat="server"
                                                f_tkhao="~/App_form/ns/ls/ns_ls_dg.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Kết quả đánh giá" /></a></li>
                                        <li style="display: none"><a id="ns_ttb" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_ttb')">
                                            <Cthuvien:roi ID="Lb_ttb" runat="server"
                                                f_tkhao="~/App_form/ns/sk/ns_ttb.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Trang thiết bị" /></a></li>
                                        <li style="display: none"><a id="ns_cd_dsvm" href="#" onclick="ns_cb_P_ACTIVEMENU('ns_cd_dsvm')">
                                            <Cthuvien:roi ID="Lb_dmvs" runat="server"
                ...
                <div class="b_right col_70 inner" id="UPa_ct">
                    ...
                    <div>
                        <asp:Panel ID="Pa_syll" runat="server" Style="display: block;">
                            ...
                            <div class="col_3_iterm width_common" style="padding-top: 5px;">
                                ...
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_40">Ngày sinh<span class="require">*</span></span>
                                    <div class="input-group">
                                        <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="NSINH" ten="Ngày sinh" runat="server" CssClass="form-control icon_lich"
                                            kt_xoa="X" ToolTip="Ngày sinh" />
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_40">ĐT Nhà riêng</span>
                                    <div class="input-group">
                            ...
                            <div class="col_3_iterm width_common">
                                ...
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_40">Email cá nhân</span>
                                    <div class="input-group">
                                ...
                                <div class="b_right form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_40">Hôn nhân</span>
                                    <div class="input-group">
                            ...
                            <div class="col_3_iterm width_common">
                                ...
                                <div class="b_right form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_40">Nơi cấp</span>
                                    <div class="input-group">
                            ...
                            <div class="col_3_iterm width_common">
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label b_left col_45">CMTND/ Thẻ căn cước<span class="require">*</span></span>
                                    <div class="input-group">
                                ...
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_40">Ngày cấp<span class="require">*</span></span>
                                    <div class="input-group">
                                ...
                                <div class="b_right form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_40">Nơi cấp<span class="require">*</span></span>
                                    <div class="input-group">
                            ...
                            <div class="col_3_iterm width_common">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="NN" runat="server" ten="Quốc tịch" CssClass="form-control css_list"
                                            ktra="ns_ma_nuoc,ma,ten" kt_xoa="X" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_40">Dân tộc</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="dantoc" ten="Dân tộc" CssClass="form-control css_list" runat="server" ktra="ns_ma_dt,ma,ten" />
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_40">Tôn giáo</span>
                                    <div class="input-group">
                            ...
                            <div class="col_3_iterm width_common">
                                ...
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_40">Quận/Huyện</span>
                                    <div class="input-group">
                        ...
                        <asp:Panel ID="Pa_ttk" runat="server" Style="display: none;">
                            ...
                            <div style="display: none">
                                ...
                                <Cthuvien:ma ID="ten_phong" ten="Tên phòng ban" runat="server" CssClass="css_form" kieu_unicode="true" kt_xoa="X" Width="150px" MaxLength="255" />
                    ...
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="moi" runat="server" class="bt_action" anh="K" Text="Làm mới" OnClick="return ns_cb_P_MOI();form_P_LOI();" />
                        <Cthuvien:nhap ID="nhap" runat="server" class="bt_action" anh="K" Text="Ghi" OnClick="return ns_cb_P_KT();form_P_LOI();" />
                        <Cthuvien:nhap ID="in" runat="server" class="bt_action" anh="K" Text="In lý lịch" OnServerClick="nhap2_Click" />
                        <Cthuvien:nhap ID="chon" runat="server" class="bt_action" anh="K" Text="Chọn" OnClick="return form_P_TRA_CHON('SO_THE,TEN,PHONG,TEN_PHONG,EMAIL,NGAYD,CDANH,NSINH,DTDD,EMAIL_CTY,TTR,SO_ID');form_P_LOI();" />
                        <Cthuvien:nhap ID="xoa" runat="server" class="bt_action" anh="K" Text="Xóa" OnClick="return ns_cb_P_XOA();form_P_LOI();" />
                    ...
                    <div class="list_bt_action" style="margin-top: 0px !important;">
                        <button onclick="return ns_cb_Export();form_P_LOI();" class="bt_action">File mẫu</button>
                        <button onclick="return ns_cb_Import();form_P_LOI();" class="bt_action">Import</button>
                    </div>
                    <div style="display: none">
                        <Cthuvien:nhap ID="ttt" runat="server" class="bt_action" anh="K" Text="Mã thông tin" OnClick="return from_MA_TT();form_P_LOI();" />
    ...
    <div id="UPa_hi">
        ...
        <Cthuvien:an ID="aTrangthai" runat="server" value="0" />
        <Cthuvien:an ID="aPhong" runat="server" value="0" />
