<%@ Page Language="C#" AutoEventWireup="true" CodeFile="file_import_ths.aspx.cs" Inherits="f_file_import_ths" 
    Title="file_import_ths" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                            ...
                            <tr>
                                <td>
                                    <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                        CssClass="table gridX" loai="X" hangKt="5" cotAn="url,so_id,ten" hamRow="file_import_ths_GR_lke_RowChange()">
                                        <Columns>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="box3 txRight2">
                                                    <a href="#" onclick="return file_import_ths_P_NH();form_P_LOI();" class="bt bt-grey"><i class="fa fa-save"></i>Nhập</a>
                                                    

                                                    <a href="#" onclick="return form_P_TRA_CHON_D();form_P_LOI();" class="bt bt-grey"><span class="txUnderline">C</span>họn</a>
    ...
    <div id="UPa_hi">
        <Cthuvien:an ID="kthuoc" runat="server" Value="750,380" />
