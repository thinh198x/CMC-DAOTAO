<%@ Page Title="ns_cb_tt" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_cb_tt.aspx.cs" Inherits="f_ns_cb_tt" %>
    ...
    <div id="main_content" class="container_content hide_sbar">
        <div class="r_c_content b_right">
            <div class="title_dmuc width_common">
                <Cthuvien:luu ID="tenForm" runat="server" Text="Thông tin cán bộ nhân viên" />
            ...
            <div class="width_common auto_sc line_37">
                <div class="b_left col_30 inner tabdoc_left">
                    ...
                    <asp:Panel ID="Pu_tk" runat="server" Style="display: none;">
                        <div id="UPa_tk">
                            <div class="non_tabdoc inner" style="height: 190px">
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label b_left col_30">Trạng thái</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_list ID="trangthai_tk" onchange="ns_cb_P_KTRA('PHONG_TK')" CssClass="form-control css_list"
                                ...
                                <div class="b_left form-group iterm_form" style="display: none;">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="phong_tk" ten="Phòng" runat="server" kieu="S" CssClass="form-control css_list" ktra="DT_PH" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                            ...
                            <div class="grid_table width_common">
                                ...
                                <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_cb_P_LKE()" />
                            </div>
                            <div class="list_bt_action">
                                <Cthuvien:nhap ID="excel" runat="server" class="bt_action" anh="K" Text="Xuất excel" Width="100px" OnClick="return ns_cb_P_EXCEL();form_P_LOI();" />
                            </div>
                        </div>
                    </asp:Panel>
                    <asp:Panel ID="Pu_ttk" runat="server" Style="display: block;">
                        <div class="non_tabdoc inner">
                            <div class="sublist_gr">
                                <ul class="tabContent-list">
                                    <li class="sub_gr">Thông tin</li>
                                    <ul class="tabContent-list2">
                                        <li><a id="ns_qhe" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_qhe')">
                                            <Cthuvien:roi ID="ld_qhe" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/tt/ns_qhe_tt.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Quan hệ thân nhân" />
                                        </a></li>
                                        <li style="display: none"><a id="ns_gd_hc" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_gd_hc')">
                                            <Cthuvien:roi ID="Lb_hc" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/tt/ns_gd_hc.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Hoàn cảnh kinh tế" /></a></li>
                                        <li><a id="ns_dthv" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_dthv')">
                                            <Cthuvien:roi ID="Lb_dthv" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/tt/ns_dthv_tt.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Bằng cấp chuyên môn" /></a></li>
                                        <li><a id="ns_dt_nghan" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_dt_nghan')">
                                            <Cthuvien:roi ID="Lb_dtnh" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/tt/ns_dt_tt_nghan.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Chứng chỉ đào tạo" /></a></li>
                                        <li style="display: none"><a id="ns_kynang_cn" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_kynang_cn')">
                                            <Cthuvien:roi ID="Lb_kynang" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/tt/ns_kynang_cn.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Kỹ năng cá nhân" /></a></li>
                                        <li style="display: none"><a id="ns_ths" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_ths')">
                                            <Cthuvien:roi ID="Lb_ths" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/tt/ns_ths.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Túi hồ sơ" /></a></li>
                                        <li style="display: none;"><a id="ns_qt_hoctap" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_qt_hoctap')">
                                        ...
                                        <li style="display: none"><a id="ns_ho_gdinh" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_ho_gdinh')">
                                            <Cthuvien:roi ID="ho_gdinh" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/tt/ns_ho_gdinh.aspx" gui="SO_THE,TEN" dong="true" Text="Thông tin hộ gia đình" /></a></li>
                                        <li><a id="ns_lsct" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_lsct')">
                                            <Cthuvien:roi ID="Ls_lsct" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/ls/ns_lsct_tt.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Quá trình công tác trước khi vào công ty" /></a></li>

                                    </ul>
                                    <li class="sub_gr">Nghiệp vụ</li>
                                    <ul class="tabContent-list2">
                                        <li><a id="ns_ls_luong" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_ls_luong')">
                                            <Cthuvien:roi ID="lb_ls_luong" runat="server" Width="365px"
                                        ...
                                        <li><a id="ns_ls_ct_tct" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_ls_ct_tct')">
                                        ...
                                        <li><a id="ns_lsld" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_lsld')">
                                            <Cthuvien:roi ID="Lb_hd" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/ls/ns_ls_tt_hd_ld.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Quá trình hợp đồng lao động" /></a></li>
                                        <li style="display: none"><a id="ns_hd" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_hd')">
                                            <Cthuvien:roi ID="Lbss_hd" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/qt/ns_tt_hd.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Quá trình ký hợp đồng lao động" /></a></li>
                                        <li><a id="ns_lskt" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_lskt')">
                                            <Cthuvien:roi ID="ld_kt" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/ls/ns_ls_tt_kt.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Quá trình khen thưởng" /></a></li>
                                        <li><a id="ns_lskl" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_lskl')">
                                            <Cthuvien:roi ID="ld_kl" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/ls/ns_ls_tt_kl.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Quá trình kỷ luật" /></a></li>
                                        <li><a id="ns_lsdt" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_lsdt')">
                                        ...
                                        <li style="display: none"><a id="ns_cp" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_cp')">
                                            <Cthuvien:roi ID="Lb_cp" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/qt/ns_tt_cp.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Chuyển phòng" /></a></li>
                                        <li style="display: none"><a id="ns_hdct" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_hdct')">
                                        ...
                                        <li style="display: none"><a id="ns_biendong_bh" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_biendong_bh')">
                                        ...
                                        <li style="display: none"><a id="ns_tv" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_tv')">
                                        ...
                                        <li style="display: none"><a id="ns_ktkl_kt" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_ktkl_kt')">
                                            <Cthuvien:roi ID="Lbs_kt" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/ktkl/ns_ktkl_kt.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Khen thưởng" /></a></li>
                                        <li style="display: none"><a id="ns_ktkl_kl" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_ktkl_kl')">
                                            <Cthuvien:roi ID="Lb_kls" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/ktkl/ns_ktkl_kl.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Kỷ luật" /></a></li>
                                        <li><a id="ns_ls_dg" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_ls_dg')">
                                            <Cthuvien:roi ID="lb_dg" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/ls/ns_ls_tt_dg.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Kết quả đánh giá" /></a></li>
                                        <li style="display: none"><a id="ns_ttb" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_ttb')">
                                            <Cthuvien:roi ID="Lb_ttb" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/sk/ns_ttb.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Trang thiết bị" /></a></li>
                                        <li style="display: none"><a id="ns_cd_dsvm" href="#" onclick="ns_cb_tt_P_ACTIVEMENU('ns_cd_dsvm')">
                                            <Cthuvien:roi ID="Lb_dmvs" runat="server" Width="365px"
                                                f_tkhao="~/App_form/ns/cd/ns_cd_dsvm.aspx" gui="SO_THE,TEN,PHONG" dong="true" Text="Đi muộn - Về sớm" /></a></li>
                                    </ul>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="b_right col_70 inner" id="UPa_ct">
                    <div class="col_3_iterm width_common">
                        <div class="b_left form-group iterm_form css_border" style="width: 90px;">
                            <img id="iurl" runat="Server" alt=" ảnh thẻ" title="Anh the" src="~/images/no_image.png" style="width: 90px; height: 100px; float: right"
                                onclick="return khud_trdoi_FI_NH();form_P_LOI();" disabled="disabled" />
                        </div>
                        <div class="b_left form-group iterm_form" style="padding-left: 80px; padding-top: 35px;">
                            ...
                            <div class="input-group">
                                <Cthuvien:ma ID="so_the" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_ma" kieu_chu="True" kt_xoa="G"
                                    ToolTip="Mã nhân viên" ten="Mã nhân viên" onchange="ns_cb_P_KTRA('SO_THE')" />
                            </div>
                        </div>
                        <div class="b_left form-group iterm_form" style="padding-top: 35px;">
                            <span class="standard_label lv2 b_left col_40">Tên nhân viên</span>
                            <div class="input-group">
                                <Cthuvien:ma ID="TEN" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_ma" kieu_unicode="True" kt_xoa="X"
                        ...
                        <div class="b_left form-group iterm_form" style="padding-left: 80px;">
                            ...
                            <div class="input-group">
                                <Cthuvien:ma ID="kiemnhiem" runat="server" CssClass="form-control css_ma" kieu_chu="True" kt_xoa="G"
                                    ToolTip="Mã nhân viên" ten="Mã nhân viên" BackColor="#f6f7f7" disabled="disabled" />
                            </div>
                        </div>
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ma ID="TEN_HOA" runat="server" CssClass="form-control css_ma" kieu_unicode="True" kt_xoa="X"
                                    ten="Họ và tên" onchange="ns_cb_P_KTRA('TEN')" BackColor="#f6f7f7" disabled="disabled" />
                            </div>
                        </div>
                    </div>
                    <div id="NPa" runat="server" class="navi_tabngang width_common">
                        <Cthuvien:tab ID="NPa_syll" runat="server" CssClass="css_tab_ngang_ac" Width="120px"
                            Text="Sơ yếu lý lịch" />
                        <Cthuvien:tab ID="NPa_ttct" runat="server" CssClass="css_tab_ngang_de" Width="120px"
                            Text="Thông tin công ty" />
                        <Cthuvien:tab ID="NPa_ttk" runat="server" CssClass="css_tab_ngang_de" Width="120px"
                            Text="Thông tin khác" />
                        <div style="display: none">
                            <Cthuvien:tab ID="NPa_ttnl" runat="server" CssClass="css_tab_ngang_de" Width="120px"
                    ...
                    <div>
                        <asp:Panel ID="Pa_syll" runat="server" Style="display: block;">
                            ...
                            <div class="col_3_iterm width_common" style="padding-top: 5px;">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="GTINH" ten="Giới tính" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" runat="server" ktra="DT_GT" kt_xoa="X" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Ngày sinh<span class="require">*</span></span>
                                    <div class="input-group">
                                        <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="NSINH" ten="Ngày sinh" BackColor="#f6f7f7" disabled="disabled" runat="server" CssClass="form-control css_ma_c"
                                ...
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:ma ID="email" ten="Email" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_ma" kt_xoa="X"
                            ...
                            <div class="col_3_iterm width_common">
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label b_left col_45">Số CMT theo MST</span>
                                    <div class="input-group">
                                ...
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="ngay_cmt9" ten="Ngày cấp CMTND 9 số" ToolTip="Ngày cấp CMTND 9 số" runat="server"
                                            CssClass="form-control css_ma_c" kt_xoa="X" />
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                            ...
                            <div class="col_3_iterm width_common">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="NN" runat="server" ten="Quốc tịch" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" ktra="ns_ma_nuoc,ma,ten" kt_xoa="X" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Dân tộc</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="dantoc" ten="Dân tộc" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" runat="server" ktra="ns_ma_dt,ma,ten" />
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Tôn giáo</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="tongiao" ten="Tôn giáo" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" runat="server" ktra="ns_ma_tg,ma,ten" />
                                    </div>
                                </div>
                            </div>
                            <div class="b_left form-group iterm_form">
                                ...
                                <div class="input-group">
                                    <Cthuvien:ma ID="noi_sinh" runat="server" kt_xoa="X" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_ma"
                            ...
                            <div class="col_3_iterm width_common">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="tt_noisinh" BackColor="#f6f7f7" disabled="disabled" ten="Tỉnh/Thành phố" CssClass="form-control css_list" kieu_unicode="true" runat="server" onchange="ns_cb_tt_P_KTRA_DR('tt_noisinh')" ToolTip="Tỉnh/Thành phố" ktra="ns_ma_tt,ma,ten" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Quận/Huyện</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="qh_noisinh" BackColor="#f6f7f7" disabled="disabled" ten="Quận/Huyện" CssClass="form-control css_list" runat="server" onchange="ns_cb_tt_P_KTRA_DR('qh_noisinh')" ToolTip="Quận Huyện" ktra="ns_ma_qh,ma,ten" />
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Xã/Phường</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="xp_noisinh" BackColor="#f6f7f7" disabled="disabled" ten="Xã/Phường" CssClass="form-control css_list" runat="server" onchange="ns_cb_tt_P_KTRA_DR('xp_noisinh')" ToolTip="Tỉnh/Thành phố" ktra="ns_ma_xp,ma,ten" />
                                    </div>
                                </div>
                            </div>
                            <div class="b_left form-group iterm_form">
                                ...
                                <div class="input-group">
                                    <Cthuvien:ma ID="quequan" runat="server" kt_xoa="X" CssClass="form-control css_ma" BackColor="#f6f7f7" disabled="disabled"
                                        kieu_unicode="true" MaxLength="255" />
                                </div>
                            </div>
                            <div class="col_3_iterm width_common">
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label b_left col_45">Tỉnh/Thành phố</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="tt_quequan" ten="Tỉnh/Thành phố" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" kieu_unicode="true" runat="server" onchange="ns_cb_P_KTRA_DR('tt_quequan')" ToolTip="Tỉnh/Thành phố" ktra="ns_ma_tt,ma,ten" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Quận/Huyện</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="qh_quequan" ten="Quận/Huyện" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" runat="server" onchange="ns_cb_P_KTRA_DR('qh_quequan')" ToolTip="Quận Huyện" ktra="ns_ma_qh,ma,ten" />
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Xã/Phường</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="xp_quequan" ten="Xã/Phường" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" runat="server" onchange="ns_cb_P_KTRA_DR('xp_quequan')" ToolTip="Tỉnh/Thành phố" ktra="ns_ma_xp,ma,ten" />
                                    </div>
                                </div>
                            </div>
                            <div class="b_left form-group iterm_form">
                            ...
                            <div class="col_3_iterm width_common">
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label b_left col_45">Tỉnh/Thành phố</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="tt_thuongtru" ten="Tỉnh/Thành phố" CssClass="form-control css_list" runat="server" onchange="ns_cb_tt_P_KTRA_DR('tt_thuongtru')" ToolTip="Tỉnh/Thành phố" ktra="ns_ma_tt,ma,ten" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Quận/Huyện</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="qh_thuongtru" ten="Quận/Huyện" CssClass="form-control css_list" runat="server" onchange="ns_cb_tt_P_KTRA_DR('qh_thuongtru')" ToolTip="Tỉnh/Thành phố" ktra="ns_ma_qh,ma,ten" />
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Xã/Phường</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="xp_thuongtru" ten="Xã/Phường" CssClass="form-control css_list" runat="server" onchange="ns_cb_tt_P_KTRA_DR('xp_thuongtru')" ToolTip="Tỉnh/Thành phố" ktra="ns_ma_xp,ma,ten" />
                                    </div>
                                </div>
                            </div>
                            <div class="b_left form-group iterm_form">
                            ...
                            <div class="col_3_iterm width_common">
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label b_left col_45">Tỉnh/Thành phố</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="tt_tamtru" ten="Tỉnh/Thành phố" CssClass="form-control css_list" runat="server" onchange="ns_cb_tt_P_KTRA_DR('tt_tamtru')"
                                            ToolTip="Tỉnh/Thành phố" ktra="ns_ma_tt,ma,ten" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Quận/Huyện</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="qh_tamtru" ten="Quận/Huyện" CssClass="form-control css_list" runat="server" onchange="ns_cb_tt_P_KTRA_DR('qh_tamtru')"
                                            ToolTip="Tỉnh/Thành phố" ktra="ns_ma_qh,ma,ten" />
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Xã/Phường</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="xp_tamtru" kt_xoa="X" ten="Xã/Phường" CssClass="form-control css_list" runat="server" onchange="ns_cb_tt_P_KTRA_DR('xp_tamtru')"
                                            ToolTip="Tỉnh/Thành phố" ktra="ns_ma_xp,ma,ten" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col_3_iterm width_common">
                                ...
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="quanhe_ll" ktra="DT_QUANHE_LL" runat="server" CssClass="form-control css_list" kt_xoa="X" />
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                        ...
                        <asp:Panel ID="Pa_ttct" runat="server" Style="display: none;">
                            <div class="b_left form-group iterm_form" style="padding-top: 5px;">
                                ...
                                <div class="input-group">
                                    <Cthuvien:DR_lke ID="DONVI" ktra="DT_DONVI" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" onchange="ns_cb_P_KTRA_DR('DONVI')" kt_xoa="X" ten="Công ty"></Cthuvien:DR_lke>
                                </div>
                            </div>
                            <div class="col_3_iterm width_common" style="padding-top: 5px;">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="PHONG_BAN" ktra="DT_PHONG_BAN" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" onchange="ns_cb_P_KTRA_DR('PHONG_BAN')" kt_xoa="X" ten="Phòng/Bộ phận"></Cthuvien:DR_lke>
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form" style="display: none;">
                                    <span class="standard_label lv2 b_left col_45">Phòng/Bộ phận</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="ban" ktra="DT_BAN" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" kt_xoa="X" ten="Ban/Bộ phận"></Cthuvien:DR_lke>
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Khối<span class="require">*</span> </span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="KHOI" ktra="DT_KHOI" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list"
                                            kt_xoa="X" ten="Khối"> 
                                        </Cthuvien:DR_lke>
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:kieu ID="la_cty_chinh" runat="server" lke="X, " Width="30px" ToolTip="X - Có,  - Không" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_ma_c" Text="X" />
                                    </div>
                                </div>
                            </div>
                            <div class="b_left form-group iterm_form" style="padding-top: 5px;">
                                ...
                                <div class="input-group">
                                    <Cthuvien:ma ID="phongban_ct" runat="server" CssClass="form-control" BackColor="#f6f7f7" disabled="disabled" kt_xoa="X" ten="Đơn vị/ bộ phận" />
                                </div>
                            </div>
                            <div style="display: none">
                                <Cthuvien:ma ID="phong" runat="server" BackColor="#f6f7f7" disabled="disabled" kt_xoa="X" CssClass="css_form" Width="150px" MaxLength="255" />
                            </div>
                            <div class="col_3_iterm width_common" style="padding-top: 5px;">
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label b_left col_45">Chức danh<span class="require">*</span></span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="CDANH" ktra="DT_CDANH" runat="server" onchange="ns_cb_P_KTRA_DR('CDANH');" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" kt_xoa="X" ten="Chức danh"></Cthuvien:DR_lke>
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Nhóm chức danh </span>
                                    <div class="input-group">
                                        <Cthuvien:ma ID="ncdanh" runat="server" BackColor="#f6f7f7" disabled="disabled" kt_xoa="X" CssClass="form-control css_ma" kieu_unicode="true" MaxLength="255" />
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Cấp bậc</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="bac_cdanh" ktra="DT_BCDANH" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" kt_xoa="X" ten="Cấp bậc chức danh"></Cthuvien:DR_lke>
                                    </div>
                                </div>
                            </div>
                            <div class="col_3_iterm width_common" style="padding-top: 5px;">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="DTNV" ktra="DT_DTNV" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list"
                            ...
                            <div class="col_3_iterm width_common" style="padding-top: 5px;">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="ngayd" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control icon_lich" kieu_luu="S"
                                            kt_xoa="X" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="ngay_tv" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control icon_lich" kieu_luu="S"
                                            kt_xoa="X" />
                                    </div>
                                </div>
                            </div>
                            <div class="col_3_iterm width_common" style="padding-top: 5px;">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="ngay_ct" BackColor="#f6f7f7" disabled="disabled" ten="Ngày vào chính thức" ToolTip="Ngày vào chính thức" runat="server"
                                ...
                                <div class="b_right form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:ma ID="ma_nsd" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_ma" kieu_unicode="true" kt_xoa="X" Enabled="false"
                            ...
                            <div class="col_3_iterm width_common">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="MA_PBO" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" ten="Mã phân bổ"
                                ...
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="address" ten="Địa chỉ làm việc" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" runat="server" ToolTip="Địa chỉ làm việc" ktra="DT_ADDRESS" />
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Chi nhánh</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="branch" kt_xoa="X" ten="Chi nhánh" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" runat="server" ToolTip="Chi nhánh" ktra="DT_BRANCH" />
                                    </div>
                                </div>
                            </div>
                            <div class="col_3_iterm width_common" style="padding-top: 5px;">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:ma ID="quanly_tt" ten="Quản lý trực tiếp" BackColor="#f6f7f7" disabled="disabled" ToolTip="Quản lý trực tiếp" runat="server"
                                            CssClass="form-control css_ma" kt_xoa="X" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:ma ID="email_cty" ten="Email công ty" BackColor="#f6f7f7" disabled="disabled" runat="server" CssClass="form-control css_ma" kt_xoa="X" Enabled="true" MaxLength="255" />
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Mã chấm công</span>
                                    <div class="input-group">
                                        <Cthuvien:ma ID="ma_cc" ten="Mã chấm công" BackColor="#f6f7f7" disabled="disabled" runat="server" CssClass="form-control css_ma" kt_xoa="X" kieu_so="true" MaxLength="255" />
                                    </div>
                                </div>
                            </div>
                            <div class="col_3_iterm width_common">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="qtrr" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" ten="Đối tượng quản trị rủi ro" ktra="DT_QTRR" kt_xoa="X" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Vùng miền<span class="require">*</span></span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke kt_xoa="X" ID="VUNG" ten="Vùng miền" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" runat="server"
                                ...
                                <div class="b_right form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="ubck" kt_xoa="X" ten="Ủy ban chứng khoán" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_list" runat="server" ToolTip="Chi nhánh" ktra="DT_UBCK" />
                                    </div>
                                </div>
                            </div>
                            <div style="display: none">
                                ...
                                <Cthuvien:ma ID="ten_cm" ten="Chuyên môn" disabled="disabled" runat="server" BackColor="#f6f7f7" CssClass="css_form" kt_xoa="X" Width="150px" />
                                <Cthuvien:ma ID="ten_cbnn" ten="Cấp bậc nghề nghiệp" disabled="disabled" runat="server" BackColor="#f6f7f7" CssClass="css_form" kt_xoa="X" Width="150px" />
                                <Cthuvien:ma ID="ten_loai_cb" ten="Phân loại NV" disabled="disabled" runat="server" BackColor="#f6f7f7" CssClass="css_form" kt_xoa="X" Width="150px" />
                                <Cthuvien:ma ID="ten_capnv" ten="Loại cb" disabled="disabled" runat="server" BackColor="#f6f7f7" CssClass="css_form" kt_xoa="X" Width="150px" />
                        ...
                        <asp:Panel ID="Pa_ttnl" runat="server" Style="display: none;">
                            <Cthuvien:GridX ID="GR_ct" runat="server" AutoGenerateColumns="false" PageSize="1" disabled="disabled"
                        ...
                        <asp:Panel ID="Pa_ttk" runat="server" Style="display: none;">
                            <div class="col_3_iterm width_common" style="padding-top: 5px;">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_list ID="DT_CUTRU" runat="server" CssClass="form-control css_list" ten="Đối tượng cư trú" tra="CT,KCT"
                                            BackColor="#f6f7f7" disabled="disabled" lke="Đối tượng cư trú,Đối tượng không cư trú" kt_xoa="X" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Số sổ BHXH</span>
                                    <div class="input-group">
                                        <Cthuvien:ma ID="so_bhxh" ten="Sổ sổ BHXH" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_ma" kt_xoa="X" MaxLength="255" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Sở trường</span>
                                    <div class="input-group">
                                        <Cthuvien:ma ID="thoihan_hchieu" ten="Sở trường" kieu_unicode="true" runat="server" BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_ma" kt_xoa="X" MaxLength="255" />
                                    </div>
                                </div>
                                ...
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:kieu ID="cd" runat="server" lke=" ,X" Width="30px" ToolTip="X - Có,  - Không" kt_xoa="X"
                                            BackColor="#f6f7f7" disabled="disabled" CssClass="form-control css_ma_c" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="ngaythamgia" runat="server" ten="Ngày tham gia CĐ" CssClass="form-control icon_lich" kieu_luu="S"
                                            BackColor="#f6f7f7" disabled="disabled" kt_xoa="X" />
                                    </div>
                                </div>
                            </div>
                            <div class="col_3_iterm width_common" style="padding-top: 5px;">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:ma ID="so_hchieu" ten="Số hộ chiếu" runat="server" CssClass="form-control css_ma" kt_xoa="X" MaxLength="255" BackColor="#f6f7f7" disabled="disabled" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                ...
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:ma ID="mast" ten="Mã số thuế" runat="server" CssClass="form-control css_ma" ToolTip="Mã số thuế"
                                            BackColor="#f6f7f7" disabled="disabled" kt_xoa="X" MaxLength="100" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Có cam kết</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="ht_tinhluong" runat="server" CssClass="form-control css_list" ten="HT tính lương" ktra="DT_HTTL" kt_xoa="X" BackColor="#f6f7f7" disabled="disabled" />
                                    </div>
                                </div>
                                <div class="b_right form-group iterm_form">
                            ...
                            <div class="col_3_iterm width_common">
                                <div class="b_left form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:ma ID="sotk" runat="server" CssClass="form-control css_ma" kt_xoa="X" ToolTip="Số tài khoản" kieu_chu="True" ten="Số tài khoản" BackColor="#f6f7f7" disabled="disabled" />
                                    </div>
                                </div>
                                <div class="b_left form-group iterm_form">
                                    <span class="standard_label lv2 b_left col_45">Ngân hàng</span>
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="nha" runat="server" kt_xoa="X" ToolTip="Ngân hàng" BackColor="#f6f7f7" disabled="disabled"
                                ...
                                <div class="b_right form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:DR_lke ID="cnhanh_nha" CssClass="form-control css_list" runat="server" kt_xoa="X" ToolTip="Chi nhánh"
                                            kieu_unicode="True" ten="Chi nhánh" ktra="DT_CNNH" BackColor="#f6f7f7" disabled="disabled" />
                                    </div>
                                </div>
                            </div>
                            <div style="display: none">
                    ...
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="nhap" class="bt_action" anh="K" runat="server" Width="100px" Text="Nhập" OnClick="return ns_cb_tt_P_NH();form_P_LOI();" />
                        <Cthuvien:nhap ID="gui" class="bt_action" anh="K" runat="server" Width="120px" Text="Gửi phê duyệt" OnClick="return ns_cb_tt_P_GUI();form_P_LOI();" />
                    </div>
                    <div style="display: none">
                        ...
                        <Cthuvien:nhap ID="moi" runat="server" Text="Làm mới" Width="100px" OnClick="return ns_cb_tt_P_MOI();form_P_LOI();" />
                        <Cthuvien:nhap ID="mau" runat="server" Text="File mẫu" Width="100px" OnClick="return ns_hdns_ma_cm_P_MAU();form_P_LOI();" />
                        <Cthuvien:nhap ID="ttt" runat="server" Text="Mã thông tin" Width="100px" OnClick="return from_MA_TT();form_P_LOI();" />
                        <Cthuvien:nhap ID="hien_ttt" runat="server" Text="Thông tin thêm" Width="100px" />
                        <Cthuvien:nhap ID="in" runat="server" Text="In lý lịch" Width="100px" OnClick="return ns_cb_tt_P_IN();form_P_LOI();" />
                        <Cthuvien:nhap ID="chon" runat="server" Text="Chọn" Width="100px" OnClick="return form_P_TRA_CHON('SO_THE,TEN,PHONG,TEN_PHONG,EMAIL,NGAYD,CDANH,NSINH,DTDD,EMAIL_CTY,TTR,SO_ID');form_P_LOI();" />
                        <Cthuvien:nhap ID="xoa" runat="server" Width="100px" Text="Xóa" OnClick="return ns_cb_tt_P_XOA();form_P_LOI();" />
                        <Cthuvien:nhap ID="XuatExcel" runat="server" Width="90px" Text="Xuất excel" OnServerClick="XuatExcel_Click" />
                        <Cthuvien:nhap ID="anh_the" runat="server" CssClass="css_button" Font-Bold="True" Text="Ảnh"
                            Width="70px" OnClick="return khud_trdoi_FI_NH();form_P_LOI();" />
                    </div>
                </div>
            </div>
        </div>
