<%@ Page Title="ns_tc_dv" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_tc_dv.aspx.cs" Inherits="f_ns_tc_dv" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <tr class="css_tieudeN">
            <td colspan="2">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="left">
                            <Cthuvien:luu ID="Luu1" runat="server" CssClass="css_tieudeM" Text="Đoàn viên" />
                        </td>
                        <td align="right">
                        ...
                        <td align="left">
                            <table id="UPa_ct" runat="server"  cellpadding="1" cellspacing="1">
                                <tr>
                                    ...
                                    <td>
                                        <Cthuvien:DR_nhap ID="PHONG" runat="server" Width="566px" CssClass="css_drop"
                                            onchange="ns_tc_dv_P_KTRA('PHONG')" DataTextField="ten" DataValueField="ma" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <Cthuvien:ma ID="SO_THE" ten="Mã cán bộ" runat="server" CssClass="css_ma" BackColor="#f6f7f7"
                                                        ...
                                                        Width="128px" onchange="ns_tc_dv_P_KTRA('so_the')" gchu="gchu" />
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label2" runat="server" Text="Số thẻ ĐV" CssClass="css_gchu"
                                                        Width="60px" />
                                                </td>
                                                <td>
                                                    <Cthuvien:ma ID="SOTHE_DV" ten="Số thẻ Đoàn viên" runat="server" CssClass="css_ma"
                                                        ToolTip="Số thẻ Đoàn viên" kt_xoa="X" kieu_chu="true" Width="366px" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <Cthuvien:ngay  placeholder='dd/MM/yyyy' ID="NGAYCAP" ten="Ngày cấp" runat="server" Width="128px" CssClass="css_ma_c"
                                                        kt_xoa="X" kieu_luu="S" />
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label5" runat="server" Text="Nơi cấp" CssClass="css_gchu_c" Width="60px" />
                                                </td>
                                                <td>
                                                    <Cthuvien:ma ID="noicap" ten="Nơi cấp" runat="server" kt_xoa="X" CssClass="css_ma"
                                                        Width="366px" kieu_unicode="true"/>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <Cthuvien:ngay  placeholder='dd/MM/yyyy' ID="ngayvao" ten="Ngày vào" runat="server" Width="128px" CssClass="css_ma_c"
                                                        kt_xoa="X" kieu_luu="S" />
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label8" runat="server" Text="Nơi vào" CssClass="css_gchu_c" Width="60px" />
                                                </td>
                                                <td>
                                    ...
                                    <td>
                                        <Cthuvien:GridX ID="GR_ct" runat="server" AutoGenerateColumns="false" PageSize="1"
                                            ...
                                            <Columns>
                                                ...
                                                <ItemTemplate>
                                                    <Cthuvien:ma ID="donvi" runat="server" Width="150px" CssClass="css_Gma" kieu_unicode="true"/>
                                                </ItemTemplate>
                                                </asp:TemplateField>
                    ...
                    <tr>
                        <td align="center">
                            <table id="UPa_nhap" runat="server" cellpadding="1" cellspacing="1">
                                <tr>
                                    <td align="center">
                                        <Cthuvien:nhap ID="nhap" runat="server" Text="Nhập" CssClass="css_button" OnClick="return ns_tc_dv_P_NH();form_P_LOI();"
                                            Width="70px" />
                                    </td>
                                    <td align="center">
                                        <Cthuvien:nhap ID="moi" runat="server" Text="Mới" CssClass="css_button" OnClick="return ns_tc_dv_P_MOI();form_P_LOI();"
                                            Width="70px" />
                                    </td>
                                    <td align="center">
                                        <Cthuvien:nhap ID="xoa" runat="server" Text="Xóa" CssClass="css_button" OnClick="return ns_tc_dv_P_XOA();form_P_LOI();"
                                            Width="70px" />
                                    </td>
                                    <td align="center" valign="middle" style="border: gray 1px solid; width: 20px;">
                                        <img runat="server" alt = "" src="~/images/bitmaps/len.gif" title="Chuyển dòng lên" onclick="return ns_tc_dv_HangLen();" />
                                    </td>
                                    <td style="border: gray 1px solid; width: 20px;" align="center" valign="middle">
                                        <img runat="server" alt = "" src="~/images/bitmaps/xuong.gif" title="Chuyển dòng xuống" onclick="return ns_tc_dv_HangXuong();" />
                                    </td>
                                    <td style="border: gray 1px solid; width: 20px;" align="center" valign="middle">
                                        <img runat="server" alt = "" src="~/images/bitmaps/cat.gif" title="Cắt các dòng đã chọn" onclick="return ns_tc_dv_CatDong();" />
                                    </td>
                                    <td style="border: gray 1px solid; width: 20px;" align="center" valign="middle">
                                        <img runat="server" alt = "" src="~/images/bitmaps/chen.gif" title="Chèn dòng" onclick="return ns_tc_dv_ChenDong('C');" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td>
                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                CssClass="table gridX" loai="X" hangKt="14" cotAn="so_id" hamRow="ns_tc_dv_GR_lke_RowChange()">
                                <Columns>
                                    <asp:BoundField DataField="leGrid" HeaderStyle-Width="10px" />
                                    ...
                                    <asp:BoundField HeaderText="Số thẻ đoàn" DataField="sothe_dv" HeaderStyle-Width="120px" ItemStyle-CssClass="css_Gma" />
    ...
    <div id="UPa_hi">
        <Cthuvien:an ID="kthuoc" runat="server" Value="1105,500" />
