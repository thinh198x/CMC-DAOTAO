<%@ Page Title="ns_td_uv" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_td_uv.aspx.cs" Inherits="f_ns_td_uv" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="main_content" class="container_content hide_sbar">
        <div class="r_c_content b_right">
            <div class="title_dmuc width_common">
                <Cthuvien:luu ID="tenForm" runat="server" Text="Kho ứng viên" />
                <img class="b_right" src="../../../images/edoc/icon_close.png" alt="" onclick="return form_dong();" />
            </div>
            <div class="width_common auto_sc line_37">
                <div class="b_left col_30 inner" id="UPa_tk">
                    <div class="b_left width_common form-group iterm_form">
                        <span class="standard_label b_left col_30">Mã ứng viên </span>
                        <div class="input-group">
                            <Cthuvien:ma ID="so_the_tk" ten="Mã ứng viên tìm kiếm" runat="server" kt_xoa="K" CssClass="form-control css_ma" kieu_chu="true" />
                        </div>
                    </div>
                    <div class="b_left width_common form-group iterm_form">
                    ...
                    <div class="b_left width_common form-group iterm_form">
                        ...
                        <div class="input-group">
                            <Cthuvien:DR_lke ID="cdanh_ut_tk" kt_xoa="X" ten="Chức danh" CssClass="form-control css_list" ktra="DT_CDANH_UTTK" runat="server">                                                                                
                            </Cthuvien:DR_lke>
                        </div>
                    </div>
                    <div class="b_left width_common form-group iterm_form">
                        ...
                        <div class="input-group">
                            <Cthuvien:DR_lke ID="trangthai_tk" kt_xoa="X" ten="Trạng thái" CssClass="form-control css_list" ktra="DT_UV_TK" runat="server">                                                                                
                            </Cthuvien:DR_lke>
                        </div>
                    </div>
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="tim" runat="server" Text="Tìm kiếm" Width="100px" class="bt_action" anh="K" OnClick="return ns_td_uv_P_LKE('M');form_P_LOI();" />
                    </div>
                    <div class="grid_table width_common">
                        <div style="overflow-x: scroll">
                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1" Width="100%"
                                CssClass="table gridX" loai="X" hangKt="20" cot="CHON,so_the,ten,ten_cdanh_ut,sodt_dd,email,ten_trangthai,trangthai,so_id" cotAn="so_id,trangthai" hamRow="ns_td_uv_GR_lke_RowChange()"
                                hamUp="ns_td_uv_lke_Update">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Chức danh mong muốn ứng tuyển" DataField="ten_cdanh_ut" HeaderStyle-Width="250px" ItemStyle-CssClass="css_Gma" />
                                    ...
                                    <asp:BoundField HeaderText="Trạng thái" DataField="ten_trangthai" HeaderStyle-Width="180px" ItemStyle-CssClass="css_Gma" />
                        ...
                        <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_td_uv_P_LKE('L')" />

                    </div>
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="excel" runat="server" Width="100px" class="bt_action" Text="Xuất excel" OnServerClick="excel_Click" />
                    </div>
                </div>
                <div class="b_right col_70 inner" id="UPa_ct">
                        ...
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ma ID="so_the" runat="server" CssClass="form-control css_ma" kieu_chu="True" kt_xoa="G" Enabled="false" BackColor="#f6f7f7"
                                    ToolTip="Mã số cán bộ" ten="Số thẻ" onchange="ns_td_uv_P_KTRA('SO_THE')" />
                            </div>
                        </div>
                        <div class="b_left form-group iterm_form">
                            <span class="standard_label lv2 b_left col_30">Họ và Tên <span class="require">*</span></span>
                            <div class="input-group">
                    ...
                    <div class="b_right form-group iterm_form">
                        <span class="standard_label b_left col_15">Chức danh mong muốn ứng tuyển<span class="require">*</span></span>
                        <div class="input-group">
                            <Cthuvien:DR_lke ID="cdanh_ut" kt_xoa="X" ten="Chức danh mong muốn ứng tuyển" CssClass="form-control css_list" ktra="DT_CDANH_UT" runat="server">                                                                                
                            </Cthuvien:DR_lke>
                        </div>
                    </div>
                        ...
                        <div>
                            <asp:Panel ID="Pa_ttc" runat="server" Style="display: block;">
                                ...
                                <div class="b_left width_common form-group iterm_form">
                                    ...
                                    <div class="input-group">
                                        <Cthuvien:ma ID="noilamviec_mm" runat="server" kt_xoa="X" CssClass="form-control css_ma"
                                ...
                                <div class="col_3_iterm width_common">
                                    <div class="b_left form-group iterm_form">
                                        ...
                                        <div class="input-group">
                                            <Cthuvien:DR_lke kt_xoa="X" ID="tt_noisinh" ten="Tỉnh/Thành" runat="server" CssClass="form-control css_list" onchange="ns_td_uv_P_KTRA_DR('tt_noisinh')" ToolTip="Tỉnh/Thành " ktra="ns_ma_tt,ma,ten" />
                                    ...
                                    <div class="b_left form-group iterm_form">
                                        ...
                                        <div class="input-group">
                                            <Cthuvien:DR_lke kt_xoa="X" ID="qh_noisinh" ten="Quận/Huyện" runat="server" CssClass="form-control css_list" onchange="ns_td_uv_P_KTRA_DR('qh_noisinh')" ToolTip="Quận/Huyện " />
                                ...
                                <div class="col_3_iterm width_common">
                                    <div class="b_left form-group iterm_form">
                                        <span class="standard_label b_left col_45">Tỉnh/Thành</span>
                                        <div class="input-group">
                                            <Cthuvien:DR_lke kt_xoa="X" ID="tt_tamtru" ten="Tỉnh/Thành" runat="server" CssClass="form-control css_list" onchange="ns_td_uv_P_KTRA_DR('tt_tamtru')" ToolTip="Tỉnh/Thành " ktra="ns_ma_tt,ma,ten" />
                                    ...
                                    <div class="b_left form-group iterm_form">
                                        <span class="standard_label lv2 b_left col_45">Quận/Huyện</span>
                                        <div class="input-group">
                                            <Cthuvien:DR_lke kt_xoa="X" ID="qh_tamtru" ten="Quận/Huyện" runat="server" CssClass="form-control css_list" onchange="ns_td_uv_P_KTRA_DR('qh_tamtru')" ToolTip="Quận/Huyện " />
                                ...
                                <div class="col_3_iterm width_common">
                                    <div class="b_left form-group iterm_form">
                                        <span class="standard_label b_left col_45">Tỉnh/Thành</span>
                                        <div class="input-group">
                                            <Cthuvien:DR_lke kt_xoa="X" ID="tt_thuongtru" ten="Tỉnh/Thành" runat="server" CssClass="form-control css_list" onchange="ns_td_uv_P_KTRA_DR('tt_thuongtru')" ToolTip="Tỉnh/Thành " ktra="ns_ma_tt,ma,ten" />
                                    ...
                                    <div class="b_left form-group iterm_form">
                                        <span class="standard_label lv2 b_left col_45">Quận/Huyện</span>
                                        <div class="input-group">
                                            <Cthuvien:DR_lke kt_xoa="X" ID="qh_thuongtru" ten="Quận/Huyện" runat="server" CssClass="form-control css_list" onchange="ns_td_uv_P_KTRA_DR('qh_thuongtru')" ToolTip="Quận/Huyện " />
                                ...
                                <div class="col_3_iterm width_common">
                                    ...
                                    <div style="display: none;">
                                        ...
                                        <Cthuvien:ma ID="mayeucau_td" ten="Yêu cầu tuyển dụng" runat="server" ToolTip="Cân nặng"
                                            CssClass="form-control css_" kt_xoa="X" />
                                    </div>
                                </div>
                            </asp:Panel>
                                    ...
                                    <div class="b_left width_common form-group iterm_form">
                                        ...
                                        <div class="input-group">
                                            <Cthuvien:kieu ID="nguoithan_lvttd_co" runat="server" lke=",X" Width="30px" ToolTip="Có người thân/họ hàng làm việc tại Tập đoàn thủ đô"
                                                onchange="ns_td_uv_P_ANHIEN('NGUOITHAN_CO')" CssClass="form-control css_Gma_c" Text="" kt_xoa="X" />
                                            ...
                                            <Cthuvien:kieu ID="nguoithan_lvttd_ko" runat="server" lke=",X" Width="30px" ToolTip="Không có người thân/họ hàng làm việc tại Tập đoàn thủ đô"
                                                onchange="ns_td_uv_P_ANHIEN('NGUOITHAN_KO')" CssClass="form-control css_Gma_c" Text="" kt_xoa="X" />
                                        ...
                                        <div class="b_left form-group iterm_form">
                                            ...
                                            <div class="input-group">
                                                <Cthuvien:kieu ID="banthan_lvttd_co" runat="server" lke=",X" Width="30px" ToolTip="Có người thân/họ hàng làm việc tại Tập đoàn thủ đô"
                                                    onchange="ns_td_uv_P_ANHIEN('BANTHAN_CO')" CssClass="form-control css_Gma_c" Text="" kt_xoa="X" />
                                                ...
                                                <Cthuvien:kieu ID="banthan_lvttd_ko" runat="server" lke=",X" Width="30px" ToolTip="Không có người thân/họ hàng làm việc tại Tập đoàn thủ đô"
                                                    onchange="ns_td_uv_P_ANHIEN('BANTHAN_KO')" CssClass="form-control css_Gma_c" Text="" kt_xoa="X" />
                                            </div>
                                        </div>
                                        <div class="b_right form-group iterm_form">
                                    ...
                                    <div class="b_left form-group iterm_form">
                                        ...
                                        <div class="input-group">
                                            <Cthuvien:kieu ID="banthan_ut_co" runat="server" lke=",X" Width="30px" ToolTip="Có người thân/họ hàng làm việc tại Tập đoàn thủ đô"
                                                onchange="ns_td_uv_P_ANHIEN('UNGTUYEN_CO')" CssClass="form-control css_Gma_c" Text="" kt_xoa="X" />
                                            ...
                                            <Cthuvien:kieu ID="banthan_ut_ko" runat="server" lke=",X" Width="30px" ToolTip="Không có người thân/họ hàng làm việc tại Tập đoàn thủ đô"
                                                onchange="ns_td_uv_P_ANHIEN('UNGTUYEN_KO')" CssClass="form-control css_Gma_c" Text="" kt_xoa="X" />
                                        </div>
                                    </div>
                                    <div class="b_left form-group iterm_form">
                    ...
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="nhap" runat="server" class="bt_action" anh="K" Font-Bold="True" Width="70px" Text="Nhập" OnClick="return ns_td_uv_P_NH();form_P_LOI();" />
                        <Cthuvien:nhap ID="moi" runat="server" Text="Mới" class="bt_action" anh="K" OnClick="return ns_td_uv_P_MOI();form_P_LOI();" Width="70px" />
                        <Cthuvien:nhap ID="xoa" runat="server" class="bt_action" anh="K" Font-Bold="True" Width="70px" Text="Xóa" OnClick="return ns_td_uv_P_XOA();form_P_LOI();" />
                        ...
                        <Cthuvien:nhap ID="XuatFileMau" runat="server" Width="80px" class="bt_action" anh="K" Text="File mẫu" OnServerClick="XuatFileMau_Click" />
                        <Cthuvien:nhap ID="NhapFileMau" runat="server" class="bt_action" anh="K" Font-Bold="True" Width="70px" Text="Import" OnClick="return ns_td_uv_Import();form_P_LOI();" />
                        <Cthuvien:nhap ID="chon" runat="server" class="bt_action" anh="K" Font-Bold="True" Width="70px" Text="Chọn" OnClick="return ns_td_uv_P_CHON();form_P_LOI();" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="UPa_hi">
        ...
        <Cthuvien:an ID="TD_CN" runat="server" value="TD_CN" />
        <Cthuvien:an ID="qg" runat="server" value="QG001" />
