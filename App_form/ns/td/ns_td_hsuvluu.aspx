<%@ Page Title="ns_td_hsuv" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_td_hsuvluu.aspx.cs" Inherits="f_ns_td_hsuv" %>
        ...
        <tr class="css_tieudeN">
            <td colspan="2">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="left">
                            <Cthuvien:luu ID="Luu1" runat="server" CssClass="css_tieudeM" Text="Hồ sơ ứng viên lưu" />
                        </td>
                        <td align="right">
        ...
        <tr>
            <td>
                <table id="UPa_ct" runat="Server" cellpadding="1" cellspacing="1" >
                    <tr>
                        <td>
                            <asp:Label ID="Label9" runat="server" Text="Nhóm công việc" Width="100px" CssClass="css_gchu" />
                        </td>
                        <td align="left">
                                ...
                                <tr>
                                    <td>
                                        <Cthuvien:ma ID="NHOM_CDANH" runat="server" ten="Nhóm công việc" BackColor="#f6f7f7"
                                            ...
                                            CssClass="css_ma" Width="137px" onchange="ns_td_hsuv_P_KTRA('NHOM_CDANH')" />
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <Cthuvien:ma ID="MA_CDANH" runat="server" ten="Mã vị trí cần tuyển" ToolTip="Mã vị trí cần tuyển"
                                            ...
                                            kieu_chu="true" CssClass="css_ma" Width="137px" onchange="ns_td_hsuv_P_KTRA('MA_CDANH')" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <tr>
                        ...
                        <td align="left">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <Cthuvien:ma ID="CMT" runat="server" ten="Số CMT/hộ chiếu" kieu_chu="true" CssClass="css_ma"
                                    ...
                                    <td>
                                        <Cthuvien:ma ID="TEN" ten="Họ tên ứng viên" ToolTip="Họ tên ứng viên" runat="server"
                                            kt_xoa="X" CssClass="css_ma" Width="137px" kieu_unicode="true" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <Cthuvien:DR_nhap ID="gtinh" ten="Giới tính" runat="server" kieu="U" CssClass="css_drop"
                                            Width="143px" DataTextField="ten" DataValueField="ma" />
                                    </td>
                                    <td>
                                        <asp:Label ID="Label6" runat="server" Text="Ngày sinh" Width="70px" CssClass="css_gchu_c" />
                                    </td>
                                    <td>
                                        <Cthuvien:ngay  placeholder='dd/MM/yyyy' ID="nsinh" ten="Ngày sinh" runat="server" CssClass="css_ma_c" kieu_luu="I"
                                            Width="137px" kt_xoa="X" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <Cthuvien:ma ID="trinh_do" ten="Trình độ" runat="server" kt_xoa="X" CssClass="css_ma"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <Cthuvien:ma ID="kinh_nghiem" ten="Kinh nghiệm" runat="server" kt_xoa="X" CssClass="css_ma"
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <Cthuvien:ma ID="ky_nang" ten="Kỹ năng" runat="server" kt_xoa="X" CssClass="css_ma"
                                Width="350px" kieu_unicode="true" TextMode="MultiLine" Rows="2" />
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <Cthuvien:nd ID="note" ten="Ghi chú" runat="server" kt_xoa="X" CssClass="css_ma"
                                Width="350px" kieu_unicode="true" TextMode="MultiLine" Height="50px"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                CssClass="table gridX" loai="X" hangKt="14" hamRow="ns_td_hsuv_GR_lke_RowChange()">
                                <Columns>
