<%@ Page Title="ns_td_ungvien_dongy" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_td_ungvien_dongy.aspx.cs" Inherits="f_ns_td_ungvien_dongy" %>
                    ...
                    <tr>
                        <td align="right" colspan="2">
                            <table cellpadding="1" cellspacing="1" width="100%">
                                <tr>
                                    <td align="left">
                                        <Cthuvien:luu ID="Luu2" runat="server" CssClass="css_tieudeM" Text="Thông tin ứng viên trúng tuyển" />
                                    </td>
                                    <td align="right">
                                        <div class="acc">
                                            <ul>
                                    ...
                                    <td>
                                        <div id="first-tab-group">
                                            <div class="box3" id="search">
                                                <asp:Panel ID="Pa_ch" runat="server" Style="height: 522px; display: block;">
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="center">
                                                                <table id="Upa_tk" style="line-height: 20px;" cellpadding="1" cellspacing="1">
                                                                    <tr>
                                                                        <td align="left">
                                                                        ...
                                                                        <td>
                                                                            <Cthuvien:ma ID="cdanh_tk" placeholder="Nhấn (F1)" runat="server" CssClass="css_form" kieu_chu="True" kt_xoa="G"
                                                                                ToolTip="Ví trí tuyển dụng" ktra="ns_ma_cdanh,ma,ten" gchu="gchu" f_tkhao="~/App_form/ns/hdns/tl/ns_ma_cdanh.aspx" BackColor="#f6f7f7" Width="140px" ten="Mã yêu cầu TD" onchange="ns_td_ungvien_dongy_P_KTRA('CDANH')" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <Cthuvien:ma ID="ma_yc_tk" runat="server" BackColor="#f6f7f7" CssClass="css_form" f_tkhao="~/App_form/ns/td/ns_td_khct.aspx" gchu="gchu" kieu_chu="True" kt_xoa="G" ktra="ns_td_khct,ma,ma" onchange="ns_td_ungvien_dongy_P_KTRA('MA_YC_TK')" placeholder="Nhấn (F1)" ten="Mã yêu cầu TD" ToolTip="Mã yêu cầu tìm kiếm" Width="140px" />
                                                                        </td>
                                                                        <td></td>
                                                                        <td>
                                                                            <a href="#" onclick="return ns_td_ungvien_dongy_P_LKE('M');form_P_LOI();" class="bt bt-grey"><i class="fa fa-search"></i>Tìm kiếm</a>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left"></td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                                                    CssClass="table gridX" loai="X" hangKt="11" cot="sott,so_the,ten,nam,ma_yc,cdanh,phong_yc,ngay_bd" cotAn="so_id">
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundField HeaderText="Ngày đi làm dự kiến" DataField="ngay_bd" HeaderStyle-Width="100px" ItemStyle-CssClass="css_Gma_c" />
                                                                    </Columns>
                                                                </Cthuvien:GridX>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td id="GR_lke_td" runat="server" align="center" style="padding-right: 10px;">
                                                                <khud_slide:khud_slide ID="GR_lke_slide" runat="server" rong="200" loai="X" gridId="GR_lke"
                                                                    ham="ns_td_ungvien_dongy_P_LKE('L')" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" style="padding-top: 20px">
                                                                <a href="#" onclick="return ns_td_ungvien_dongy_P_EXCEL();form_P_LOI();" class="bt bt-grey"><i class="fa fa-grey"></i>Xuất excel</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
