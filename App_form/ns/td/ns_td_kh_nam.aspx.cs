...
public partial class f_ns_td_kh_nam : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                string b_s = this.ResolveUrl("~/App_form/ns/td/ns_td_kh_nam" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ns_td_kh_nam_P_KD();", true);
    ...
    protected void excel_Click(object sender, EventArgs e)
    {
        try
        {
            DataTable b_dt = ns_td.Fdt_NS_TD_KH_NAM_EXPORT();
            b_dt.TableName = "DATA";
            bang.P_SO_CNG(ref b_dt, "ngaycan_ns");

            // ghi log
            hts_dungchung.PHT_LOG_NH(PHANHE.TD, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.EXPORT_EXCEL, TEN_FORM.NS_TD_KH_NAM, TEN_BANG.NS_TD_KH_NAM);
            Excel_dungchung.ExportTemplate("Templates/ExportMau/ns_td_kh_nam.xlsx", b_dt, null, "Ke_hoach_tuyen_dung_nam");
        }
    ...
    protected void XuatFileMau_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // ghi log
            hts_dungchung.PHT_LOG_NH(PHANHE.TD, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.EXPORT_MAU, TEN_FORM.NS_TD_KH_NAM, TEN_BANG.NS_TD_KH_NAM);
