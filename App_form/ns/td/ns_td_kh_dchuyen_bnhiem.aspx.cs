...
public partial class f_ns_td_kh_dchuyen_bnhiem : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                string b_s = this.ResolveUrl("~/App_form/ns/td/ns_td_kh_dchuyen_bnhiem" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
                ...
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ns_td_kh_dchuyen_bnhiem_P_KD();", true);
    ...
    protected void excel_Click(object sender, EventArgs e)
    {
        try
        {
            DataTable b_dt = ns_td.Fdt_NS_TD_KH_DCHUYEN_BNHIEM_EXPORT();
            b_dt.TableName = "DATA"; 

            // ghi log
            hts_dungchung.PHT_LOG_NH(PHANHE.TD, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.EXPORT_EXCEL, TEN_FORM.NS_TD_KH_DCHUYEN_BNHIEM, TEN_BANG.NS_TD_KH_DCHUYEN_BNHIEM);
            Excel_dungchung.ExportTemplate("Templates/ExportMau/ns_td_kh_dchuyen_bnhiem.xlsx", b_dt, null, "Ke_hoach_tuyen_dung_nam");
        }
    ...
    protected void XuatFileMau_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // ghi log
            hts_dungchung.PHT_LOG_NH(PHANHE.TD, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.EXPORT_MAU, TEN_FORM.NS_TD_KH_DCHUYEN_BNHIEM, TEN_BANG.NS_TD_KH_DCHUYEN_BNHIEM);
            Excel_dungchung.ExportTemplate("Templates/ExportMau/ns_td_kh_dchuyen_bnhiem.xlsx", b_ds, null, "Ke_hoach_nam" + DateTime.Now.Second);
        }
