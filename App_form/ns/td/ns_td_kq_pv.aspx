<%@ Page Title="ns_td_kq_pv" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_td_kq_pv.aspx.cs" Inherits="f_ns_td_kq_pv" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="padding-left: 15px;">
                                                                <div><a href="#" onclick="return ns_td_kq_pv_P_LKE();form_P_LOI();" class="bt bt-grey"><i class="fa fa-search"></i>Tìm kiếm</a></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                    ...
                                    <td>
                                        <div style="height: 600px; width: 600px; overflow: scroll">
                                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                                CssClass="table gridX" loai="X" hangKt="18" cotAn="so_id,nam,thang,gioitinh,ngaysinh" hamRow="ns_td_kq_pv_GR_lke_RowChange()">
                                                <Columns>
                                                ...
                                                <td colspan="2">
                                                    <div style="width: 550px; overflow-x: scroll">
                                                        <Cthuvien:GridX ID="Gr_mt" runat="server" AutoGenerateColumns="false" PageSize="1"
                                                            CssClass="table gridX" loai="N" cot="stt,tieuchi,ghinhan_dactrung,tytrong,diem_dg,tongdiem" hangKt="7">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Nhận xét những nét đặc trưng" HeaderStyle-Width="200px">
                                                                    <ItemTemplate>
                                                                        <Cthuvien:ma ID="ghinhan_dactrung" runat="server" kieu_unicode="true" CssClass="css_Gma" kt_xoa="X" Width="200px" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            <td align="left">
                                                                <Cthuvien:kieu ID="dong_y" runat="server" lke=",X" Width="30px" ToolTip="X - Đồng ý" CssClass="css_form_c" Text="" />
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label13" runat="server" CssClass="css_gchu_c">Đồng ý tiếp nhận</asp:Label>
                                                            </td>
                                                            <td align="left">
                                                                <Cthuvien:kieu ID="xemxet" runat="server" lke=",X" Width="30px" ToolTip="X - Tham gia,  - Không tham gia" CssClass="css_form_c" Text="" />
                                                            </td>
                                                            <td>
                                                                <asp:Label ID="Label15" runat="server" CssClass="css_gchu_c">Cần xem xét thêm</asp:Label>
                                                            </td>
                                                            <td align="left">
                                                                <Cthuvien:kieu ID="khong_dongy" runat="server" lke=",X" Width="30px" ToolTip="X - Tham gia,  - Không tham gia" CssClass="css_form_c" Text="" />
                                                            </td>
                                                            <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="box3 txRight">
                                                        ...
                                                        <a href="#" onclick="return ns_td_kq_pv_P_NH();form_P_LOI();" class="bt bt-grey"><i class="fa fa-save"></i><span class="txUnderline">N</span>hập</a>
                                                        <a href="#" onclick="return ns_td_kq_pv_P_Update('1');form_P_LOI();" class="bt bt-grey">Trúng tuyển</a>
                                                        <a href="#" onclick="return ns_td_kq_pv_P_Update('2');form_P_LOI();" class="bt bt-grey">Không trúng tuyển</a>
                                                        <a href="#" class="bt bt-grey" onclick="return sendMail();form_P_LOI();"><i class="fa fa-send"></i>Gửi email</a>
                                                        <a href="#" onclick="return ns_td_kq_pv_P_IN();form_P_LOI();" class="bt bt-grey"><i class="fa fa-file-word-o"></i>In</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr style="display: none">
                                                <td>
                                                    <Cthuvien:nhap ID="inword" runat="server" Width="100px" Text="In biểu mẫu" OnServerClick="inword_Click" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
