<%@ Page Title="ns_qt_nghiphep_pd" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_qt_nghiphep_pd.aspx.cs" Inherits="f_ns_qt_nghiphep_pd" %>
    ...
    <div id="main_content" class="container_content hide_sbar">
        <div class="r_c_content b_right">
            <div class="title_dmuc width_common">
                <Cthuvien:luu ID="tenForm" runat="server" Text="Phê duyệt thông tin đăng ký nghỉ" />
                ...
                <div class="b_right col_100 inner" id="UPa_ct">
                    <div class="col_5_iterm width_common">
                        ...
                        <div class="b_right form-group lv2 iterm_form">
                            <Cthuvien:nhap ID="tim" class="bt_action" anh="K" runat="server" Text="Tìm kiếm" Width="90px" OnClick="ns_qt_nghiphep_pd_P_LKE();form_P_LOI('');" Title="Tìm kiếm" />
                    ...
                    <div class="grid_table width_common">
                        <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Loại đăng ký" DataField="LOAI_DKY" ItemStyle-CssClass="css_Gma" />
                        ...
                        <div id="GR_lke_td">
                            <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_qt_nghiphep_pd_P_LKE()" />
                        </div>
                    </div>
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="Nhap1" runat="server" Text="Phê duyệt" Width="120px" class="bt_action" anh="K" title="Phê duyệt" OnClick="return ns_qt_nghiphep_pd_P_PHEDUYET('C');form_P_LOI();" />
                        <Cthuvien:nhap ID="thanhly" runat="server" Text="Không phê duyệt" Width="130px" class="bt_action" anh="K" title="Không phê duyệt" OnClick="return ns_qt_nghiphep_pd_P_KOPHEDUYET();form_P_LOI();" />
                    </div>
                </div>
            </div>
        </div>
