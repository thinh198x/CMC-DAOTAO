<%@ Page Title="ns_qt_lviec_ngoaicty" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_qt_lviec_ngoaicty.aspx.cs" Inherits="f_ns_qt_lviec_ngoaicty" %>
            ...
            <div class="width_common auto_sc line_55">
                    ...
                    <div class="col_2_iterm width_common">
                        <div class="b_right lv2 form-group iterm_form">
                            <Cthuvien:nhap ID="tim" runat="server" Width="120px" class="bt_action" anh="K" Text="Tìm kiếm"
                                OnClick="return ns_qt_lviec_ngoaicty_P_LKE('K');form_P_LOI();" />
                        </div>
                    </div>
                    <div class="grid_table width_common">
                        <div style="overflow-x: scroll;">
                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1" Width="100%"
                                ...
                                hamRow="ns_qt_lviec_ngoaicty_GR_lke_RowChange()">
                                <Columns>
                        ...
                        <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_qt_lviec_ngoaicty_P_LKE('K')" />
                ...
                <div class="b_right col_50 inner" id="UPa_ct">
                    ...
                    <div class="col_2_iterm width_common">
                        <%-- <div class="b_left form-group iterm_form">
                            <div class="input-group">
                                <Cthuvien:DR_lke ID="MACC_NGHI" ktra="DT_KIEUNGHI" kt_xoa="X" CssClass="form-control css_list" ten="Loại hình nghỉ" runat="server" onchange="ns_qt_lviec_ngoaicty_P_KTRA('MACC_NGHI');">                                                                                
                                </Cthuvien:DR_lke>
                            </div>
                        </div>--%>
                        <div class="b_left form-group iterm_form">
                            <span class="standard_label b_left col_40">Ngày đăng ký</span>
                            <div class="input-group">
                                <Cthuvien:ngay ID="NGAY_DKY" placeholder='dd/MM/yyyy' ten="Từ ngày" runat="server" kt_xoa="X" CssClass="form-control icon_lich css_ma" kieu_luu="S" onchange="ns_qt_lviec_ngoaicty_P_KTRA('NGAYD')" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col_2_iterm width_common">
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ma ID="GIOD" ten="Từ giờ" MaxLength="30" kt_xoa="X" runat="server" CssClass="form-control css_ma_c" kieu_chu="True" onchange="ns_qt_lviec_ngoaicty_P_KTRA('GIOD')" />
                            </div>
                        </div>
                        <div class="b_right form-group iterm_form">
                            <span class="standard_label lv2 b_left col_40">Đến giờ <span class="require">*</span></span>
                            <div class="input-group">
                                <Cthuvien:ma ID="GIOC" ten="Đến giờ" MaxLength="30" kt_xoa="X" runat="server" CssClass="form-control css_ma_c" kieu_chu="True" onchange="ns_qt_lviec_ngoaicty_P_KTRA('GIOC')" />
                            </div>
                        </div>
                    </div>
