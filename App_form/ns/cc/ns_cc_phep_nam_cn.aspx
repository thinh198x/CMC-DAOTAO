<%@ Page Title="ns_cc_phep_nam_cn" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_cc_phep_nam_cn.aspx.cs" Inherits="f_ns_cc_phep_nam_cn" %>
                ...
                <div class="b_left col_100 inner" id="UPa_tk">
                    <div class="width_common" style="display: none">
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:DR_lke ID="PHONG" ten="Phòng" runat="server" CssClass="form-control css_list" kieu="U" kt_xoa="K" onchange="ns_cc_phep_nam_cn_P_KTRA('PHONG')" ktra="DT_PHONG" />
                            </div>
                        </div>
                    </div>
                    <div class="col_3_iterm width_common">
                        ...
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:DR_lke ID="NAM" ten="Năm" runat="server" CssClass="form-control css_list" onchange="ns_cc_phep_nam_cn_P_KTRA('NAM');" kt_xoa="K" ktra="DT_NAM" />
                        ...
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:DR_lke ID="KYLUONG" ten="Kỳ công" runat="server" CssClass="form-control css_list" kt_xoa="G" onchange="ns_cc_phep_nam_cn_P_KTRA('KYLUONG')" ktra="DT_KYLUONG" />
                        ...
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ma ID="so_the" runat="server" CssClass="form-control css_ma" BackColor="#f6f7f7" kieu_chu="true" placeholder="Nhấn (F1)"
                                    f_tkhao="~/App_form/ns/tt/ns_cb_chon.aspx" gchu="gchu" ten="Mã nhân viên" MaxLength="30" Enabled="false"
                                    onchange="ns_cc_phep_nam_cn_P_LKE()" ktra="ns_cb,so_the,ten" kt_xoa="K" />

                            </div>
                        </div>
                    </div>
                    <div class="list_bt_action" style="display: none">
                        <Cthuvien:nhap ID="t" runat="server" Text="Tổng hợp phép năm" class="bt_action" anh="K" Width="160px" OnClick="ns_cc_phep_nam_cn_TINH();form_P_LOI('');" Title="Tổng hợp phép năm" />
                    </div>
                    <div class="grid_table width_common">
                        ...
                        <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_cc_phep_nam_cn_P_LKE()" />
                    </div>
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="Nhap1" runat="server" Text="Xuất Excel" class="bt_action" anh="K" Width="120px" OnClick="ns_cc_phep_nam_cn_P_EXPORT();form_P_LOI('');" Title="Tìm kiếm" />
