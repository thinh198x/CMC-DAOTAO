...
public partial class f_ns_cc_phep_nam : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                string b_s = this.ResolveUrl("~/App_form/ns/cc/ns_cc_phep_nam" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
                ScriptManager.RegisterClientScriptInclude(this.Page, this.GetType(), Guid.NewGuid().ToString(), b_s);
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ns_cc_phep_nam_P_KD('');", true);
                P_NHAN_DROP();
            }
        }
    ...
    protected void nhap_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Excel_dungchung.ExportTemplate("Templates/ExportMau/ns_cc_phep_nam.xlsx", b_dt, null, "Tong_hop_phep_nam");
        }
