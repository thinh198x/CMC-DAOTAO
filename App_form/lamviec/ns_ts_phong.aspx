<%@ Page Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true" CodeFile="ns_ts_phong.aspx.cs" Inherits="f_ns_ts_phong" Title="ns_ts_phong" %>
        ...
        <tr class="css_tieudeN">
            <td colspan="2">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="left">
                            <Cthuvien:luu ID="Luu1" runat="server" CssClass="css_tieudeM" Text="Manday dự trữ phòng" />
                        </td>
                        <td align="right">
                    ...
                    <tr>
                        <td align="center">
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td align="left">
                                       <asp:Label ID="Label3" runat="server" CssClass="css_gchu" Text="Dự án" />
                                    </td>
                                    <td align="left">
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td align="left">
                                                     <Cthuvien:nhap ID="timkiem" runat="server" Text="Tìm kiếm" Width="100px" OnClick="return ns_ts_phong_P_LKE();" />
                                                </td>
                                ...
                                <tr>
                                    <td colspan="2" style="padding-top: 2px">
                                        <table>
                                            ...
                                            <tr>
                                                <td align="center" id="GR_lke_td" style="padding-left: 286px;">
                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                        <tr>
                                                            <td>
                                                                <khud_slide:khud_slide ID="GR_lke_slide" runat="server" loai="X" rong="150" gridId="GR_lke" ham="ns_ts_phong_P_LKE()" />
                                                            </td>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <Cthuvien:nhap ID="in" runat="server" Text="In" CssClass="css_button" OnClick="return ns_ts_phong_P_IN();"
                                                        Width="70px" />
                                                </td>
