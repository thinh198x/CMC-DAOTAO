...
public partial class bai2 : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string b_s = this.ResolveUrl("~/App_form/daotao-2022/Ntduc_test/ntduc_bai2" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
            P_NHAN_DROP();
    ...
    protected void nhap_Click(object sender, EventArgs e)
    {
        try
        {
            DataTable b_dt = ns_hdns.Fdt_NS_HDNS_NTDUC_BAI2_EXPORT();
        
            bang.P_THAY_GTRI(ref b_dt, "tthai", "1", "Áp dụng");
            bang.P_THAY_GTRI(ref b_dt, "tthai", "2", "Ngừng áp dụng");
