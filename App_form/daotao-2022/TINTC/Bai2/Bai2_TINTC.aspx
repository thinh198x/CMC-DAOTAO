<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/trangnen.master" CodeFile="Bai2_TINTC.aspx.cs" Inherits="App_form_ns_ma_tin_bai2" %>
    ...
    <div id="main_content" class="container_content hide_sbar">
        <div class="r_c_content b_right">
            <div class="title_dmuc width_common">
                <Cthuvien:luu ID="tenForm" runat="server" Text="Bài 2" />
