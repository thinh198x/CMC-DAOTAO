...
public partial class f_daotao_ma : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                string b_s = this.ResolveUrl("~/App_form/daotao-2022/TINTC/bai4_test/daotao_ma" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
    ...
    protected void nhap_Click(object sender, EventArgs e)
    {
        try
        {
            DataTable b_dt = ns_hdns.Fdt_TIN_BT4_DROP();
            ...
            Excel_dungchung.ExportTemplate("Templates/DaoTao/daotao_ma.xlsx", b_dt, null, "Tin_Bai4");
        }
