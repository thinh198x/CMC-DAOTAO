    ...
    <div id="main_content" class="container_content hide_sbar">
        <div class="r_c_content b_right">
            <div class="title_dmuc width_common">
                <Cthuvien:luu ID="tenForm" runat="server" Text="TIN bai 4" />
                ...
                <div class="b_left col_50 inner" id="UPa_ct">
                    ...
                    <div class="b_left form-group iterm_form">
                       ...
                       <div class="b_left form-group iterm_form">
                        ...
                        <div class="input-group">
                            <Cthuvien:ma ID="MA_CD" f_tkhao="~/App_form/daotao-2022/TINTC/Bai2/Bai2_TINTC.aspx" runat="server" CssClass="form-control css_ma" kieu_chu="True" kt_xoa="G" ten="Nhóm chức danh" BackColor="#f6f7f7"
