...
public partial class f_bt3_tin : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string b_s = this.ResolveUrl("~/App_form/daotao-2022/TINTC/Bai3/Bai3_TinTC" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
            P_NHAN_DROP();
    ...
    {
        //Tinh thanh
        DataTable b_dt = ns_hdns.Fdt_TIN_BT3_DROP();
    ...
    protected void nhap_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Excel_dungchung.ExportTemplate("Templates/DaoTao/daotao_bai3.xlsx", b_dt, null, "Tin_Bai3");
        }
