<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bai3_TINTC.aspx.cs" Inherits="f_bt3_tin" 
    ...
    <div id="main_content" class="container_content hide_sbar">
        <div class="r_c_content b_right">
            <div class="title_dmuc width_common">
                <Cthuvien:luu ID="tenForm" runat="server" Text="Bài 3" />
                        ...
                        <div style="overflow-x: scroll">
                            <Cthuvien:GridX ID="GR_lke" Width="100%" runat="server" AutoGenerateColumns="false" PageSize="1" CssClass="table gridX" hangKt="15" hamRow="GR_lke_RowChange()"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ten_tt" HeaderText="Tỉnh thành" HeaderStyle-Width="60px" ItemStyle-CssClass="css_Gma" />
                                </Columns>
                            </Cthuvien:GridX>
                        </div>
