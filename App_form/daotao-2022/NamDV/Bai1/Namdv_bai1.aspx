<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Namdv_bai1.aspx.cs" Inherits="f_daotao_NamDV_bai1" MasterPageFile="~/trangnen.master" %>
                    ...
                    <div class="grid_table width_common">
                        <div>
                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                CssClass="table gridX" loai="X" hangKt="15" cotAn="nsd,ghichu,tt" hamRow="GR_lke_RowChange()">
                                <Columns>
                        ...
                        <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" gridId="GR_lke" ham="P_LKE()" /> <%--phân trang--%>
                    </div>
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="excel" runat="server" Text="Xuất excel" class="bt_action" anh="K" OnClick="return P_IN();form_P_LOI();" Width="100px" /> <%--Xuât exel--%>
                    </div>
                </div>
