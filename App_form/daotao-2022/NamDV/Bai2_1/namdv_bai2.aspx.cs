...
public partial class f_ns_hdns_ma_nn_nam_bai2 : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string b_s = this.ResolveUrl("~/App_form/daotao-2022/NamDV/Bai2_1/namdv_bai2" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
            P_NHAN_DROP();
    ...
    protected void btn_excel_mau_Click(object sender, EventArgs e)
    {
        ...
        bang.P_THEM_HANG(ref b_dt, new object[] { "2", "Ngừng áp dụng" }); b_dt.TableName = "DATA";
    ...
    protected void nhap_Click(object sender, EventArgs e)
    {
        try
        {
            DataTable b_dt = ns_hdns.Fdt_NAM_BAI2_EXPORT(c_ma_nnn.Value, macd.Text, tencd.Text);
