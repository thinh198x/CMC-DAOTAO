<%@ Page Language="C#" AutoEventWireup="true" CodeFile="namdv_bai2.aspx.cs"
    Inherits="f_ns_hdns_ma_nn_nam_bai2" MasterPageFile="~/trangnen.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="main_content" class="container_content hide_sbar">
        <div class="r_c_content b_right">
            <div class="title_dmuc width_common">
                <Cthuvien:luu ID="tenForm" runat="server" Text="NAM Bài 2" />
                ...
                <div class="b_left col_50 inner" id="UPa_tk">
                    ...
                    <%-- <div class="b_left form-group iterm_form">
                        <div class="list_bt_action">
                            <Cthuvien:nhap ID="tim" runat="server" Text="Tìm kiếm" Width="100px" class="bt_action" anh="K" OnClick="return P_LKE();form_P_LOI();" />
                        </div>
                    </div>--%>
    ...
    <Cthuvien:an ID="c_ma_nnn" runat="server" Value="1300,560" />
</asp:Content>
