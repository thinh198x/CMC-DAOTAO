...
public partial class f_ns_tl_bluong_sale : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                string b_s = this.ResolveUrl("~/App_form/tl/ns_tl_bluong_sale" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
                ScriptManager.RegisterClientScriptInclude(this.Page, this.GetType(), Guid.NewGuid().ToString(), b_s);
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ns_tl_bluong_sale_P_KD();", true);
                P_NHAN_DROP();
            }
        }
    ...
    protected void nhap_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataSet b_ds = tl_ch.Fdt_NS_TL_BLUONG_SALE_EXCEL(aphong.Value, akyluong.Value, so_the_tk.Text);
            ...
            bang.P_SO_CNG(ref b_dt, "NGAY_NGHI,NGAY_VAO,NGAYD,NGAYC,NGAY_NGHI");
            ...
            Excel_dungchung.ExportTemplate("Templates/ExportMau/ns_tl_bluong_sale_th.xlsx", b_ds_in, null, "bang_luong_tong_hop");
        }
