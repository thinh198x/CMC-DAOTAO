<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tl_ma_hinhthucHuong.aspx.cs" Inherits="f_tl_ma_hinhthucHuong"
    Title="tl_ma_hinhthucHuong" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
        ...
        <tr class="css_tieudeN">
            <td colspan="2">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="left">
                            <Cthuvien:luu ID="Luu1" runat="server" CssClass="css_tieudeM" Text="Hình thức hưởng" />
                        </td>
                        <td align="right">
                                    ...
                                    <td>
                                        <table cellpadding="1" cellspacing="1">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Cthuvien:ma ID="MA" ten="Mã" runat="server" CssClass="css_ma" kieu_chu="True" kt_xoa="G"
                                                                    onchange="tl_ma_hinhthucHuong_P_KTRA('MA')" Width="120px" />
                                                            </td>
                                            ...
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <Cthuvien:ma ID="TEN" ten="Tên" runat="server" CssClass="css_nd" kieu_unicode="True"
                                                        kt_xoa="X" Width="190px"></Cthuvien:ma>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td align="left" style="padding-left: 40px">
                                        <table id="UPa_nhap" cellpadding="1" cellspacing="1">
                                            <tr>
                                                <td align="center">
                                                    <Cthuvien:nhap ID="nhap" runat="server" CssClass="css_button" Font-Bold="True" OnClick="return tl_ma_hinhthucHuong_P_NH();form_P_LOI();"
                                                        Text="Nhập" Width="70px" />
                                                </td>
                                                <td align="center">
                                                    <Cthuvien:nhap ID="xoa" runat="server" CssClass="css_button" Font-Bold="True" OnClick="return tl_ma_hinhthucHuong_P_XOA();form_P_LOI();"
                                                        Text="Xóa" Width="70px" />
                                                </td>
                                                <td align="center">
                                ...
                                <tr>
                                    <td>
                                        <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                            CssClass="table gridX" loai="X" hangKt="15" cotAn="nsd" hamRow="tl_ma_hinhthucHuong_GR_lke_RowChange()">
                                            <Columns>
