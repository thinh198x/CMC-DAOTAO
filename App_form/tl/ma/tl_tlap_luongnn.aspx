<%@ Page Title="tl_tlap_luongnn" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="tl_tlap_luongnn.aspx.cs" Inherits="f_tl_tlap_luongnn" %>
        ...
        <tr class="css_tieudeN">
            <td colspan="2">
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td align="left">
                            <Cthuvien:luu ID="Luu1" runat="server" CssClass="css_tieudeM" Text="Thiết lập lương tối thiểu nhà nước" />
                        </td>
                        <td align="right">
                                            ...
                                            <tr>
                                                <td>
                                                    <Cthuvien:ngay  placeholder='dd/MM/yyyy' ID="NGAY" runat="server" CssClass="css_ma_c" kt_xoa="G" Width="100px" kieu_luu="S"
                                                        ten="Ngày hiệu lực" onchange = "tl_tlap_luongnn_P_KTRA('NGAY')" />
                                                </td>
                                                <td>
                                    ...
                                    <td>
                                        <table border="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label3" runat="server" CssClass="css_gchu" Text="Ngày QĐ" Width="60px" />
                                                </td>
                                                <td>
                    ...
                    <tr>
                        <td align="center">
                            <table id = "UPa_nhap" border="0" cellpadding="1" cellspacing="1">
                                <tr>
                                    <td>
                                        <Cthuvien:nhap ID="nhap" runat="server" Text="Nhập" CssClass="css_button" OnClick="return tl_tlap_luongnn_P_NH();form_P_LOI();" Width="70px"/>
                                    </td>
                                    <td>
                                        <Cthuvien:nhap ID="moi" runat="server" Text="Mới" CssClass="css_button" OnClick="return tl_tlap_luongnn_P_MOI();form_P_LOI();" Width="70px"/>
                                    </td>
                                    <td>
                                        <Cthuvien:nhap ID="xoa" runat="server" Text="Xóa" CssClass="css_button" OnClick="return tl_tlap_luongnn_P_XOA();form_P_LOI();" Width="70px"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td>
                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                CssClass="table gridX" loai="X" hangKt="15" hamRow="tl_tlap_luongnn_GR_lke_RowChange()">
                                <Columns>
