<%@ Page Title="ns_cc_tonghop_okifood" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_cc_tonghop_okifood.aspx.cs" Inherits="f_ns_cc_tonghop_okifood" %>
                                                    ...
                                                    <table border="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="width: 20px;" align="center" valign="middle">
                                                                <img runat="server" alt="" src="~/images/icon/phai.png" title="Lựa chọn" onclick="return ns_cc_tonghop_okifood_phong();" />
                                                            </td>
                                                            <td>
                                                ...
                                                <tr>
                                                    <td align="left">
                                                        <table id="tblInfo" cellspacing="0" cellpadding="0" class="tbl_ll">
                                                            <tr>
                                                                ...
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" colspan="6" align="center">
                                                                    <asp:Label ID="Label7" runat="server" Text="Công chính (Ngày công)" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" colspan="6" align="center">
                                                                    <asp:Label ID="Label4" runat="server" Width="210px" Text="Làm thêm (Giờ công)" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" colspan="6" align="center">
                                                                    <asp:Label ID="Label30" runat="server" Text="Nghỉ chế độ (Ngày công)" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" colspan="3" align="center">
                                                                    <asp:Label ID="Label31" runat="server" Text="Nghỉ khác (Ngày công)" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" rowspan="2" align="center">
                                                                    <asp:Label ID="Label29" runat="server" Width="110px" Text="Hành chính" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" rowspan="2" align="center">
                                                                    <asp:Label ID="Label14" runat="server" Width="110px" Text="Ca sáng" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" rowspan="2" align="center">
                                                                    <asp:Label ID="Label15" runat="server" Width="110px" Text="Ca chiều" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" rowspan="2" align="center">
                                                                    <asp:Label ID="Label1" runat="server" Width="110px" Text="Ca đêm" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" rowspan="2" align="center">
                                                                    <asp:Label ID="Label32" runat="server" Width="110px" Text="Nghỉ bù" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" rowspan="2" align="center">
                                                                    <asp:Label ID="Label33" runat="server" Width="110px" Text="Lương sản phẩm" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" colspan="2" align="center">
                                                                    <asp:Label ID="Label8" runat="server" Width="221px" Text="Làm thêm ngày thường" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" colspan="2" align="center">
                                                                    <asp:Label ID="Label9" runat="server" Width="221px" Text="Làm thêm ngày nghỉ" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" colspan="2" align="center">
                                                                    <asp:Label ID="Label10" runat="server" Width="221px" Text="Làm thêm ngày Lễ, Tết" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" colspan="4" align="center">
                                                                    <asp:Label ID="Label11" runat="server" Width="110px" Text="Nghỉ việc có hưởng lương" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" colspan="2" align="center">
                                                                    <asp:Label ID="Label12" runat="server" Width="110px" Text="Nghỉ việc không hưởng lương" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" colspan="3" align="center">
                                                                    <asp:Label ID="Label22" runat="server" Width="110px" Text="Nghỉ việc riêng không lương" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                 <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;"  align="center">
                                                                    <asp:Label ID="Label16" runat="server" Width="110px" Text="Ngày" />
                                                                </td>
                                                                 <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" align="center">
                                                                    <asp:Label ID="Label17" runat="server" Width="110px" Text="Đêm" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;"  align="center">
                                                                    <asp:Label ID="Label18" runat="server" Width="110px" Text="Ngày" />
                                                                </td>
                                                                 <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" align="center">
                                                                    <asp:Label ID="Label19" runat="server" Width="110px" Text="Đêm" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;"  align="center">
                                                                    <asp:Label ID="Label20" runat="server" Width="110px" Text="Ngày" />
                                                                </td>
                                                                 <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" align="center">
                                                                    <asp:Label ID="Label21" runat="server" Width="110px" Text="Đêm" />
                                                                </td>

                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" align="center">
                                                                    <asp:Label ID="Label26" runat="server" Width="110px" Text="Nghỉ phép" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;"  align="center">
                                                                    <asp:Label ID="Label27" runat="server" Width="110px" Text="Nghỉ Lễ, Tết" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;"  align="center">
                                                                    <asp:Label ID="Label23" runat="server" Width="110px" Text="Học tập, Hội nghị" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;"  align="center">
                                                                    <asp:Label ID="Label34" runat="server" Width="110px" Text="Hiếu hỷ" />
                                                                </td>
                                                                 <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" align="center">
                                                                    <asp:Label ID="Label28" runat="server" Width="110px" Text="Nghỉ ốm" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" align="center">
                                                                    <asp:Label ID="Label13" runat="server" Width="110px" Text="Nghỉ thai sản" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" rowspan="2" align="center">
                                                                    <asp:Label ID="Label24" runat="server" Width="110px" Text="Hiếu hỷ khác" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" rowspan="2" align="center">
                                                                    <asp:Label ID="Label25" runat="server" Width="110px" Text="Nghỉ việc riêng" />
                                                                </td>
                                                                <td style="background-color: #9fc54e; border-right: gray 1px solid; border-bottom: gray 1px solid;" rowspan="2" align="center">
                                                                    <asp:Label ID="Label35" runat="server" Width="110px" Text="Nghỉ không lý do" />
                                                                </td>
                                                                 
                                                            </tr>
                                                        </table>
                                                        <Cthuvien:GridX ID="Gr_ma" runat="server" AutoGenerateColumns="false" PageSize="1"
                                                            CssClass="table gridX" loai="N" cot="so_the,ten,ma01,ma2,ma3,ma4,ma5,ma6,ma7,ma8,ma9,ma10,ma11,ma12,ma13,ma14,ma15,ma16,ma17,ma18,ma19,ma20,ma21,ma22,ma23,ma24,ma25" cotAn="ma22,ma23,ma24,ma25" hangKt="1" gchuId="gchu">
                                                            <Columns>
                                                        ...
                                                        <Cthuvien:GridX ID="GR_ct" runat="server" AutoGenerateColumns="false" PageSize="1"
                                                            CssClass="table gridX" loai="L" hangKt="19" gchuId="gchu" cotAn="PHONG_CP,N22,N23,N24,N25">
                                                            <Columns>
                                                                <asp:BoundField DataField="leGrid" HeaderStyle-Width="21px" />
                                                                <asp:BoundField DataField="SO_THE" HeaderStyle-Width="78px" ItemStyle-CssClass="css_Gma" />
                                                                <asp:BoundField DataField="TEN" HeaderStyle-Width="208px" ItemStyle-CssClass="css_Gma" />
