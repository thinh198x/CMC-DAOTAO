<%@ Page Title="tl_ct_cong" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="tl_ct_cong.aspx.cs" Inherits="f_tl_ct_cong" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <tr>
                        <td align="center">
                            <table cellpadding="1" cellspacing="1" width="100%">
                                <tr>
                                    <td align="left">
                                        <Cthuvien:luu ID="Luu5" runat="server" CssClass="css_tieudeM" Text="Thiết lập công thức công" />
                                    </td>
                                    <td align="right">
                                        <div class="acc">
                                            <ul>
                                            ...
                                            <tr>
                                                <td>
                                                    <Cthuvien:GridX ID="GR_ct" runat="server" AutoGenerateColumns="false" PageSize="1"
                                                        CssClass="table gridX" loai="X" hangKt="11" cot="stt,macl,tencl,congthuc,TT" cotAn="macl,congthuc,TT" hamRow="tl_ct_cong2_GR_lke_RowChange()">
                                                        <Columns>
                                                            <asp:BoundField DataField="leGrid" HeaderStyle-Width="10px" />
                                                            <asp:BoundField DataField="STT" HeaderText="STT" HeaderStyle-Width="40px" ItemStyle-CssClass="css_ma_c" />
                                                            <asp:BoundField HeaderText="Mã cột công" DataField="macl" HeaderStyle-Width="1px"></asp:BoundField>
                                                            <asp:BoundField HeaderText="Tên cột công" DataField="tencl" HeaderStyle-Width="405px"></asp:BoundField>
                                            ...
                                            <tr>
                                                <td>
                                                    <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                                        CssClass="table gridX" loai="X" hangKt="11" cotAn="macl" cot="chon,tencl,cot_cong,macl" hamRow="tl_ct_cong_GR_lke_RowChange()">
                                                        <Columns>
                                                            <asp:BoundField DataField="leGrid" HeaderStyle-Width="10px" />
                                                            ...
                                                            <asp:BoundField HeaderText="Kiểu công" DataField="cot_cong" ItemStyle-CssClass="css_ma_c" HeaderStyle-Width="70px" />
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <div class="box3 txRight"  style="width:179px">
                                                        <a href="#" onclick="return tl_ct_cong_P_KT();form_P_LOI();" class="bt bt-grey">Kiểm tra CT</a>
                                                        <a href="#" onclick="return tl_ct_cong_P_NH();form_P_LOI();" class="bt bt-grey"><i class="fa fa-save"></i>Lưu</a>
                                                ...
                                                <td align="left">
                                                    <div class="box3 txRight" style="text-align:left; padding-left:50px;">
                                                        <a href="#" onclick="return tl_ct_cong_cong();" class="bt bt-grey">Cộng</a>
                                                        <a href="#" onclick="return tl_ct_cong_tru();" class="bt bt-grey">Trừ</a>
                                                        <a href="#" onclick="return tl_ct_cong_nhan();" class="bt bt-grey">Nhân</a>
                                                        <a href="#" onclick="return tl_ct_cong_chia();" class="bt bt-grey">Chia</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
    ...
    <div id="UPa_hi">
        ...
        <Cthuvien:an ID="kthuoc" runat="server" Value="1120,800" />
    </div>
</asp:Content>
