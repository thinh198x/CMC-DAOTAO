...
public partial class f_ns_cc_dky_lthem : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string b_s = this.ResolveUrl("~/App_form/tl/cc/ns_cc_dky_lthem" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
            ScriptManager.RegisterClientScriptInclude(this.Page, this.GetType(), Guid.NewGuid().ToString(), b_s);
            ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ns_cc_dky_lthem_P_KD('" + Nhap2.UniqueID + "');", true);
            P_NHAN_DROP();
        }
    }
    ...
    protected void btn_excel_mau_Click(object sender, EventArgs e)
    {
        ...
        // ghi log
        hts_dungchung.PHT_LOG_NH(PHANHE.CC, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.EXPORT_MAU, TEN_FORM.NS_CC_DKY_LTHEM, TEN_BANG.NS_CC_DKY_LTHEM);
    ...
    protected void nhap_Click(object sender, EventArgs e)
    {
        try
        {
            DataTable b_dt = tl_cc.Fdt_NS_CC_DKY_LTHEM_EXPORT();
            ...
            bang.P_THAY_GTRI(ref b_dt, "LTHEM_THEOLUAT", "C", "Làm thêm theo luật");
            bang.P_THAY_GTRI(ref b_dt, "LTHEM_THEOLUAT", "K", "Làm thêm không theo luật"); 
            // ghi log
            hts_dungchung.PHT_LOG_NH(PHANHE.CC, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.EXPORT_EXCEL, TEN_FORM.NS_CC_DKY_LTHEM, TEN_BANG.NS_CC_DKY_LTHEM);
            Excel_dungchung.ExportTemplate("Templates/ExportMau/ns_cc_dky_lthem.xlsx", b_dt, null, "dangky_lamthem");
        }
