<%@ Page Language="C#" AutoEventWireup="true" CodeFile="import_ns_cc_phep_dieuchinh.aspx.cs" Inherits="f_import_ns_cc_phep_dieuchinh"
    Title="import_ns_cc_phep_dieuchinh" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
                            ...
                            <tr>
                                <td>
                                    <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                        CssClass="table gridX" loai="X" hangKt="5" cotAn="so_id,ten" hamRow="import_ns_cc_phep_dieuchinh_GR_lke_RowChange()">
                                        <Columns>
                            ...
                            <tr>
                                <td id="GR_lke_td" runat="server" align="center">
                                    <khud_slide:khud_slide ID="GR_lke_slide" rong="20" runat="server" loai="X" gridId="GR_lke"
                                        ham="import_ns_cc_phep_dieuchinh_P_LKE()" />
                                </td>
                            </tr>
                        </table>
                    </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="box3 txRight2">
                                                    <a href="#" onclick="return import_ns_cc_phep_dieuchinh_P_NH();form_P_TRA_CHON('ten_file')"  class="bt bt-grey"><i class="fa fa-save"></i>Nhập</a>
                                                    <a href="#" onclick="return import_ns_cc_phep_dieuchinh_P_XOA();form_P_LOI();" class="bt bt-grey"><i class="fa fa-trash-o"></i>Xóa</a>
