...
public partial class f_ns_cc_dkc_connho : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                string b_s = this.ResolveUrl("~/App_form/tl/cc/ns_cc_dkc_connho" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
                ScriptManager.RegisterClientScriptInclude(this.Page, this.GetType(), Guid.NewGuid().ToString(), b_s);
                ScriptManager.RegisterClientScriptInclude(this.Page, this.GetType(), Guid.NewGuid().ToString(), b_s1);
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "ns_cc_dkc_connho_P_KD();", true);
                P_NHAN_DROP();
            }
        }
    ...
    protected void btn_excel_mau_Click(object sender, EventArgs e)
    {
        ...
        //b_dt_macc_nghi = ns_qt.Fdt_ns_cc_dkc_connho_SC(null);
        ...
        // ghi log
        //hts_dungchung.PHT_LOG_NH(PHANHE.CC, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.EXPORT_MAU, TEN_FORM.ns_cc_dkc_connho, TEN_BANG.ns_cc_dkc_connho);
        Excel_dungchung.ExportTemplate("Templates/importmau/ns_cc_dkc_connho.xls", b_ds, null, "quan_ly_dang_ky_nghi");
    }
    ...
    protected void nhap_Click(object sender, EventArgs e)
    {
        try
        {
            object[] a_obj = ns_qt.Fdt_NS_CC_DKC_CONNHO_LKE(so_the_tk.Text, ten_tk.Text,NGAYD_TK.Text,NGAYC_TK.Text, 1, 1000);
            ...
            // ghi log
            //hts_dungchung.PHT_LOG_NH(PHANHE.CC, NHOM_CHUCNANG.NGHIEP_VU, THAOTAC.EXPORT_EXCEL, TEN_FORM.ns_cc_dkc_connho, TEN_BANG.ns_cc_dkc_connho);
            Excel_dungchung.ExportTemplate("Templates/ExportMau/ns_cc_dkc_connho_export.xlsx", b_dt, null, "dang_ky_ca_connho");
        }
