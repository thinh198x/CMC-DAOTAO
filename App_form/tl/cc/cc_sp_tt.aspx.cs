...
public partial class f_cc_sp_tt : fmau
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        { 
            if (!IsPostBack) 
            {
                ...
                string b_s = this.ResolveUrl("~/App_form/tl/cc/cc_sp_tt" + khac.Fs_runMode() + ".js?v=" + ht_dungchung.b_ver);
                ScriptManager.RegisterClientScriptInclude(this.Page, this.GetType(), Guid.NewGuid().ToString(), b_s);
                ScriptManager.RegisterStartupScript(this, this.GetType(), Guid.NewGuid().ToString(), "cc_sp_tt_P_KD();", true);
                if (se.Fs_DUYET() != "IE") kthuoc.Value = "1055,785";
                P_NHAN_DROP();
                PHONG.Focus();
            }
        }
