<%@ Page Title="ns_cc_dkc_connho" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_cc_dkc_connho.aspx.cs" Inherits="f_ns_cc_dkc_connho" %>
                ...
                <div class="b_left col_50 inner" id="UPa_tk">
                    ...
                    <div class="col_2_iterm width_common" style="display: none;">
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:DR_lke ID="phong_tk" ten="Phòng" runat="server" CssClass="form-control css_list" onchange="ns_cc_dkc_connho_P_KTRA('PHONG_TK')" ktra="DT_PHONG" />
                            </div>
                        </div>
                        <div class="b_right form-group iterm_form">
                        </div>
                    ...
                    <div class="col_2_iterm width_common">
                        ...
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="NGAYD_TK" ten="Từ ngày" runat="server" kt_xoa="G" CssClass="form-control icon_lich" kieu_luu="S" onchange="ns_cc_dkc_connho_P_KTRA('NGAYD')" />
                        ...
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="NGAYC_TK" ten="Đến ngày" runat="server" kt_xoa="G" CssClass="form-control icon_lich" kieu_luu="S" onchange="ns_cc_dkc_connho_P_KTRA('NGAYC')" />

                            </div>
                        </div>
                    </div>
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="tim" runat="server" Width="120px" Text="Tìm kiếm" class="bt_action" anh="K" OnClick="return ns_cc_dkc_connho_P_LKE('K');form_P_LOI();" />
                    </div>
                    <div class="grid_table width_common">
                        <div style="overflow-x: scroll">
                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1" Width="100%"
                                CssClass="table gridX" loai="X" hangKt="15" cotAn="mota,cdanh,phong,so_id" hamRow="ns_cc_dkc_connho_GR_lke_RowChange()">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Ngày đăng ký từ" DataField="ngayd" HeaderStyle-Width="90px" ItemStyle-CssClass="css_Gma_c" />
                                    <asp:BoundField HeaderText="Ngày đăng ký đến" DataField="ngayc" HeaderStyle-Width="90px" ItemStyle-CssClass="css_Gma_c" />
                        ...
                        <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_cc_dkc_connho_P_LKE('K')" />

                    </div>
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="Nhap1" runat="server" Width="120px" class="bt_action" anh="K" Text="Xuất excel" OnClick="return ns_cc_dkc_connho_P_IN();form_P_LOI();" />
                    </div>
                </div>
                <div class="b_right col_50 inner" id="UPa_ct">
                        ...
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ma ID="SO_THE" placeholder="Nhấn (F1)" ten="Mã nhân viên" runat="server" CssClass="form-control css_ma" BackColor="#f6f7f7"
                                    ktra="ns_cb,so_the,ten" ToolTip="Mã số nhân viên" kt_xoa="G" kieu_chu="true"
                                    f_tkhao="~/App_form/ns/tt/ns_cb_chon.aspx" onchange="ns_cc_dkc_connho_P_KTRA('SO_THE')" gchu="gchu" />
                    ...
                    <div class="col_2_iterm width_common">
                        ...
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="NGAYD" ten="Từ ngày" runat="server" kt_xoa="G" CssClass="form-control icon_lich" kieu_luu="S" onchange="ns_cc_dkc_connho_P_KTRA('NGAYD')" />
                        ...
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ngay placeholder='dd/MM/yyyy' ID="NGAYC" ten="Đến ngày" runat="server" kt_xoa="G" CssClass="form-control icon_lich" kieu_luu="S" onchange="ns_cc_dkc_connho_P_KTRA('NGAYC')" />
                    ...
                    <div class="col_2_iterm width_common">
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:DR_lke ID="CA" ten="Ca" runat="server" ktra="DT_CALV" kieu_chu="true" CssClass="form-control css_list" 
                                    kt_xoa="X" onchange="ns_cc_dkc_connho_P_KTRA('CA_LV');" />
                            </div>
                        </div>
                    </div>
                    <div class="col_2_iterm width_common">
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ma ID="GIOD" ten="Từ giờ" MaxLength="30" kt_xoa="X" runat="server" CssClass="form-control css_ma_c"
                        ...
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ma ID="GIOC" ten="Đến giờ" MaxLength="30" kt_xoa="X" runat="server" CssClass="form-control css_ma_c"
                                    Enabled="false" BackColor="#f6f7f7" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="nhap" runat="server" Width="80px" class="bt_action" anh="K" Text="Ghi" OnClick="return ns_cc_dkc_connho_P_NH();form_P_LOI();" />
                        <Cthuvien:nhap ID="moi" runat="server" Width="80px" class="bt_action" anh="K" Text="Mới" OnClick="return ns_cc_dkc_connho_P_MOI();form_P_LOI();" />
                        <Cthuvien:nhap ID="xoa" runat="server" Width="80px" class="bt_action" anh="K" Text="Xóa" OnClick="return ns_cc_dkc_connho_P_XOA();form_P_LOI();" />
                        <%--<Cthuvien:nhap ID="Nhap3" runat="server" Width="80px" Text="Hủy đơn" OnClick="return ns_cc_dkc_connho_P_Update();form_P_LOI();" />--%>

                        <div style="display: none;">
                            <Cthuvien:nhap ID="Nhap3" runat="server" Width="80px" class="bt_action" anh="K" Text="File mẫu" OnClick="return ns_cc_dkc_connho_P_MAU();form_P_LOI();" />
                            <Cthuvien:nhap ID="Nhap4" runat="server" class="bt_action" anh="K" Text="Import excel" OnClick="return ns_cc_dkc_connho_FILE_Import();form_P_LOI('');" />
