<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cc_khaibao_lamthem.aspx.cs" Inherits="f_cc_khaibao_lamthem"
    Title="cc_khaibao_lamthem" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>
        ...
        <tr>
            <td align="center">
                <table cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                        <td align="left">
                            <Cthuvien:luu ID="Luu5" runat="server" CssClass="css_tieudeM" Text="Khai báo làm thêm" />
                        </td>
                        <td align="right">
                            <table cellpadding="1" cellspacing="1">
                                <tr>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                    ...
                                    <td style="display: none">
                                        <table cellpadding="1" cellspacing="1">
                                            <tr>
                                                ...
                                                <td align="left">
                                                    <Cthuvien:thang ID="thang" ten="Tháng" runat="server" CssClass="css_form_c" Width="120px" kieu_luu="I" onchange="cc_khaibao_lamthem_P_LKE();" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1"
                                            CssClass="table gridX" loai="X" hangKt="15" cotAn="so_id,hso" hamRow="cc_khaibao_lamthem_GR_lke_RowChange()">
                                            <Columns>
                                ...
                                <tr>
                                    <td id="GR_lke_td" runat="server" align="center">
                                        <khud_slide:khud_slide ID="GR_lke_slide" runat="server" loai="X" rong="50" gridId="GR_lke" ham="cc_khaibao_lamthem_P_LKE()" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td>
                                        <table id="UPa_ct" runat="server" cellpadding="1" cellspacing="1">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <Cthuvien:ma ID="SO_THE" ten="Số thẻ" runat="server" CssClass="css_form" kieu_chu="True" BackColor="#f6f7f7"
                                                                    kt_xoa="K" f_tkhao="~/App_form/ns/tt/ns_cb_chon.aspx" ktra="ns_cb,so_the,ten" onchange="cc_khaibao_lamthem_P_KTRA('SO_THE')" Width="140px" />
                                                            </td>
                                                            <td>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <Cthuvien:bbuoc ID="lblngaydk" runat="server" CssClass="css_gchu" Text="Ngày làm thêm"></Cthuvien:bbuoc>
                                                </td>
                                                <td>
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="left">
                                                                <Cthuvien:ngay ID="NGAY_DKY" ten="Ngày làm thêm" runat="server" onchange="cc_khaibao_lamthem_P_KTRA('ngay_dky')" CssClass="css_form_c" kieu_luu="S"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="left">
                                                                <Cthuvien:ma ID="GIO_BD" ten="Từ giờ" runat="server" onchange="cc_khaibao_lamthem_P_KTRA('GIO_BD')" kt_xoa="X" CssClass="css_form_c"
                                                                    Width="140px" />
                                                            </td>
                                                            <td align="left">
                                                            ...
                                                            <td align="left">
                                                                <Cthuvien:ma ID="GIO_KT" ten="Đến giờ" onchange="cc_khaibao_lamthem_P_KTRA('GIO_KT')" runat="server" kt_xoa="X" CssClass="css_form_c"
                                                                    Width="150px" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Label ID="Label3" runat="server" Text="Số giờ chuyển vào nghỉ bù" Width="80px" CssClass="css_gchu_c" />
                                                            </td>
                                                            <td>
                                                                <Cthuvien:ma ID="so_gio_nb" runat="server" CssClass="css_form" Width="150px" kt_xoa="X" gchu="gchu" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label6" runat="server" Width="80px" CssClass="css_gchu" Text="Số giờ được thanh toán" />
                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td align="left">
                                                                <Cthuvien:ma ID="so_gio_tt" ten="Số giờ làm thêm được thanh toán" runat="server" kt_xoa="X" CssClass="css_form"
                                                                    Width="140px" /> 
                                                            </td>
                                                            <td></td>
                                                            <td></td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="box3 txCenter">
                                                        <a href="#" onclick="return cc_khaibao_lamthem_P_NH();form_P_LOI();" class="bt bt-grey"><i class="fa fa-save"></i><span class="txUnderline">N</span>hập</a>
                                                        <a href="#" class="bt bt-grey" onclick="return cc_khaibao_lamthem_P_XOA();form_P_LOI();"><i class="fa fa-trash-o"></i><span class="txUnderline"></span>Xóa</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="box3 txRight">
                                                        <a href="#" onclick="return cc_khaibao_lamthem_P_IN();form_P_LOI();" class="bt bt-grey"><span class="txUnderline">X</span>uất excel</a>
                                                        <a href="#" onclick="return cc_khaibao_lamthem_P_MAU();form_P_LOI();" class="bt bt-grey"><span class="txUnderline">E</span>xcel mẫu</a>
                                                        <a href="#" onclick="return cc_khaibao_lamthem_FILE_Import();form_P_LOI();" class="bt bt-grey"><span class="txUnderline">Nh</span>ập excel</a>
