<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ns_tl_bluong_bb.aspx.cs" Inherits="f_ns_tl_bluong_bb"
    Title="ns_tl_bluong_bb" EnableEventValidation="false" MasterPageFile="~/trangnen.master" %>

<%@ Register Src="~/App_ctr/khud/ctr_khud_divL.ascx" TagName="ctr_khud_divL" TagPrefix="ctr_khud_divL" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="r_c_content b_right">
        <div class="title_dmuc width_common">
            <Cthuvien:luu ID="tenForm" runat="server" Text="Bảng lương công tác viên khối BB" />
                ...
                <div class="col_5_iterm width_common">
                    <div class="b_left form-group iterm_form" style="width: 10%">
                        ...
                        <div class="input-group">
                            <Cthuvien:DR_lke ID="NAM" kt_xoa="" ten="Năm" ktra="DT_NAM" runat="server" onchange="ns_tl_bluong_bb_P_NAM()" CssClass="form-control css_list" />
                        </div>
                    </div>
                    <div class="b_left form-group iterm_form">
                        <span class="standard_label lv2 b_left col_30">Kỳ lương</span>
                        <div class="input-group">
                            <Cthuvien:DR_lke ID="KYLUONG_ID" kt_xoa="X" ten="Kỳ lương" ktra="DT_KY" runat="server" CssClass="form-control css_list" onchange="ns_tl_bluong_bb_P_LKE()" />
                        </div>
                    </div>
                    <div class="b_left form-group iterm_form">
                        <span class="standard_label lv2 b_left col_40">Mã nhân viên</span>
                        <div class="input-group">
                            <Cthuvien:ma ID="so_the" ten="Mã nhân viên" kieu_chu="true" runat="server" CssClass="form-control css_ma" onchange="ns_tl_bluong_bb_P_LKE()" />
                        </div>
                    </div>
                    <div class="b_left form-group iterm_form">
                        <span class="standard_label lv2 b_left col_30" style="width: 30%">Phòng ban</span>
                        <div class="input-group">
                            <Cthuvien:DR_lke ID="phong" ktra="DT_PHONG" runat="server" kt_xoa="X" CssClass="form-control css_list" onchange="ns_tl_bluong_bb_P_LKE()" />
                        </div>
                    </div>
                    <div class="b_right form-group lv2 iterm_form">
                        <Cthuvien:nhap ID="Nhap1" runat="server" class="bt_action" Text="Tổng hợp" OnClick="return ns_tl_bluong_bb_P_TONGHOP();" />
                    </div>
                    <div class="grid_table width_common">
                        <div style="overflow-x: scroll">
                            <Cthuvien:GridX ID="GR_lke" runat="server" AutoGenerateColumns="false" PageSize="1" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Tổng thu nhập trước thuế" DataField="thunhap_truocthue" ItemStyle-CssClass="css_Gma_r" HeaderStyle-Width="100px" />
                                    ...
                                    <asp:BoundField HeaderText="Truy lĩnh" DataField="xoa_no" ItemStyle-CssClass="css_Gma_r" HeaderStyle-Width="100px" />
                        ...
                        <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_tl_bluong_bb_P_LKE()" />
                    </div>
                    <div class="list_bt_action">
                        <Cthuvien:nhap ID="layexcel" runat="server" class="bt_action" anh="K" Text="Xuất excel" onclick="ns_tl_bluong_bb_EXCEL()" />
                    </div>
