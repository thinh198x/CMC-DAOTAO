<%@ Page Title="ns_tl_bluong" Language="C#" MasterPageFile="~/trangnen.master" AutoEventWireup="true"
    CodeFile="ns_tl_bluong.aspx.cs" Inherits="f_ns_tl_bluong" %>
    ...
    <div id="main_content" class="container_content hide_sbar">
        ...
        <div class="r_c_content b_right">
            <div class="title_dmuc width_common">
                <Cthuvien:luu ID="tenForm" runat="server" Text="Bảng tính lương khối BACK" />
                ...
                <div class="b_left col_100 inner" id="UPa_ct">
                    <div class="col_4_iterm width_common">
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:DR_lke ID="NAM" ten="Năm" runat="server" kt_xoa="M" Width="100px" onchange="ns_tl_bluong_P_NAM();" CssClass="form-control css_list" ktra="DT_NAM" />
                            </div>
                        </div>
                        <div class="b_left form-group iterm_form">
                            <span class="standard_label lv2 b_left col_40" style="width: 80px">Kỳ lương</span>
                            <div class="input-group">
                                <Cthuvien:DR_lke ID="KYLUONG" ten="Kỳ lương" Width="300px" kt_xoa="N" runat="server" CssClass="form-control css_list" onchange="ns_tl_bluong_P_KTRA('KYLUONG')" ktra="DT_KY" />
                            </div>
                        </div>
                        <div class="b_left form-group iterm_form">
                            ...
                            <div class="input-group">
                                <Cthuvien:ma ID="so_the_tk" ten="Mã nhân viên" runat="server" CssClass="form-control css_ma"
                                    kt_xoa="G" onchange="ns_tl_bluong_P_KTRA('KYLUONG')" kieu_chu="true" />
                            </div>
                        </div>
                        <div class="b_left form-group iterm_form">
                            <span class="standard_label lv2 b_left col_45"></span>
                            <div class="input-group">
                                <Cthuvien:nhap ID="timkiem" runat="server" anh="K" class="bt_action" Text="Tính lương" hoi="0" OnClick="return ns_tl_bluong_TINH();" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab_content">
                        <asp:Panel ID="Pa_yc" runat="server" Style="display: none;">
                            ...
                            <ctr_khud_divL:ctr_khud_divL ID="GR_tk_slide" runat="server" loai="X" gridId="GR_tk" ham="ns_tl_bluong_tk_P_LKE()" />
                        </asp:Panel>
                        <asp:Panel ID="Pa_tt" runat="server" Style="display: block;">
                            ...
                            <ctr_khud_divL:ctr_khud_divL ID="GR_lke_slide" runat="server" loai="X" gridId="GR_lke" ham="ns_tl_bluong_P_LKE()" />
                        </asp:Panel>
                    </div>
                    <div class="list_bt_action lv2">
                        <div class="col_5_iterm width_common">
                            <%-- <div id="tdKhoa" class="b_left">
                                <Cthuvien:nhap ID="nhap" runat="server" Text="Khóa" OnClick="ns_tl_bluong_P_DONG();form_P_LOI('');" class="bt_action" anh="K" />
                            </div>
                            <div id="tdMo" class="b_left">
                                <Cthuvien:nhap ID="moi" runat="server" Text="Mở" OnClick="ns_tl_bluong_P_MO();form_P_LOI('');" class="bt_action" anh="K" />
                            </div>
                            <div id="tdKhoavv" class="b_left">
                                <Cthuvien:nhap ID="nhap1" runat="server" OnClick="ns_tl_bluong_P_DONG_VV();form_P_LOI('');" Text="Khóa vĩnh viễn" class="bt_action" anh="K" />
                            </div>--%>

                            <div class="b_left" style="padding-left: 3px;">
                                <Cthuvien:nhap ID="excel" runat="server" Text="Xuất excel" Width="90px" OnClick="ns_tl_bluong_P_IN();form_P_LOI('');" Title="Xuất excel" class="bt_action" anh="K" />
                            </div>
                            <div style="display: none">
                                <Cthuvien:nhap ID="chuyentien" runat="server" Text="In lệnh chuyển tiền" CssClass="css_button" OnClick="return ns_tl_bluong_P_CHUYEN_TIEN();form_P_LOI();" Width="150px" />
